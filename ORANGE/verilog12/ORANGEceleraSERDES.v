...
module oscillator_XORANGE_XceleraSERDES_Xoscillator (SIMPV,ok_oscillator,oscillator,ten,tdext,ten_oscillator_on,ten_oscillator_off,ten_oscillator_div8,ten_oscillator_external,tdi_oscillator,enable_oscillator,CELG,CELSUB);
  input  ten;
  input  CELG;
  input  SIMPV;
  input  tdext;
...
oscillator_XORANGE_XceleraSERDES_Xoscillator Xoscillator (
.ten(ten_serdes),
.CELG(CELG59462),
.SIMPV(CELV96848),
.tdext(tdext),
...
.otp_q(otp_q[7:0]),
.CELSUB(CELSUB40948),
.otp_id({a0,a0,a1,a0,a0,a1,a1,a1}),
.otp_nr(otp_nr),
.otp_we(otp_we[63:0]),
.unlock(unlock),
.otp_done(otp_done),
...
.i2cpassword({a0,a0}),
.celkelvin_CELV(celkelvin_VCC_bdce7a57),
.enable_hardware(a1),
.otp_clock_enable(otp_clock_enable),
