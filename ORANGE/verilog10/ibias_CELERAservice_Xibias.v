...
module rlpp3000rpo24p1u0p5u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule
...
//Celera Confidential Do Not Copy R(IBIAS)
module rlpp3000rpo19p9u0p4u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule
...
//OUTPUTS:9 VMAX:6V DFT:yes ACCURACY:yes
...
rlpp3000rpo24p1u0p5u XRIBIAS_0(
.RP (RP),
.RN (RPRN4_1),
.ISO (CELG)
);
rlpp3000rpo24p1u0p5u XRIBIAS_1(
.RP (RPRN4_1),
.RN (RPRN4_2),
.ISO (CELG)
);
rlpp3000rpo24p1u0p5u XRIBIAS_2(
.RP (RPRN4_2),
.RN (RPRN4_3),
.ISO (CELG)
);
rlpp3000rpo24p1u0p5u XRIBIAS_3(
.RP (RPRN4_3),
.RN (RN4),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo24p1u0p5u

//Die Size Calculator rlpp3000rpo24p1u0p5u
//,diesize,rlpp3000rpo24p1u0p5u,4

//Celera Confidential Do Not Copy RN4
rlpp3000rpo19p9u0p4u XRN4_0(
.RP (RN4),
.RN (RN4RN3_1),
.ISO (CELG)
);
rlpp3000rpo19p9u0p4u XRN4_1(
.RP (RN4RN3_1),
.RN (RN3),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo19p9u0p4u

//Die Size Calculator rlpp3000rpo19p9u0p4u
//,diesize,rlpp3000rpo19p9u0p4u,2

//Celera Confidential Do Not Copy RN3
rlpp3000rpo19p9u0p4u XRN3_0(
.RP (RN3),
.RN (RN2),
.ISO (CELG)
);
...
//Die Size Calculator rlpp3000rpo19p9u0p4u
//,diesize,rlpp3000rpo19p9u0p4u,1

//Celera Confidential Do Not Copy RN2
rlpp3000rpo19p9u0p4u XRN2_0(
.RP (RN2),
.RN (RN1),
.ISO (CELG)
);
rlpp3000rpo19p9u0p4u XRN2_1(
.RP (RN2),
.RN (RN1),
.ISO (CELG)
);
...
rlpp3000rpo19p9u0p4u XRN1_0(
.RP (RN1),
.RN (RN0),
.ISO (CELG)
);
rlpp3000rpo19p9u0p4u XRN1_1(
.RP (RN1),
.RN (RN0),
.ISO (CELG)
);
rlpp3000rpo19p9u0p4u XRN1_2(
.RP (RN1),
.RN (RN0),
.ISO (CELG)
);
rlpp3000rpo19p9u0p4u XRN1_3(
.RP (RN1),
.RN (RN0),
.ISO (CELG)
);
...
//Die Size Calculator rlpp3000rpo19p9u0p4u
//,diesize,rlpp3000rpo19p9u0p4u,4

//Celera Confidential Do Not Copy RN0
rlpp3000rpo19p9u0p4u XRN0_0(
.RP (RN0),
.RN (SENSE_G),
.ISO (CELG)
);
rlpp3000rpo19p9u0p4u XRN0_1(
.RP (RN0),
.RN (SENSE_G),
.ISO (CELG)
);
rlpp3000rpo19p9u0p4u XRN0_2(
.RP (RN0),
.RN (SENSE_G),
.ISO (CELG)
);
rlpp3000rpo19p9u0p4u XRN0_3(
.RP (RN0),
.RN (SENSE_G),
.ISO (CELG)
);
rlpp3000rpo19p9u0p4u XRN0_4(
.RP (RN0),
.RN (SENSE_G),
.ISO (CELG)
);
rlpp3000rpo19p9u0p4u XRN0_5(
.RP (RN0),
.RN (SENSE_G),
.ISO (CELG)
);
rlpp3000rpo19p9u0p4u XRN0_6(
.RP (RN0),
.RN (SENSE_G),
.ISO (CELG)
);
rlpp3000rpo19p9u0p4u XRN0_7(
.RP (RN0),
.RN (SENSE_G),
.ISO (CELG)
);
...
//Die Size Calculator rlpp3000rpo19p9u0p4u
//,diesize,rlpp3000rpo19p9u0p4u,8
