...
//CORE:sandh
//NAME:sandh_celeraadc_XTHERMOMETER_XMAIN_XADC_Xsandh
...
//Celera Confidential Do Not Copy ibiasmirror_sandh_celeraadc_Xsandh_IBIASMIRROR.v
//Celera:ibiasmirror_sandh_celeraadc_Xsandh_IBIASMIRROR
//Celera Confidential Symbol Generator
//OUTPUTS:2 VMAX:6V DFT:no
module ibiasmirror_sandh_celeraadc_Xsandh_IBIASMIRROR (SIMPV,IP,enable_ibiasmirror,global_ibiasmirror,ok_ibiasmirror,IPO,
CELG,CELSUB);
input SIMPV;
input IP;
...
//Celera Confidential Do Not Copy amplifier_sandh_celeraadc_XTHERMOMETER_XMAIN_XADC_Xsandh_Xampin.v

//Celera Confidential Do Not Copy amplifier_sandh_celeraadc_XTHERMOMETER_XMAIN_XADC_Xsandh_Xampout.v
...
//Celera Confidential Do Not Copy delayfixed_sandh_celeraadc_Xmaxsampledelay.v
//Celera:delayfixed_sandh_celeraadc_Xmaxsampledelay
//Celera Confidential Symbol Generator
//TYPE:fixed Egde:rise
module delayfixed_sandh_celeraadc_Xmaxsampledelay (CELV,i,o,
CELG,CELSUB);
input CELV;
input i;
output o;
...
//Celera Confidential Do Not Copy delayfixed_sandh_celeraadc_Xsandh_Xholddelay.v
//Celera:delayfixed_sandh_celeraadc_Xsandh_Xholddelay
//Celera Confidential Symbol Generator
//TYPE:fixed Egde:rise
module delayfixed_sandh_celeraadc_Xsandh_Xholddelay (CELV,i,o,
CELG,CELSUB);
input CELV;
input i;
output o;
...
//Celera Confidential Do Not Copy ibiasmirror_sandh_celeraadc_Xsandh_IBIASMIRROR
ibiasmirror_sandh_celeraadc_Xsandh_IBIASMIRROR Xibias(
.SIMPV (SIMPV),
.IP (IP),
...
//,diesize,ibiasmirror_sandh_celeraadc_Xsandh_IBIASMIRROR

//Celera Confidential Do Not Copy amplifier_sandh_celeraadc_XTHERMOMETER_XMAIN_XADC_Xsandh_Xampin
amplifier_sandh_celeraadc_XTHERMOMETER_XMAIN_XADC_Xsandh_Xampin Xampin(
.SIMPV (SIMPV),
.INP (IN),
.IP (IPO0),
...
//,diesize,amplifier_sandh_celeraadc_XTHERMOMETER_XMAIN_XADC_Xsandh_Xampin
...
//Celera Confidential Do Not Copy amplifier_sandh_celeraadc_XTHERMOMETER_XMAIN_XADC_Xsandh_Xampout
amplifier_sandh_celeraadc_XTHERMOMETER_XMAIN_XADC_Xsandh_Xampout Xampout(
.SIMPV (SIMPV),
.INP (CAP),
.IP (IPO1),
.enable_amplifier (enable),
...
//,diesize,amplifier_sandh_celeraadc_XTHERMOMETER_XMAIN_XADC_Xsandh_Xampout
...
//Celera Confidential Do Not Copy delayfixed_sandh_celeraadc_Xmaxsampledelay
delayfixed_sandh_celeraadc_Xmaxsampledelay Xmaxsampledelay(
.CELV (SIMPV),
.i (strobe_sandh),
.o (max_sample),
.CELSUB (CELSUB),
...
//,diesize,delayfixed_sandh_celeraadc_Xmaxsampledelay

//Celera Confidential Do Not Copy delayfixed_sandh_celeraadc_Xsandh_Xholddelay
delayfixed_sandh_celeraadc_Xsandh_Xholddelay Xholddelay(
.CELV (SIMPV),
.i (hold),
.o (delay_hold),
.CELSUB (CELSUB),
...
//,diesize,delayfixed_sandh_celeraadc_Xsandh_Xholddelay
