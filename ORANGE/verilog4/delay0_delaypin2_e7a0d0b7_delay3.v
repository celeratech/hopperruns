...
//CELL SOURCE:delay0
//NAME:delay0_delaypin2_e7a0d0b7_delay3
...
mim34_2f20p5x14p4 XC0_3(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x14p4 XC0_4(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x14p4 XC0_5(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x14p4 XC0_6(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x14p4 XC0_7(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x14p4 XC0_8(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x14p4 XC0_9(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x14p4 XC0_10(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x14p4 XC0_11(
.CP (C0),
.CN (CELG)
);
