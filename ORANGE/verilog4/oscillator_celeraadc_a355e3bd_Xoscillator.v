...
//CORE:oscillator
//NAME:oscillator_celeraadc_a355e3bd_Xoscillator
...
module mim34_2f27p6x22p1 (CP,CN);
inout CP;
inout CN;
endmodule
...
mim34_2f27p6x22p1 XCAPhf_0(
.CP (CL),
.CN (CELG)
);
mim34_2f27p6x22p1 XCAPhf_1(
.CP (CL),
.CN (CELG)
);
mim34_2f27p6x22p1 XCAPhf_2(
.CP (CL),
.CN (CELG)
);
