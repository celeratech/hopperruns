...
//Celera Confidential Do Not Copy vbuffer_thermometer_8fe611c5_Xbuffer.v
//Celera:vbuffer_thermometer_8fe611c5_Xbuffer
//Celera Confidential Symbol Generator
//GAIN:1.0 Input:np with 1000.0K Impedance
module vbuffer_thermometer_8fe611c5_Xbuffer (SIMPV,IN,IP,OUT,enable_vbuffer,ok_vbuffer,global_vbuffer,
CELG,CELSUB);
input SIMPV;
input IN;
input IP;
...
//Celera Confidential Do Not Copy ibiasmirror_thermometer_8fe611c5_IBIASMIRROR.v
//Celera:ibiasmirror_thermometer_8fe611c5_IBIASMIRROR
//Celera Confidential Symbol Generator
//OUTPUTS:2 VMAX:6V DFT:no
module ibiasmirror_thermometer_8fe611c5_IBIASMIRROR (SIMPV,IP,enable_ibiasmirror,global_ibiasmirror,ok_ibiasmirror,IPO,
CELG,CELSUB);
input SIMPV;
input IP;
...
//Celera Confidential Do Not Copy thermometer_8fe611c5
//Celera Confidential Symbol Generator
//THERMOMETER: with output Buffer
module thermometer_8fe611c5 (SIMPV,IP,global_thermometer,OUT_THERMOMETER,ok_thermometer,
enable_thermometer,
...
//Celera Confidential Do Not Copy vbuffer_thermometer_8fe611c5_Xbuffer
vbuffer_thermometer_8fe611c5_Xbuffer Xbuffer(
.SIMPV (SIMPV),
.IN (THERMOMETER_OUT),
.IP (IPO1),
...
//,diesize,vbuffer_thermometer_8fe611c5_Xbuffer

//Celera Confidential Do Not Copy ibiasmirror_thermometer_8fe611c5_IBIASMIRROR
ibiasmirror_thermometer_8fe611c5_IBIASMIRROR Xibias(
.SIMPV (SIMPV),
.IP (IP),
...
//,diesize,ibiasmirror_thermometer_8fe611c5_IBIASMIRROR
