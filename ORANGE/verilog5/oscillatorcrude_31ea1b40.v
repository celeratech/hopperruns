...
//Celera Confidential Do Not Copy CAPaccuracy
module mim34_2f21p1x16p7 (CP,CN);
inout CP;
inout CN;
endmodule

//Celera Confidential Do Not Copy mim34_2f30p0x28p2
module mim34_2f30p0x28p2 (CP,CN);
inout CP;
inout CN;
endmodule
...
//Celera Confidential Do Not Copy oscillatorcrude_31ea1b40
//Celera Confidential Symbol Generator
//VMAX:globalV,Crude:1.024KHz
module oscillatorcrude_31ea1b40 (SIMPV,ok_oscillator,osc,global_oscillator,
...
mim34_2f21p1x16p7 XCT10(
.CP (CRT0),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CT3_
mim34_2f21p1x16p7 XCT3_0(
.CP (CRT1),
.CN (SENSE_G)
);
mim34_2f21p1x16p7 XCT3_1(
.CP (CRT1),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CT5_
mim34_2f21p1x16p7 XCT5_0(
.CP (CRT2),
.CN (SENSE_G)
);
mim34_2f21p1x16p7 XCT5_1(
.CP (CRT2),
.CN (SENSE_G)
);
mim34_2f21p1x16p7 XCT5_2(
.CP (CRT2),
.CN (SENSE_G)
);
mim34_2f21p1x16p7 XCT5_3(
.CP (CRT2),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CT0
mim34_2f21p1x16p7 XCT00(
.CP (CLT0),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CT2_
mim34_2f21p1x16p7 XCT2_0(
.CP (CLT1),
.CN (SENSE_G)
);
mim34_2f21p1x16p7 XCT2_1(
.CP (CLT1),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CT4_
mim34_2f21p1x16p7 XCT4_0(
.CP (CLT2),
.CN (SENSE_G)
);
mim34_2f21p1x16p7 XCT4_1(
.CP (CLT2),
.CN (SENSE_G)
);
mim34_2f21p1x16p7 XCT4_2(
.CP (CLT2),
.CN (SENSE_G)
);
mim34_2f21p1x16p7 XCT4_3(
.CP (CLT2),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CAPon__
mim34_2f30p0x28p2 XCAPon__0(
.CP (CR),
.CN (SENSE_G)
);
mim34_2f30p0x28p2 XCAPon__1(
.CP (CR),
.CN (SENSE_G)
);
mim34_2f30p0x28p2 XCAPon__2(
.CP (CR),
.CN (SENSE_G)
);
mim34_2f30p0x28p2 XCAPon__3(
.CP (CR),
.CN (SENSE_G)
);
mim34_2f30p0x28p2 XCAPon__4(
.CP (CR),
.CN (SENSE_G)
);
mim34_2f30p0x28p2 XCAPon__5(
.CP (CR),
.CN (SENSE_G)
);
mim34_2f30p0x28p2 XCAPon__6(
.CP (CR),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CAPoff__
mim34_2f30p0x28p2 XCAPoff__0(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x28p2 XCAPoff__1(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x28p2 XCAPoff__2(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x28p2 XCAPoff__3(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x28p2 XCAPoff__4(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x28p2 XCAPoff__5(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x28p2 XCAPoff__6(
.CP (CL),
.CN (SENSE_G)
);
