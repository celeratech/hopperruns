...
STONEnoconn XNCIP_9a4148db (
.noconn(noconn_IN_IP_9a4148db)
);
...
.V(SIMPV),
.IN(noconn_IN_IP_9a4148db),
.IP(IP_9a4148db)
);

vpulse_0x5d0x1d0ux12ux1nx1nx500d0n XV4_e35a5ca2 (
.PLUS(net_466),
.MINUS(net_122)
);
...
vpwl_0x0_10d998ux0_11d0ux0 V_mode_cvx_bac4ba19 (
.PLUS(net_464),
.MINUS(net_122)
);
...
vpwl_0x0_10d998ux0_11d0ux0 V_done_telemetryx_197fcab8 (
.PLUS(net_468),
.MINUS(net_122)
);

vpwl_0x0_0d999ux0_1d0ux5 Xdatamap1_register_pwl_bit0 (
.PLUS(register_vshunt_15[0]),
.MINUS(net_0)
);

vpwl_0x0_1d0ux0 Xdatamap1_register_pwl_bit1 (
.PLUS(register_vshunt_15[1]),
.MINUS(net_0)
);

vpwl_0x0_1d0ux0 Xdatamap1_register_pwl_bit2 (
.PLUS(register_vshunt_15[2]),
.MINUS(net_0)
);

vpwl_0x0_0d999ux0_1d0ux5 Xdatamap1_register_pwl_bit3 (
.PLUS(register_vshunt_15[3]),
.MINUS(net_0)
);

vpwl_0x0_0d999ux0_1d0ux5 Xdatamap1_register_pwl_bit4 (
.PLUS(register_vshunt_15[4]),
.MINUS(net_0)
);

vpwl_0x0_1d0ux0 Xdatamap1_register_pwl_bit5 (
.PLUS(register_vshunt_15[5]),
.MINUS(net_0)
);

vpwl_0x0_1d0ux0 Xdatamap1_register_pwl_bit6 (
.PLUS(register_vshunt_15[6]),
.MINUS(net_0)
);

vpwl_0x0_0d999ux0_1d0ux5 Xdatamap1_register_pwl_bit7 (
.PLUS(register_vshunt_15[7]),
.MINUS(net_0)
);

vpwl_0x0_0d999ux0_1d0ux5 Xdatamap1_register_pwl_bit8 (
.PLUS(register_vshunt_15[8]),
.MINUS(net_0)
);

vpwl_0x0_1d0ux0 Xdatamap1_register_pwl_bit9 (
.PLUS(register_vshunt_15[9]),
.MINUS(net_0)
);

vpwl_0x0_1d0ux0 Xdatamap1_register_pwl_bit10 (
.PLUS(register_vshunt_15[10]),
.MINUS(net_0)
);

vpwl_0x0_0d999ux0_1d0ux5 Xdatamap1_register_pwl_bit11 (
.PLUS(register_vshunt_15[11]),
.MINUS(net_0)
);

vpwl_0x0_0d999ux0_1d0ux5 Xdatamap1_register_pwl_bit12 (
.PLUS(register_vshunt_15[12]),
.MINUS(net_0)
);

vpwl_0x0_0d999ux0_1d0ux5 Xdatamap1_register_pwl_bit13 (
.PLUS(register_vshunt_15[13]),
.MINUS(net_0)
);

vpwl_0x0_1d0ux0 Xdatamap1_register_pwl_bit14 (
.PLUS(register_vshunt_15[14]),
.MINUS(net_0)
);

vpwl_0x0_1d0ux0 Xdatamap1_register_pwl_bit15 (
.PLUS(register_vshunt_15[15]),
.MINUS(net_0)
);

vpwl_0x0_10d998ux0_11d0ux5d0 V_enable_capcalculatex_e24eb4d4 (
.PLUS(net_467),
.MINUS(net_122)
);

vpwl_0x0_10d998ux0_11d0ux0 V_kelvin_GNDcalculatorx_16189e6a (
.PLUS(net_123),
.MINUS(net_122)
);

vdc_0 VI__kelvin_GNDcalculator_b0ae994b (
.PLUS(kelvin_GNDcalculator),
.MINUS(net_123)
);

vpwl_0x0_10d998ux0_11d0ux0 V_enable_chargereferencex_b48e7d4c (
.PLUS(net_471),
.MINUS(net_122)
);
