...
module ipwl_0x0_10d0ux0_11d0ux1d0n(PLUS, MINUS);
output PLUS;
output MINUS;
endmodule
...
module vpwl_0x0_10d0ux0_11d0ux6 (PLUS,MINUS);
  output  PLUS;
  output  MINUS;
endmodule
...
vpwl_0x0_10d0ux0_11d0ux0 V_ENx (
.PLUS(net_62),
.MINUS(GND)
);
...
ipwl_0x0_10d0ux0_11d0ux1d0n I_VCCx (
.PLUS(net_63),
.MINUS(GND)
);
...
vpwl_0x0_10d0ux0_11d0ux6 V_BIASx (
.PLUS(net_59),
.MINUS(GND)
);
