...
module mim34_2f27p7x22p1 (CP,CN);
inout CP;
inout CN;
endmodule
...
//Celera Confidential Do Not Copy oscillatorcrude_c20ae7fc
//Celera Confidential Symbol Generator
//VMAX:globalV,Crude:256.000KHz
module oscillatorcrude_c20ae7fc (SIMPV,ok_oscillator,osc,global_oscillator,
enable_oscillator,
IP,
CELG,SENSE_G,CELSUB);
input SIMPV;
...
mim34_2f27p7x22p1 XCAPon_0(
.CP (CR),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CAPoff_
mim34_2f27p7x22p1 XCAPoff_0(
.CP (CL),
.CN (SENSE_G)
);
