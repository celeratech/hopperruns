...
//,diesize,rlpp3000rpo95p6u1p3u,9
...
rlpp3000rpo95p6u1p3u XRFB0_6(
.RP (REFDIV2celkelvin_GNDref_B),
.RN (celkelvin_GNDref),
.ISO (CELG)
);
rlpp3000rpo95p6u1p3u XRFB0_7(
.RP (REFDIV2celkelvin_GNDref_B),
.RN (celkelvin_GNDref),
.ISO (CELG)
);
rlpp3000rpo95p6u1p3u XRFB0_8(
.RP (REFDIV2celkelvin_GNDref_B),
.RN (celkelvin_GNDref),
.ISO (CELG)
);
...
rlpp3000rpo95p6u1p3u XRFB1_6(
.RP (REFIREFDIV2_B),
.RN (REFDIV2),
.ISO (CELG)
);
rlpp3000rpo95p6u1p3u XRFB1_7(
.RP (REFIREFDIV2_B),
.RN (REFDIV2),
.ISO (CELG)
);
rlpp3000rpo95p6u1p3u XRFB1_8(
.RP (REFIREFDIV2_B),
.RN (REFDIV2),
.ISO (CELG)
);
...
//Die Size Calculator rlpp3000rpo95p6u1p3u
//,diesize,rlpp3000rpo95p6u1p3u,1
