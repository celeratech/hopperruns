...
//Celera Confidential Do Not Copy Resistor Divider
module rlpp3000rpo18p5u0p4u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule
...
rlpp3000rpo18p5u0p4u XRTOP_0(
.RP (TOP),
.RN (TOPTAP0_1),
.ISO (CELG)
);
rlpp3000rpo18p5u0p4u XRTOP_1(
.RP (TOPTAP0_1),
.RN (TOPTAP0_2),
.ISO (CELG)
);
rlpp3000rpo18p5u0p4u XRTOP_2(
.RP (TOPTAP0_2),
.RN (TOPTAP0_3),
.ISO (CELG)
);
rlpp3000rpo18p5u0p4u XRTOP_3(
.RP (TOPTAP0_3),
.RN (TOPTAP0_4),
.ISO (CELG)
);
rlpp3000rpo18p5u0p4u XRTOP_4(
.RP (TOPTAP0_4),
.RN (TAP0),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo18p5u0p4u

//Die Size Calculator rlpp3000rpo18p5u0p4u
//,diesize,rlpp3000rpo18p5u0p4u,5
