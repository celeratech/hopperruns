// ------------------------ Module Definitions -----------
module feedbackdivider_e387aa9c (CELV,SUB,SENSE_FEEDBACKDIVIDER,FEEDBACKDIVIDER_FB,ten,RTN,pin1,pin2,pin3,enable_feedbackdivider,CELG);
  input  RTN;
  input  SUB;
  input  ten;
  input  CELG;
