...
module mim34_2f19p0x15p2 (CP,CN);
inout CP;
inout CN;
endmodule
...
//Celera Confidential Do Not Copy oscillatorcrude_c74643e1
//Celera Confidential Symbol Generator
//VMAX:globalV,Crude:32.000KHz
module oscillatorcrude_c74643e1 (SIMPV,ok_oscillator,osc,global_oscillator,
enable_oscillator,
IP,
CELG,SENSE_G,CELSUB);
input SIMPV;
...
mim34_2f19p0x15p2 XCAPon_0(
.CP (CR),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CAPoff_
mim34_2f19p0x15p2 XCAPoff_0(
.CP (CL),
.CN (SENSE_G)
);
