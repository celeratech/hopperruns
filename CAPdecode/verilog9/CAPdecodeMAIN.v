// ------------------------ Module Definitions -----------
module CAPDECODEpugetCOMPARATOR (out,FALL,RISE,SIMPV,enable,POSITIVE,CELG59462,CELV96848,CELSUB40948,IP_ddbf19a4,ok_comparator);
  output  out;
  input  FALL;
  input  RISE;
  input  SIMPV;
...
// ------------------------ Module Verilog ---------------
module CAPdecodeMAIN (porb, SIMPV, VCC2P5, CAPSLCT0, CAPSLCT1, CELG59462, CELV96848, CAPcount_0, CAPcount_1, dft_sample, CELSUB40948, IP_cc6aff98, IP_ddbf19a4, cap2_active, cap3_active, cap4_active, dft_select0, dft_select1, dft_startup, done_capdecode, hijack_measure, dft_sampleDELAY, kelvin_GNDcapdecode, enable_capcitordecode);
input  porb;
input  SIMPV;
inout  VCC2P5;
input  CAPSLCT0;
...
CAPDECODEpugetCOMPARATOR_6efaead1 XCOMPARATOR1 (
.out(net_151),
.FALL(net_190),
.RISE(net_189),
.SIMPV(SIMPV),
