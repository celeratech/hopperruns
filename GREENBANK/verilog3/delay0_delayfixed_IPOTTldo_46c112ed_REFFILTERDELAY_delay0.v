...
//CELL SOURCE:delay0
//NAME:delay0_delayfixed_IPOTTldo_46c112ed_REFFILTERDELAY_delay0
...
module mim34_2f20p5x13p8 (CP,CN);
inout CP;
inout CN;
endmodule
...
mim34_2f20p5x13p8 XC0_0(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x13p8 XC0_1(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x13p8 XC0_2(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x13p8 XC0_3(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x13p8 XC0_4(
.CP (C0),
.CN (CELG)
);

//Celera Confidential Do Not Copy //DieSize,mim34_2f20p5x13p8

//Die Size Calculator mim34_2f20p5x13p8
//,diesize,mim34_2f20p5x13p8,5
