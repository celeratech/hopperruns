...
module pad_GREENBANK_LDO1 (GESD,LDO1,MUDV);
  input  GESD;
  inout  LDO1;
  inout  MUDV;
endmodule

module pad_GREENBANK_LDO10 (GESD,MUDV,LDO10,celkelvin_LDO10_9b1f0b60);
  input  GESD;
  inout  MUDV;
  inout  LDO10;
...
module pad_GREENBANK_LDO13 (GESD,MUDV,LDO13,celkelvin_LDO13_e09c7b4a);
  input  GESD;
  inout  MUDV;
  inout  LDO13;
...
module pad_GREENBANK_LDO14 (GESD,MUDV,LDO14,celkelvin_LDO14_31b80673);
  input  GESD;
  inout  MUDV;
  inout  LDO14;
...
module pad_GREENBANK_LDO3 (GESD,LDO3,MUDV);
  input  GESD;
  inout  LDO3;
  inout  MUDV;
endmodule

module pad_GREENBANK_LDO4 (GESD,LDO4,MUDV);
  input  GESD;
  inout  LDO4;
  inout  MUDV;
endmodule
...
module pad_GREENBANK_LDO6 (GESD,LDO6,MUDV);
  input  GESD;
  inout  LDO6;
  inout  MUDV;
endmodule

module pad_GREENBANK_LDO7 (GESD,LDO7,MUDV,sense_LDO7);
  input  GESD;
  inout  LDO7;
  inout  MUDV;
  inout  sense_LDO7;
...
module pad_GREENBANK_LDO9 (GESD,LDO9,MUDV,celkelvin_LDO9_e7f88029);
  input  GESD;
  inout  LDO9;
  inout  MUDV;
...
module pad_GREENBANK_MUDV (GESD,MUDV,CELV96848,kelvin_MUDV,CELPOWER_LDO,CELPOWER_LDO_62423880,CELPOWER_LDO_af77ae17,CELPOWER_LDO_d8ea4418,CELPOWER_LDO_fd4a89e4,celkelvin_MUDV_4be07aeb);
  input  GESD;
  inout  MUDV;
  output  CELV96848;
  inout  kelvin_MUDV;
...
// ------------------------ Module Verilog ---------------
module GREENBANKceleraRING (TAO, tdo, tmi, LDO0, LDO1, LDO2, LDO3, LDO4, LDO5, LDO6, LDO7, LDO8, LDO9, MUDG, MUDV, LDO10, LDO11, LDO12, LDO13, LDO14, LDO15, TAEXT, CELINA, CELIND, DFTSCL, DFTSDA, unlock, CELOUTA, CELOUTD, CELG59462, CELV96848, sense_LDO2, sense_LDO5, sense_LDO7, CELSUB40948, kelvin_MUDV, CELPOWER_LDO, SENSE_G_30a24d84, kelvin_MUDGservice, kelvin_MUDGamplifier, CELPOWER_LDO_62423880, CELPOWER_LDO_af77ae17, CELPOWER_LDO_d8ea4418, CELPOWER_LDO_fd4a89e4, celkelvin_LDO8_37713079, celkelvin_LDO9_e7f88029, celkelvin_MUDG_2e498fae, celkelvin_MUDG_31b80673, celkelvin_MUDG_37713079, celkelvin_MUDG_58ede99a, celkelvin_MUDG_5f8d3afe, celkelvin_MUDG_92a31bd7, celkelvin_MUDG_9b1f0b60, celkelvin_MUDG_ac0a699d, celkelvin_MUDG_dbb8d281, celkelvin_MUDG_e09c7b4a, celkelvin_MUDG_e5e6d906, celkelvin_MUDG_e7f88029, celkelvin_MUDG_f3f88263, celkelvin_MUDV_4be07aeb, celkelvin_LDO10_9b1f0b60, celkelvin_LDO11_58ede99a, celkelvin_LDO12_dbb8d281, celkelvin_LDO13_e09c7b4a, celkelvin_LDO14_31b80673, celkelvin_LDO15_92a31bd7);
inout  TAO;
inout  tdo;
inout [4:0] tmi;
inout  LDO0;
...
// ------------------------ Networks ---------------------
pad_GREENBANK_DFTSCL XDFTSCL (
.GESD(GESD),
.DFTSCL(DFTSCL)
);

pad_GREENBANK_DFTSDA XDFTSDA (
.GESD(GESD),
.DFTSDA(DFTSDA)
);

pad_GREENBANK_LDO0 XLDO0 (
.GESD(GESD),
.LDO0(LDO0),
.MUDV(MUDV)
);

pad_GREENBANK_LDO1 XLDO1 (
.GESD(GESD),
.LDO1(LDO1),
.MUDV(MUDV)
);

pad_GREENBANK_LDO10 XLDO10 (
.GESD(GESD),
.MUDV(MUDV),
.LDO10(LDO10),
...
pad_GREENBANK_LDO3 XLDO3 (
.GESD(GESD),
.LDO3(LDO3),
.MUDV(MUDV)
);

pad_GREENBANK_LDO4 XLDO4 (
.GESD(GESD),
.LDO4(LDO4),
.MUDV(MUDV)
);

pad_GREENBANK_LDO5 XLDO5 (
.GESD(GESD),
.LDO5(LDO5),
.MUDV(MUDV),
...
pad_GREENBANK_LDO6 XLDO6 (
.GESD(GESD),
.LDO6(LDO6),
.MUDV(MUDV)
);

pad_GREENBANK_LDO7 XLDO7 (
.GESD(GESD),
.LDO7(LDO7),
.MUDV(MUDV),
