...
// ------------------------ Module Verilog ---------------
module GREENBANK (LDO0, LDO1, LDO2, LDO3, LDO4, LDO5, LDO6, LDO7, LDO8, LDO9, MUDG, MUDV, LDO10, LDO11, LDO12, LDO13, LDO14, LDO15, CELINA, CELIND, CELOUTA, CELOUTD);
inout  LDO0;
inout  LDO1;
inout  LDO2;
inout  LDO3;
...
GREENBANKceleraSERDES XceleraSERDES (
.pd0(pd0),
.tdo(tdo),
.tmi(tmi[5:0]),
.GOTP(GOTP),
