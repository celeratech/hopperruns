...
//Celera:amplifier_6348de59
//Celera Confidential Symbol Generator
//Gain Adjust:openloop, Input Type:p, Bandwidth:medium
module amplifier_6348de59 (SIMPV,INP,IP,OUT,enable_amplifier,ok_amplifier,global_amplifier,
INN,
CELG,CELSUB);
input SIMPV;
input INP;
...
amplifier_6348de59 Xamplifier1 (
.IP(IP_be65c403),
...
.global_amplifier(global_amplifier_be65c403_Xamplifier1)
);
...
.a({a1,a0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x08_ten_7,noconn_dft_hex0x08_ten_6,noconn_dft_hex0x08_ten_5,noconn_dft_hex0x08_ten_4,noconn_dft_hex0x08_ten_3,noconn_dft_hex0x08_ten_2,noconn_dft_hex0x08_ten_1,global_amplifier_be65c403_Xamplifier1}),
