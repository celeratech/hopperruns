...
//Celera Confidential Do Not Copy feedbackdivider_IPOTTldo_46c112ed_FBD.v
//Celera:feedbackdivider_IPOTTldo_46c112ed_FBD
//Celera Confidential Symbol Generator
//Type: fixed,Feedback: 0.800V, Disconnect: pin, P Offset: 10%, N Offset: 0%, Bias Current: 10uA, DFT: no
//VOUT:3.3
module feedbackdivider_IPOTTldo_46c112ed_FBD (SIMPV,CELSUB,kelvin_FEEDBACKDIVIDER,FEEDBACKDIVIDER_FB,global_feedbackdivider,RTN,
...
//Celera Confidential Do Not Copy fet_IPOTTldo_46c112ed_PFET.v
//Celera:fet_IPOTTldo_46c112ed_PFET
//Celera Confidential Symbol Generator
//power PMOS:Ron:0.500 Ohm
//Vgs 6V Vds 6V
//Kelvin:no

module fet_IPOTTldo_46c112ed_PFET (GATE,DRAIN,
SOURCE,
PMOSiso6,SUB);
input GATE;
inout SOURCE;
...
//Celera Confidential Do Not Copy delayfixed_IPOTTldo_46c112ed_REFFILTERDELAY.v
//Celera:delayfixed_IPOTTldo_46c112ed_REFFILTERDELAY
//Celera Confidential Symbol Generator
//TYPE:fixed Egde:rise
module delayfixed_IPOTTldo_46c112ed_REFFILTERDELAY (CELV,i,o,
CELG,CELSUB);
input CELV;
input i;
output o;
...
//Celera Confidential Do Not Copy rcnetwork_IPOTTldo_46c112ed_REFFILTER.v
//Celera:rcnetwork_IPOTTldo_46c112ed_REFFILTER
//Celera Confidential Symbol Generator
...
//Celera Confidential Do Not Copy rcnetwork_IPOTTldo_46c112ed_GAIN.v
//Celera:rcnetwork_IPOTTldo_46c112ed_GAIN
//Celera Confidential Symbol Generator
//RC Netork:series R:600.0 KOhm C:0 pF
module rcnetwork_IPOTTldo_46c112ed_GAIN (IN,
CELSUB,
OUT); 
inout IN;
inout OUT;
...
//Celera Confidential Do Not Copy rcnetwork_IPOTTldo_46c112ed_PSRR.v
//Celera:rcnetwork_IPOTTldo_46c112ed_PSRR
//Celera Confidential Symbol Generator
//RC Netork:series R:200.0 KOhm C:5.0 pF
module rcnetwork_IPOTTldo_46c112ed_PSRR (IN,
CELSUB,
OUT); 
inout IN;
inout OUT;
...
//Celera Confidential Do Not Copy rcnetwork_IPOTTldo_46c112ed_FEEDFORWARD.v
//Celera:rcnetwork_IPOTTldo_46c112ed_FEEDFORWARD
//Celera Confidential Symbol Generator
//RC Netork:series R:0 KOhm C:10.0 pF
module rcnetwork_IPOTTldo_46c112ed_FEEDFORWARD (IN,
OUT); 
inout IN;
inout OUT;
endmodule
...
//Celera Confidential Do Not Copy rcnetwork_IPOTTldo_46c112ed_COMPENSATION.v
//Celera:rcnetwork_IPOTTldo_46c112ed_COMPENSATION
//Celera Confidential Symbol Generator
//RC Netork:series R:200.0 KOhm C:12.0 pF
module rcnetwork_IPOTTldo_46c112ed_COMPENSATION (IN,
CELSUB,
OUT); 
inout IN;
inout OUT;
...
//Celera Confidential Do Not Copy IPOTTldo_46c112ed
//Celera Confidential Symbol Generator
//LDO:Output 3.3V
...
//Celera Confidential Do Not Copy feedbackdivider_IPOTTldo_46c112ed_FBD
feedbackdivider_IPOTTldo_46c112ed_FBD XFDB(
.SIMPV (SIMPV),
...
//,diesize,feedbackdivider_IPOTTldo_46c112ed_FBD
//Celera Confidential Do Not Copy fet_IPOTTldo_46c112ed_PFET
fet_IPOTTldo_46c112ed_PFET XPFET(
.GATE (PGATE),
.SOURCE (CELPOWER_LDO),
.DRAIN (LDO),
...
//,diesize,fet_IPOTTldo_46c112ed_PFET
//Celera Confidential Do Not Copy STONEldoOUTPUT
...
//Celera Confidential Do Not Copy rcnetwork_IPOTTldo_46c112ed_GAIN
rcnetwork_IPOTTldo_46c112ed_GAIN XGAIN(
.IN (COMP),
.OUT (GATE),
.CELSUB (CELG)
);
//,diesize,rcnetwork_IPOTTldo_46c112ed_GAIN
//Celera Confidential Do Not Copy rcnetwork_IPOTTldo_46c112ed_PSRR
rcnetwork_IPOTTldo_46c112ed_PSRR XPSRR(
.IN (SIMPV),
.OUT (AMP),
.CELSUB (CELG)
);
//,diesize,rcnetwork_IPOTTldo_46c112ed_PSRR
//Celera Confidential Do Not Copy rcnetwork_IPOTTldo_46c112ed_FEEDFORWARD
rcnetwork_IPOTTldo_46c112ed_FEEDFORWARD XFEEDFORWARD(
.IN (ERROR),
.OUT (celkelvin_LDO)
);
//,diesize,rcnetwork_IPOTTldo_46c112ed_FEEDFORWARD
//Celera Confidential Do Not Copy rcnetwork_IPOTTldo_46c112ed_COMPENSATION
rcnetwork_IPOTTldo_46c112ed_COMPENSATION XCOMPENSATION(
.IN (GATE),
.OUT (COMP),
.CELSUB (CELG)
);
//,diesize,rcnetwork_IPOTTldo_46c112ed_COMPENSATION
//Celera Confidential Do Not Copy STONEldoDFT
