...
//Celera Confidential Do Not Copy resistor_amplifier_3f8fec6d_XresR1.v
//Celera:resistor_amplifier_3f8fec6d_XresR1
//Celera Confidential Symbol Generator
//RESISTOR:200.00KOhm TYPE:poly DFT:no
module resistor_amplifier_3f8fec6d_XresR1 (RP,
CELG,
RN);
inout RP;
inout RN;
...
//Celera Confidential Do Not Copy resistor_amplifier_3f8fec6d_XresRF.v
//Celera:resistor_amplifier_3f8fec6d_XresRF
//Celera Confidential Symbol Generator
//RESISTOR:1800.00KOhm TYPE:poly DFT:no
module resistor_amplifier_3f8fec6d_XresRF (RP,
CELG,
RN);
inout RP;
inout RN;
...
//Celera Confidential Do Not Copy amplifier_3f8fec6d
//Celera Confidential Symbol Generator
//Gain Adjust:fixed, Input Type:p, Bandwidth:high
module amplifier_3f8fec6d (SIMPV,INP,IP,OUT,enable_amplifier,ok_amplifier,global_amplifier,
...
TAI_INN_AMPLIFIER,TAI_INP_AMPLIFIER,TAI_OUT_AMPLIFIER,tdi_ok_amplifier,INN,
CELG,CELSUB);
input SIMPV;
input INP;
input INN;
...
//,diesize,STONEampdft
//Celera Confidential Do Not Copy resistor_amplifier_3f8fec6d_XresR1
resistor_amplifier_3f8fec6d_XresR1 XresR1(
.CELG (CELG),
.RP (FB),
.RN (INN)
);
//,diesize,resistor_amplifier_3f8fec6d_XresR1
//Celera Confidential Do Not Copy resistor_amplifier_3f8fec6d_XresRF
resistor_amplifier_3f8fec6d_XresRF XresRF(
.CELG (CELG),
.RP (OUT),
.RN (FB)
);
//,diesize,resistor_amplifier_3f8fec6d_XresRF
//Celera Confidential Do Not Copy STONEdelay10usRise
