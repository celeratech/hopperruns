...
//Celera Confidential Do Not Copy resistor_amplifier_18c4b7e8_XresR1.v
//Celera:resistor_amplifier_18c4b7e8_XresR1
//Celera Confidential Symbol Generator
//RESISTOR:200.00KOhm TYPE:poly DFT:no
module resistor_amplifier_18c4b7e8_XresR1 (RP,
CELG,
RN);
inout RP;
inout RN;
...
//Celera Confidential Do Not Copy resistor_amplifier_18c4b7e8_XresRF.v
//Celera:resistor_amplifier_18c4b7e8_XresRF
//Celera Confidential Symbol Generator
//RESISTOR:1800.00KOhm TYPE:poly DFT:no
module resistor_amplifier_18c4b7e8_XresRF (RP,
CELG,
RN);
inout RP;
inout RN;
...
//Celera Confidential Do Not Copy amplifier_18c4b7e8
//Celera Confidential Symbol Generator
//Gain Adjust:fixed, Input Type:np, Bandwidth:low
module amplifier_18c4b7e8 (SIMPV,INP,IP,OUT,enable_amplifier,ok_amplifier,global_amplifier,
INN,
CELG,CELSUB);
input SIMPV;
input INP;
...
//Celera Confidential Do Not Copy resistor_amplifier_18c4b7e8_XresR1
resistor_amplifier_18c4b7e8_XresR1 XresR1(
.CELG (CELG),
.RP (FB),
.RN (INN)
);
//,diesize,resistor_amplifier_18c4b7e8_XresR1
//Celera Confidential Do Not Copy resistor_amplifier_18c4b7e8_XresRF
resistor_amplifier_18c4b7e8_XresRF XresRF(
.CELG (CELG),
.RP (OUT),
.RN (FB)
);
//,diesize,resistor_amplifier_18c4b7e8_XresRF
//Celera Confidential Do Not Copy STONEdelay10usRise
