...
//Celera Confidential Do Not Copy STONEcurrentmirrorpmos500nrefhv45
//Verilog HDL for "Generate", "STONEcurrentmirrorpmos500nrefhv45" "functional"


module STONEcurrentmirrorpmos500nrefhv45 ( SUB, CELV, PCASHV, HVPOS, NSINK,
...
//Celera Confidential Do Not Copy STONEcurrentmirrorpmos500nhv45
//Verilog HDL for "Generate", "STONEcurrentmirrorpmos500nhv45" "functional"


module STONEcurrentmirrorpmos500nhv45 ( SUB, HVPOS, OUT, PCASHV, IN );
...
//Celera Confidential Do Not Copy currentmirror4_cc8c710b
...
//Celera Confidential Do Not Copy STONEcurrentmirrorpmos500nhv45
STONEcurrentmirrorpmos500nhv45 XcurrentmirrorPMOS500NHV4500(
.OUT (I0),
.HVPOS (HVPOS),
.IN (IN0),
.PCASHV (PCASHV),
...
//,diesize,STONEcurrentmirrorpmos500nhv45
//Celera Confidential Do Not Copy CASCODEpmos500nref
...
//Celera Confidential Do Not Copy STONEcurrentmirrorpmos500nrefhv45
STONEcurrentmirrorpmos500nrefhv45 XcurrentmirrorPMOS500NREFHV45(
.CELV (SIMPV),
.enhv (enhv),
.HVPOS (HVPOS),
.PCAS (PCAS500N),
...
//,diesize,STONEcurrentmirrorpmos500nrefhv45
//Celera Confidential Do Not Copy CASCODEnmos500n
...
//,diesize,CASCODEpmos500n
//Celera Confidential Do Not Copy STONEcurrentmirrorpmos500nhv45
STONEcurrentmirrorpmos500nhv45 XcurrentmirrorPMOS500NHV4510(
.OUT (I1),
.HVPOS (HVPOS),
.IN (IN1),
.PCASHV (PCASHV),
...
//,diesize,CASCODEpmos500n
//Celera Confidential Do Not Copy STONEcurrentmirrorpmos500nhv45
STONEcurrentmirrorpmos500nhv45 XcurrentmirrorPMOS500NHV4520(
.OUT (I2),
.HVPOS (HVPOS),
.IN (IN2),
.PCASHV (PCASHV),
...
//,diesize,CASCODEpmos500n
//Celera Confidential Do Not Copy STONEcurrentmirrorpmos500nhv45
STONEcurrentmirrorpmos500nhv45 XcurrentmirrorPMOS500NHV4530(
.OUT (I3),
.HVPOS (HVPOS),
.IN (IN3),
.PCASHV (PCASHV),
