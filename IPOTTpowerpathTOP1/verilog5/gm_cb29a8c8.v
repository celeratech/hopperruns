...
//Celera Confidential Do Not Copy CASCODEgminpcore1x
//Verilog HDL for "CASCODES", "CASCODEgminpcore1x" "functional"


module CASCODEgminpcore1x ( CELV, PCAS500N, IDPP, CELG, IP, SUB, IDNP, PMIR500N,
...
//Celera Confidential Do Not Copy gm_cb29a8c8
...
//Celera Confidential Do Not Copy CASCODEgminpcore1x
CASCODEgminpcore1x XgmINP_CORE1X(
.PIDNP (PIDPP),
.IDNP (IDNP),
.CELV (SIMPV),
.INP (INP),
...
.INP (INP),
.IDPP (IDPP),
.trim_gmpos ({a0,a0,a0,trim_gm_positive[3],trim_gm_positive[2],trim_gm_positive[1],trim_gm_positive[0]}),
.ISP (ISP),
.INN (INN),
.CELG (CELG),
.trim_gmneg ({a0,a0,a0,trim_gm_negative[3],trim_gm_negative[2],trim_gm_negative[1],trim_gm_negative[0]}),
.SUB (CELSUB)
);
