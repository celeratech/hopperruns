...
//Celera Confidential Do Not Copy fet_fetdriver_db144989_Xnmos0.v
//Celera:fet_fetdriver_db144989_Xnmos0
//Celera Confidential Symbol Generator
//power NMOS:Ron:0.100 Ohm
//Vgs 6V Vds 6V
//Kelvin:no

module fet_fetdriver_db144989_Xnmos0 (GATE,SOURCE,DRAIN,NMOSiso6,SUB);
input GATE;
inout SOURCE;
inout DRAIN;
input SUB;
...
//Celera Confidential Do Not Copy fet_fetdriver_db144989_Xpmos0.v
//Celera:fet_fetdriver_db144989_Xpmos0
//Celera Confidential Symbol Generator
//power PMOS:Ron:0.100 Ohm
//Vgs 6V Vds 6V
//Kelvin:no

module fet_fetdriver_db144989_Xpmos0 (GATE,DRAIN,
SOURCE,
PMOSiso6,SUB);
input GATE;
inout SOURCE;
...
//Celera Confidential Do Not Copy resistor_resistor_fetdriver_db144989_Xpassive.v
//Celera:resistor_resistor_fetdriver_db144989_Xpassive
//Celera Confidential Symbol Generator
//RESISTOR:1000.00KOhm TYPE:poly DFT:no
module resistor_resistor_fetdriver_db144989_Xpassive (RP,
CELG,
RN);
inout RP;
inout RN;
...
//Celera Confidential Do Not Copy fetdriver_db144989
//Celera Confidential Symbol Generator
//FET DRIVER 'n' Type 0.100 Ron 0.100 Roff 
//Input 6V Levelshifter
//Gate Sense None
//DFT no
module fetdriver_db144989 (HVPOS,global_fetdriver,fetin,GATE,gate_status,
CELV,
CELG,
enable_fetdriver,
HVNEG,CELSUB); 
...
//Celera Confidential Do Not Copy fet_fetdriver_db144989_Xnmos0
fet_fetdriver_db144989_Xnmos0 Xpowernmos0(
.GATE (ndrive0),
.SOURCE (HVNEG),
.DRAIN (GATE),
.NMOSiso6 (HVPOS),
...
//,diesize,fet_fetdriver_db144989_Xnmos0
...
//Celera Confidential Do Not Copy fet_fetdriver_db144989_Xpmos0
fet_fetdriver_db144989_Xpmos0 Xpowerpmos0(
.GATE (pdrive0),
.SOURCE (HVPOS),
.DRAIN (GATE),
.SUB (CELSUB),
...
//,diesize,fet_fetdriver_db144989_Xpmos0
...
//Celera Confidential Do Not Copy resistor_resistor_fetdriver_db144989_Xpassive
resistor_resistor_fetdriver_db144989_Xpassive Xpassive(
.RP (GATE),
.RN (HVNEG),
.CELG (HVNEG)
);
//,diesize,resistor_resistor_fetdriver_db144989_Xpassive
