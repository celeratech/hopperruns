...
module REGULATIONcapriceREFERENCE (BIAS,mode,state,CELG59462,CELV96848,REFERENCE,kelvin_GND,CELSUB40948,kelvin_BIAS,ok_reference,IP_2820079b_XU8,enable_reference,global_vbuffer_2820079b_XU8,trim_vbuffer_negative_2820079b,trim_vbuffer_positive_2820079b,global_resistordivider_db688917_XU1,register_REFERENCE_hysteresis_5dc311a5_XU6);
  input  BIAS;
  input  mode;
  input  state;
  input  CELG59462;
...
.blank(register_Regulation_configuration_6501e26e_XU3[1]),
.state(state),
.blank_on(blank_on),
.CELG59462(CELG59462),
.CELV96848(CELV96848),
...
.BIAS(BIAS),
.mode(register_Regulation_configuration_6501e26e_XU3[0]),
.state(state),
.CELG59462(CELG59462),
.CELV96848(CELV96848),
.REFERENCE(REFERENCE),
