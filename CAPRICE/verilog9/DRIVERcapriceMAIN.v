...
module fetdriver_f73ffcfd (HVPOS,global_fetdriver,fetin,GATE,gate_status,CELV,CELG,enable_fetdriver,HVNEG,CELSUB);
  input  CELG;
  input  CELV;
  output  GATE;
  input  HVNEG;
...
module fetdriver_03bfdead (HVPOS,global_fetdriver,fetin,GATE,gate_status,CELV,CELG,enable_fetdriver,HVNEG,CELSUB);
  input  CELG;
  input  CELV;
  output  GATE;
  input  HVNEG;
...
VESPAasmINPUT1 XU13 (
.o(net_100),
.i0(register_DRIVERconfiguration_c578c173_XU12[0]),
.Tstate(net_101),
.CELG59462(CELG59462),
.CELV96848(CELV96848),
...
VESPAasmINPUT1 XU14 (
.o(net_102),
.i0(register_DRIVERconfiguration_c578c173_XU12[2]),
.Tstate(net_101),
.CELG59462(CELG59462),
.CELV96848(CELV96848),
.CELSUB40948(CELSUB40948)
...
inv_12e192f5 XU16 (
.i(register_DRIVERconfiguration_c578c173_XU12[1]),
.o(net_64),
.SUB(CELSUB40948),
.CELG(CELG59462),
.CELV(CELV96848)
...
nand2_9125fe87 XU18 (
.o(net_67),
.i0(register_DRIVERconfiguration_c578c173_XU12[1]),
.i1(on_driver),
.SUB(CELSUB40948),
.CELG(CELG59462),
.CELV(CELV96848)
...
inv_12e192f5 XU25 (
.i(register_DRIVERconfiguration_c578c173_XU12[3]),
.o(net_68),
.SUB(CELSUB40948),
.CELG(CELG59462),
.CELV(CELV96848)
...
nand2_9125fe87 XU28 (
.o(net_76),
.i0(register_DRIVERconfiguration_c578c173_XU12[3]),
.i1(on_driver),
.SUB(CELSUB40948),
.CELG(CELG59462),
.CELV(CELV96848)
...
fetdriver_f73ffcfd Xfetdriver1 (
.CELG(CELG59462),
.CELV(CELV96848),
.GATE(net_97),
.HVNEG(PGND),
...
fetdriver_03bfdead Xfetdriver2 (
.CELG(CELG59462),
.CELV(CELV96848),
.GATE(GATE),
.HVNEG(PGND),
