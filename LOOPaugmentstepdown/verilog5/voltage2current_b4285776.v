...
module rlpp3000rpo55p5u2p0u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule
...
//Celera Confidential Do Not Copy voltage2current_b4285776
//Celera Confidential Symbol Generator
//Gain: 10, Direction: source, Iout Clamp: no
//DFT:no, Accuracy: no, Input Stage Type: p
module voltage2current_b4285776 (SIMPV,CELSUB,enable_voltage2current,IP,ok_voltage2current,IOUT,VIN,global_voltage2current,
CELG);
input SIMPV;
input CELSUB;
...
//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo55p5u2p0u

//Die Size Calculator rlpp3000rpo55p5u2p0u
//,diesize,rlpp3000rpo55p5u2p0u,1

//Celera Confidential Do Not Copy rlpp3000rpo55p5u2p0u
rlpp3000rpo55p5u2p0u XV2Is_0(
.ISO (CELG),
.RP (OUT),
.RN (CELG)
);
