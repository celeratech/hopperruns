...
// ------------------------ Module Verilog ---------------
module ESRtestSEQUENCER_Rev2_DYES_0 (OFF, DONE, LOAD, porb, RELAX, CHARGE, UPDATE, STANDBY, CALCULATE, CELG59462, CELV96848, PORB97836, relax_time, CELSUB40948, blank_relax, done_esrtest, enable_relax, mon_esr_done, STATEcontrol0, STATEcontrol1, STATEcontrol2, STATEcontrol3, clock_esrtest, done_esrcount, start_esrtest, done_esrcharge, done_loadrelax, done_telemetry, done_loadcharge, enable_esrcount, enable_esrcharge, load_esrregister, done_esrcalculate, done_esrreference, enable_esrcalculate, update_esrreference);
output  OFF;
output  DONE;
output  LOAD;
input  porb;
