...
module dftprobeModel0_3a6578a9 (i,tdi,ten,CELG,CELSUB,CELV);
input  i;
output  tdi;
input  ten;
input  CELG;
...
// ------------------------ Module Verilog ---------------
module ESRtestCALCULATEdebug (tdo, tmi, done, CELG59462, CELV96848, fault_full, CELSUB40948, MULTIPLIER_0, MULTIPLIER_1, MULTIPLIER_2, MULTIPLIER_3, MULTIPLIER_4, MULTIPLIER_5, MULTIPLIER_6, MULTIPLIER_7, MULTIPLIER_8, MULTIPLIER_9, dftstatusLSB, dftstatusMSB, MULTIPLIER_10, MULTIPLIER_11, MULTIPLIER_12, MULTIPLIER_13, MULTIPLIER_14, MULTIPLIER_15, MULTIPLIER_16, MULTIPLIER_17, MULTIPLIER_18, MULTIPLIER_19, done_multiplier, enable_multiplier, enable_esrcalculate);
inout  tdo;
input [4:0] tmi;
input  done;
input  CELG59462;
...
.a({a1,a0}),
.SUB(CELSUB40948),
.tdi({a0,a0,a0,a0,tdi_XUESRtestCALCULATEmultiplierTIME,tdi_XUESRtestCALCULATEfaultFULL,tdi_XUESRtestCALCULATEdoneMULTIPLIER,tdi_XUESRtestCALCULATEcalculateTIME}),
.tdo(tdo),
.ten({noconn_dft_hex0x04_ten_7,noconn_dft_hex0x04_ten_6,ten_status_Xdftstatus2,ten_status_Xdftstatus1,ten_XUESRtestCALCULATEmultiplierTIME,ten_XUESRtestCALCULATEfaultFULL,ten_XUESRtestCALCULATEdoneMULTIPLIER,ten_XUESRtestCALCULATEcalculateTIME}),
...
dftprobeModel0_3a6578a9 XUESRtestCALCULATEfaultFULL (
.i(fault_full),
.tdi(tdi_XUESRtestCALCULATEfaultFULL),
.ten(ten_XUESRtestCALCULATEfaultFULL),
.CELG(CELG59462),
.CELV(CELV96848),
.CELSUB(CELSUB40948)
);
