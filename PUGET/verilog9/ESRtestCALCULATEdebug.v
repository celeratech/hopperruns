...
.ten_status(ten_status_df509a94_Xdftstatus1),
...
.ten_status(ten_status_290aed3d_Xdftstatus2)
);
...
.a({a1,a0}),
.SUB(CELSUB40948),
.tdi({a0,a0,a0,a0,a0,tdi_d472e132_XUESRtestCALCULATEmultiplierTIME,tdi_1ebefc96_XUESRtestCALCULATEdoneMULTIPLIER,tdi_17c2defe_XUESRtestCALCULATEcalculateTIME}),
.tdo(tdo),
.ten({noconn_dft_hex0x04_ten_7,noconn_dft_hex0x04_ten_6,noconn_dft_hex0x04_ten_5,ten_status_290aed3d_Xdftstatus2,ten_status_df509a94_Xdftstatus1,ten_d472e132_XUESRtestCALCULATEmultiplierTIME,ten_1ebefc96_XUESRtestCALCULATEdoneMULTIPLIER,ten_17c2defe_XUESRtestCALCULATEcalculateTIME}),
...
dftprobeModel0_80e43a5a XUESRtestCALCULATEcalculateTIME (
.i(net_29),
.tdi(tdi_17c2defe_XUESRtestCALCULATEcalculateTIME),
.ten(ten_17c2defe_XUESRtestCALCULATEcalculateTIME),
.CELG(CELG59462),
.CELV(CELV96848),
.CELSUB(CELSUB40948)
);

dftprobeModel0_80e43a5a XUESRtestCALCULATEdoneMULTIPLIER (
.i(done_multiplier),
.tdi(tdi_1ebefc96_XUESRtestCALCULATEdoneMULTIPLIER),
.ten(ten_1ebefc96_XUESRtestCALCULATEdoneMULTIPLIER),
.CELG(CELG59462),
.CELV(CELV96848),
.CELSUB(CELSUB40948)
);

dftprobeModel0_80e43a5a XUESRtestCALCULATEmultiplierTIME (
.i(net_23),
.tdi(tdi_d472e132_XUESRtestCALCULATEmultiplierTIME),
.ten(ten_d472e132_XUESRtestCALCULATEmultiplierTIME),
.CELG(CELG59462),
.CELV(CELV96848),
.CELSUB(CELSUB40948)
);
