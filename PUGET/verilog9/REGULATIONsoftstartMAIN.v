...
//Celera:resistor_f1dbef1c
//Celera Confidential Symbol Generator
//RESISTOR:1000KOhm TYPE:poly DFT:no
module resistor_f1dbef1c (RP,
CELG,
RN);
inout RP;
inout RN;
...
//Celera:capacitorfixed_283e2555
//Celera Confidential Symbol Generator
//CAPACITOR CONTROL:capacitor
//VALUE: 20.00pF TYPE:mim
module capacitorfixed_283e2555 (CP,
CN);
inout CP;
inout CN;
endmodule
...
.go_softstart(net_126),
.clock_regulation(net_124)
);
...
.i({net_99,net_98,net_97,net_96,net_95,net_94,net_93,net_92}),
.DAC(net_129),
.CELG(CELG59462),
.CELV(CELV96848),
.CELSUB(CELSUB40948),
...
capacitorfixed_283e2555 Xcapacitor1 (
...
.SIMPV(SIMPV),
.CELSUB(CELSUB40948),
.ok_comparator(net_137),
.INN_COMPARATOR(REF),
.INP_COMPARATOR(net_129),
.out_comparator(net_134),
