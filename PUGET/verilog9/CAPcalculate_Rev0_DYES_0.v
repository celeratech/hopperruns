...
//Celera:delayclock_f3653390
//TYPE:clock  EDGE:rise DFT:no ACC:no%
module delayclock_f3653390 (in,CELV,out,clock,celeraporb,
CELG,CELSUB);
input CELV;
input in;
output out;
...
//Celera:delayclock_0e71ef13
//TYPE:clock  EDGE:rise DFT:no ACC:no%
module delayclock_0e71ef13 (in,CELV,out,clock,celeraporb,
CELG,CELSUB);
input CELV;
input in;
output out;
