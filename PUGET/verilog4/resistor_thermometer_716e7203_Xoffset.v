...
//CORE:resistor
//NAME:resistor_thermometer_716e7203_Xoffset
...
rlpp3000rpo1p8u0p4u XRT3_1(
.RP (RT3),
.RN (RT2),
.ISO (CELG)
);
rlpp3000rpo1p8u0p4u XRT3_2(
.RP (RT3),
.RN (RT2),
.ISO (CELG)
);
rlpp3000rpo1p8u0p4u XRT3_3(
.RP (RT3),
.RN (RT2),
.ISO (CELG)
);
...
rlpp3000rpo1p5u0p4u XRT2_0(
.RP (RT2),
.RN (RT1),
.ISO (CELG)
);
rlpp3000rpo1p5u0p4u XRT2_1(
.RP (RT2),
.RN (RT1),
.ISO (CELG)
);
rlpp3000rpo1p5u0p4u XRT2_2(
.RP (RT2),
.RN (RT1),
.ISO (CELG)
);
rlpp3000rpo1p5u0p4u XRT2_3(
.RP (RT2),
.RN (RT1),
.ISO (CELG)
);
rlpp3000rpo1p5u0p4u XRT2_4(
.RP (RT2),
.RN (RT1),
.ISO (CELG)
);
...
//,diesize,rlpp3000rpo1p0u0p4u,14
