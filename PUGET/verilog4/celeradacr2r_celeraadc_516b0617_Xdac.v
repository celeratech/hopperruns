...
//CORE:celeradacr2r
//NAME:celeradacr2r_celeraadc_516b0617_Xdac
...
//Celera Confidential Do Not Copy vbuffer_celeradacr2r_celeraadc_516b0617_Xdac_Xbufo.v
//Celera:vbuffer_celeradacr2r_celeraadc_516b0617_Xdac_Xbufo
//Celera Confidential Symbol Generator
//GAIN:1.0 Input:np with 1000K Impedance
module vbuffer_celeradacr2r_celeraadc_516b0617_Xdac_Xbufo (SIMPV,IN,IP,OUT,enable_vbuffer,ok_vbuffer,global_vbuffer,
...
//Celera Confidential Do Not Copy STONEdacDFT12
//Verilog HDL for "Generate", "STONEdacDFT12" "functional"


module STONEdacDFT12 ( dh, dl, TAI_DAC, DACOUT, CELG, CELV, SUB, controllsb,
controlmsb, ten_dac, ten_daccontrollsb, ten_daccontrolmsb );

  input ten_dac;
  input CELV;
  output  [7:0] dl;
  input  [3:0] controlmsb;
  input  [3:0] ten_daccontrolmsb;
  output TAI_DAC;
  input  [7:0] ten_daccontrollsb;
  input  [7:0] controllsb;
  input SUB;
  input CELG;
  inout DACOUT;
  output  [3:0] dh;
...
//Celera Confidential Do Not Copy celeradacr2r_celeraadc_516b0617_Xdac
//Celera Confidential Symbol Generator
...
//Celera Confidential Do Not Copy Pin dl
wire[7:0] dl;

//Celera Confidential Do Not Copy Pin controlmsb
wire[3:0] controlmsb;

//Celera Confidential Do Not Copy Pin ten_daccontrolmsb
wire[3:0] ten_daccontrolmsb;

//Celera Confidential Do Not Copy Pin ten_daccontrollsb
wire[7:0] ten_daccontrollsb;

//Celera Confidential Do Not Copy Pin controllsb
wire[7:0] controllsb;

//Celera Confidential Do Not Copy Pin dh
wire[3:0] dh;
...
//Celera Confidential Do Not Copy vbuffer_celeradacr2r_celeraadc_516b0617_Xdac_Xbufo
vbuffer_celeradacr2r_celeraadc_516b0617_Xdac_Xbufo Xbufferout(
.SIMPV (SIMPV),
.IN (DACo),
.IP (IP),
.enable_vbuffer (en),
...
//,diesize,vbuffer_celeradacr2r_celeraadc_516b0617_Xdac_Xbufo
...
rlpp3000rpo1p3u0p4u XRT8_0(
.RP (R9),
.RN (R9R8_1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT8_1(
.RP (R9R8_1),
.RN (R9R8_2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT8_2(
.RP (R9R8_2),
.RN (R9R8_3),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT8_3(
.RP (R9R8_3),
.RN (R9R8_4),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT8_4(
.RP (R9R8_4),
.RN (R9R8_5),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT8_5(
.RP (R9R8_5),
.RN (R9R8_6),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT8_6(
.RP (R9R8_6),
.RN (R9R8_7),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT8_7(
.RP (R9R8_7),
.RN (R9R8_8),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT8_8(
.RP (R9R8_8),
.RN (R9R8_9),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT8_9(
.RP (R9R8_9),
.RN (R9R8_10),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT8_10(
.RP (R9R8_10),
.RN (R9R8_11),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT8_11(
.RP (R9R8_11),
.RN (R9R8_12),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT8_12(
.RP (R9R8_12),
.RN (R9R8_13),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT8_13(
.RP (R9R8_13),
.RN (R8),
.ISO (CELG)
);
...
rlpp3000rpo1p3u0p4u XRB8_0(
.RP (ROUT8),
.RN (ROUT8R9_1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_1(
.RP (ROUT8R9_1),
.RN (ROUT8R9_2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_2(
.RP (ROUT8R9_2),
.RN (ROUT8R9_3),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_3(
.RP (ROUT8R9_3),
.RN (ROUT8R9_4),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_4(
.RP (ROUT8R9_4),
.RN (ROUT8R9_5),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_5(
.RP (ROUT8R9_5),
.RN (ROUT8R9_6),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_6(
.RP (ROUT8R9_6),
.RN (ROUT8R9_7),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_7(
.RP (ROUT8R9_7),
.RN (ROUT8R9_8),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_8(
.RP (ROUT8R9_8),
.RN (ROUT8R9_9),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_9(
.RP (ROUT8R9_9),
.RN (ROUT8R9_10),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_10(
.RP (ROUT8R9_10),
.RN (ROUT8R9_11),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_11(
.RP (ROUT8R9_11),
.RN (ROUT8R9_12),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_12(
.RP (ROUT8R9_12),
.RN (ROUT8R9_13),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_13(
.RP (ROUT8R9_13),
.RN (ROUT8R9_14),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_14(
.RP (ROUT8R9_14),
.RN (ROUT8R9_15),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_15(
.RP (ROUT8R9_15),
.RN (ROUT8R9_16),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_16(
.RP (ROUT8R9_16),
.RN (ROUT8R9_17),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_17(
.RP (ROUT8R9_17),
.RN (ROUT8R9_18),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_18(
.RP (ROUT8R9_18),
.RN (ROUT8R9_19),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_19(
.RP (ROUT8R9_19),
.RN (ROUT8R9_20),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_20(
.RP (ROUT8R9_20),
.RN (ROUT8R9_21),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_21(
.RP (ROUT8R9_21),
.RN (ROUT8R9_22),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_22(
.RP (ROUT8R9_22),
.RN (ROUT8R9_23),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_23(
.RP (ROUT8R9_23),
.RN (ROUT8R9_24),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_24(
.RP (ROUT8R9_24),
.RN (ROUT8R9_25),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_25(
.RP (ROUT8R9_25),
.RN (ROUT8R9_26),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_26(
.RP (ROUT8R9_26),
.RN (ROUT8R9_27),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB8_27(
.RP (ROUT8R9_27),
.RN (R9),
.ISO (CELG)
);
...
rlpp3000rpo1p3u0p4u XRT9_0(
.RP (R10),
.RN (R10R9_1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT9_1(
.RP (R10R9_1),
.RN (R10R9_2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT9_2(
.RP (R10R9_2),
.RN (R10R9_3),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT9_3(
.RP (R10R9_3),
.RN (R10R9_4),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT9_4(
.RP (R10R9_4),
.RN (R10R9_5),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT9_5(
.RP (R10R9_5),
.RN (R10R9_6),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT9_6(
.RP (R10R9_6),
.RN (R10R9_7),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT9_7(
.RP (R10R9_7),
.RN (R10R9_8),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT9_8(
.RP (R10R9_8),
.RN (R10R9_9),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT9_9(
.RP (R10R9_9),
.RN (R10R9_10),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT9_10(
.RP (R10R9_10),
.RN (R10R9_11),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT9_11(
.RP (R10R9_11),
.RN (R10R9_12),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT9_12(
.RP (R10R9_12),
.RN (R10R9_13),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT9_13(
.RP (R10R9_13),
.RN (R9),
.ISO (CELG)
);
...
rlpp3000rpo1p3u0p4u XRB9_0(
.RP (ROUT9),
.RN (ROUT9R10_1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_1(
.RP (ROUT9R10_1),
.RN (ROUT9R10_2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_2(
.RP (ROUT9R10_2),
.RN (ROUT9R10_3),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_3(
.RP (ROUT9R10_3),
.RN (ROUT9R10_4),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_4(
.RP (ROUT9R10_4),
.RN (ROUT9R10_5),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_5(
.RP (ROUT9R10_5),
.RN (ROUT9R10_6),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_6(
.RP (ROUT9R10_6),
.RN (ROUT9R10_7),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_7(
.RP (ROUT9R10_7),
.RN (ROUT9R10_8),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_8(
.RP (ROUT9R10_8),
.RN (ROUT9R10_9),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_9(
.RP (ROUT9R10_9),
.RN (ROUT9R10_10),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_10(
.RP (ROUT9R10_10),
.RN (ROUT9R10_11),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_11(
.RP (ROUT9R10_11),
.RN (ROUT9R10_12),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_12(
.RP (ROUT9R10_12),
.RN (ROUT9R10_13),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_13(
.RP (ROUT9R10_13),
.RN (ROUT9R10_14),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_14(
.RP (ROUT9R10_14),
.RN (ROUT9R10_15),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_15(
.RP (ROUT9R10_15),
.RN (ROUT9R10_16),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_16(
.RP (ROUT9R10_16),
.RN (ROUT9R10_17),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_17(
.RP (ROUT9R10_17),
.RN (ROUT9R10_18),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_18(
.RP (ROUT9R10_18),
.RN (ROUT9R10_19),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_19(
.RP (ROUT9R10_19),
.RN (ROUT9R10_20),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_20(
.RP (ROUT9R10_20),
.RN (ROUT9R10_21),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_21(
.RP (ROUT9R10_21),
.RN (ROUT9R10_22),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_22(
.RP (ROUT9R10_22),
.RN (ROUT9R10_23),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_23(
.RP (ROUT9R10_23),
.RN (ROUT9R10_24),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_24(
.RP (ROUT9R10_24),
.RN (ROUT9R10_25),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_25(
.RP (ROUT9R10_25),
.RN (ROUT9R10_26),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_26(
.RP (ROUT9R10_26),
.RN (ROUT9R10_27),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB9_27(
.RP (ROUT9R10_27),
.RN (R10),
.ISO (CELG)
);
...
rlpp3000rpo1p3u0p4u XRT10_0(
.RP (R11),
.RN (R11R10_1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT10_1(
.RP (R11R10_1),
.RN (R11R10_2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT10_2(
.RP (R11R10_2),
.RN (R11R10_3),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT10_3(
.RP (R11R10_3),
.RN (R11R10_4),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT10_4(
.RP (R11R10_4),
.RN (R11R10_5),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT10_5(
.RP (R11R10_5),
.RN (R11R10_6),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT10_6(
.RP (R11R10_6),
.RN (R11R10_7),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT10_7(
.RP (R11R10_7),
.RN (R11R10_8),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT10_8(
.RP (R11R10_8),
.RN (R11R10_9),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT10_9(
.RP (R11R10_9),
.RN (R11R10_10),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT10_10(
.RP (R11R10_10),
.RN (R11R10_11),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT10_11(
.RP (R11R10_11),
.RN (R11R10_12),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT10_12(
.RP (R11R10_12),
.RN (R11R10_13),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT10_13(
.RP (R11R10_13),
.RN (R10),
.ISO (CELG)
);
...
rlpp3000rpo1p3u0p4u XRB10_0(
.RP (ROUT10),
.RN (ROUT10R11_1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_1(
.RP (ROUT10R11_1),
.RN (ROUT10R11_2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_2(
.RP (ROUT10R11_2),
.RN (ROUT10R11_3),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_3(
.RP (ROUT10R11_3),
.RN (ROUT10R11_4),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_4(
.RP (ROUT10R11_4),
.RN (ROUT10R11_5),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_5(
.RP (ROUT10R11_5),
.RN (ROUT10R11_6),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_6(
.RP (ROUT10R11_6),
.RN (ROUT10R11_7),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_7(
.RP (ROUT10R11_7),
.RN (ROUT10R11_8),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_8(
.RP (ROUT10R11_8),
.RN (ROUT10R11_9),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_9(
.RP (ROUT10R11_9),
.RN (ROUT10R11_10),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_10(
.RP (ROUT10R11_10),
.RN (ROUT10R11_11),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_11(
.RP (ROUT10R11_11),
.RN (ROUT10R11_12),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_12(
.RP (ROUT10R11_12),
.RN (ROUT10R11_13),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_13(
.RP (ROUT10R11_13),
.RN (ROUT10R11_14),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_14(
.RP (ROUT10R11_14),
.RN (ROUT10R11_15),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_15(
.RP (ROUT10R11_15),
.RN (ROUT10R11_16),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_16(
.RP (ROUT10R11_16),
.RN (ROUT10R11_17),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_17(
.RP (ROUT10R11_17),
.RN (ROUT10R11_18),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_18(
.RP (ROUT10R11_18),
.RN (ROUT10R11_19),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_19(
.RP (ROUT10R11_19),
.RN (ROUT10R11_20),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_20(
.RP (ROUT10R11_20),
.RN (ROUT10R11_21),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_21(
.RP (ROUT10R11_21),
.RN (ROUT10R11_22),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_22(
.RP (ROUT10R11_22),
.RN (ROUT10R11_23),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_23(
.RP (ROUT10R11_23),
.RN (ROUT10R11_24),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_24(
.RP (ROUT10R11_24),
.RN (ROUT10R11_25),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_25(
.RP (ROUT10R11_25),
.RN (ROUT10R11_26),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_26(
.RP (ROUT10R11_26),
.RN (ROUT10R11_27),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB10_27(
.RP (ROUT10R11_27),
.RN (R11),
.ISO (CELG)
);
...
rlpp3000rpo1p3u0p4u XRT11_0(
.RP (DACo),
.RN (DACoR11_1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT11_1(
.RP (DACoR11_1),
.RN (DACoR11_2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT11_2(
.RP (DACoR11_2),
.RN (DACoR11_3),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT11_3(
.RP (DACoR11_3),
.RN (DACoR11_4),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT11_4(
.RP (DACoR11_4),
.RN (DACoR11_5),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT11_5(
.RP (DACoR11_5),
.RN (DACoR11_6),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT11_6(
.RP (DACoR11_6),
.RN (DACoR11_7),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT11_7(
.RP (DACoR11_7),
.RN (DACoR11_8),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT11_8(
.RP (DACoR11_8),
.RN (DACoR11_9),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT11_9(
.RP (DACoR11_9),
.RN (DACoR11_10),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT11_10(
.RP (DACoR11_10),
.RN (DACoR11_11),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT11_11(
.RP (DACoR11_11),
.RN (DACoR11_12),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT11_12(
.RP (DACoR11_12),
.RN (DACoR11_13),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT11_13(
.RP (DACoR11_13),
.RN (R11),
.ISO (CELG)
);
...
rlpp3000rpo1p3u0p4u XRB11_0(
.RP (ROUT11),
.RN (ROUT11DACo_1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_1(
.RP (ROUT11DACo_1),
.RN (ROUT11DACo_2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_2(
.RP (ROUT11DACo_2),
.RN (ROUT11DACo_3),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_3(
.RP (ROUT11DACo_3),
.RN (ROUT11DACo_4),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_4(
.RP (ROUT11DACo_4),
.RN (ROUT11DACo_5),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_5(
.RP (ROUT11DACo_5),
.RN (ROUT11DACo_6),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_6(
.RP (ROUT11DACo_6),
.RN (ROUT11DACo_7),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_7(
.RP (ROUT11DACo_7),
.RN (ROUT11DACo_8),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_8(
.RP (ROUT11DACo_8),
.RN (ROUT11DACo_9),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_9(
.RP (ROUT11DACo_9),
.RN (ROUT11DACo_10),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_10(
.RP (ROUT11DACo_10),
.RN (ROUT11DACo_11),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_11(
.RP (ROUT11DACo_11),
.RN (ROUT11DACo_12),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_12(
.RP (ROUT11DACo_12),
.RN (ROUT11DACo_13),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_13(
.RP (ROUT11DACo_13),
.RN (ROUT11DACo_14),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_14(
.RP (ROUT11DACo_14),
.RN (ROUT11DACo_15),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_15(
.RP (ROUT11DACo_15),
.RN (ROUT11DACo_16),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_16(
.RP (ROUT11DACo_16),
.RN (ROUT11DACo_17),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_17(
.RP (ROUT11DACo_17),
.RN (ROUT11DACo_18),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_18(
.RP (ROUT11DACo_18),
.RN (ROUT11DACo_19),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_19(
.RP (ROUT11DACo_19),
.RN (ROUT11DACo_20),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_20(
.RP (ROUT11DACo_20),
.RN (ROUT11DACo_21),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_21(
.RP (ROUT11DACo_21),
.RN (ROUT11DACo_22),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_22(
.RP (ROUT11DACo_22),
.RN (ROUT11DACo_23),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_23(
.RP (ROUT11DACo_23),
.RN (ROUT11DACo_24),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_24(
.RP (ROUT11DACo_24),
.RN (ROUT11DACo_25),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_25(
.RP (ROUT11DACo_25),
.RN (ROUT11DACo_26),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_26(
.RP (ROUT11DACo_26),
.RN (ROUT11DACo_27),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRB11_27(
.RP (ROUT11DACo_27),
.RN (DACo),
.ISO (CELG)
);
...
.controlmsb (ih [3:0]),
.ten_dac (ten_dac),
.ten_daccontrollsb (ten_daccontrol [7:0]),
.ten_daccontrolmsb (ten_daccontrolmsb [3:0]),
.DACOUT (DAC),
.TAI_DAC (TAI_DAC),
.dl (dl [7:0]),
.dh (dh [3:0]),
