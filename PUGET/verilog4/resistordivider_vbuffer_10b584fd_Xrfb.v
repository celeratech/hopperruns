...
//NAME:resistordivider_vbuffer_10b584fd_Xrfb
...
module rlpp3000rpo19p6u0p4u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule
...
//Celera Confidential Do Not Copy Resistor Divider
module rlpp3000rpo18p3u0p4u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule

//Celera Confidential Do Not Copy resistordivider_vbuffer_10b584fd_Xrfb
//Celera Confidential Symbol Generator
//VMAX:6V R:1000.0KOhm 1Taps
module resistordivider_vbuffer_10b584fd_Xrfb (TOP,
...
rlpp3000rpo18p3u0p4u XRTOP_0(
.RP (disconnect),
.RN (disconnectTAP0_1),
.ISO (CELG)
);
rlpp3000rpo18p3u0p4u XRTOP_1(
.RP (disconnectTAP0_1),
.RN (TAP0),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo18p3u0p4u

//Die Size Calculator rlpp3000rpo18p3u0p4u
//,diesize,rlpp3000rpo18p3u0p4u,2

//Celera Confidential Do Not Copy RTAP0
rlpp3000rpo19p6u0p4u XRTAP0_0(
.RP (TAP0),
.RN (TAP0BOTTOM_1),
.ISO (CELG)
);
rlpp3000rpo19p6u0p4u XRTAP0_1(
.RP (TAP0BOTTOM_1),
.RN (TAP0BOTTOM_2),
.ISO (CELG)
);
rlpp3000rpo19p6u0p4u XRTAP0_2(
.RP (TAP0BOTTOM_2),
.RN (BOTTOM),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo19p6u0p4u

//Die Size Calculator rlpp3000rpo19p6u0p4u
//,diesize,rlpp3000rpo19p6u0p4u,3
