...
.TAO(TAO),
.ten({noconn_dft_hex0x68_ten_7,noconn_dft_hex0x68_ten_6,noconn_dft_hex0x68_ten_5,noconn_dft_hex0x68_ten_4,noconn_dft_hex0x68_ten_3,noconn_dft_hex0x68_ten_2,ten_out_thermometer_Xthermometer1,ten_thermometer_Xthermometer1}),
.tma({a0,a1,a1,a0,a1,a0,a0,a0}),
.tmi(tmi[4:0])
);

thermometer_7c641ed9 Xthermometer1 (
.IP(IP_aec8e192),
.CELG(CELG59462),
.SIMPV(SIMPV),
.CELSUB(CELSUB40948),
...
STONEnoconn XNCnoconn_dft_hex0x68_ten_2 (
.noconn(noconn_dft_hex0x68_ten_2)
);

STONEnoconn XNCnoconn_dft_hex0x68_ten_3 (
.noconn(noconn_dft_hex0x68_ten_3)
);

STONEnoconn XNCnoconn_dft_hex0x68_ten_4 (
.noconn(noconn_dft_hex0x68_ten_4)
);
