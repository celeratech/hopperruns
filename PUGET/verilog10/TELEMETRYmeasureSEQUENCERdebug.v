...
module dftprobeModel1_d660a09d (i,TAI,ten,CELG,CELSUB,CELV);
input  i;
output  TAI;
input  ten;
input  CELG;
...
// ------------------------ Module Verilog ---------------
module TELEMETRYmeasureSEQUENCERdebug (TAO, tdo, tmi, done_adc, CELG59462, CELV96848, dft_endoff, CELSUB40948, convert_adc, ready_count, dftstatusLSB, ok_telemetry, done_telemetry, CHANNELselect_0, CHANNELselect_1, CHANNELselect_2, CHANNELselect_3, enable_telemetry, request_capcalculate, fault_telemetrymeasure, hijack_enable_telemetry);
inout  TAO;
inout  tdo;
input [4:0] tmi;
  input  done_adc;
...
.a({a1,a0}),
.SUB(CELSUB40948),
.TAI({a0,a0,a0,a0,a0,a0,a0,TAI_XUTELEMETRYmeasureTELEMETRYdone}),
.TAO(TAO),
.tdi({a0,tdi_XUTELEMETRYmeasureSEQUENCERrequest_capcalculate,tdi_XUTELEMETRYmeasureSEQUENCERreadycount,tdi_XUTELEMETRYmeasureSEQUENCERok,tdi_XUTELEMETRYmeasureSEQUENCERfault,tdi_XUTELEMETRYmeasureSEQUENCERend_off,tdi_XUTELEMETRYmeasureSEQUENCERdoneadc,tdi_XUTELEMETRYmeasureSEQUENCERconvertadc}),
.tdo(tdo),
.ten({ten_XUTELEMETRYmeasureTELEMETRYdone,ten_XUTELEMETRYmeasureSEQUENCERrequest_capcalculate,ten_XUTELEMETRYmeasureSEQUENCERreadycount,ten_XUTELEMETRYmeasureSEQUENCERok,ten_XUTELEMETRYmeasureSEQUENCERfault,ten_XUTELEMETRYmeasureSEQUENCERend_off,ten_XUTELEMETRYmeasureSEQUENCERdoneadc,ten_XUTELEMETRYmeasureSEQUENCERconvertadc}),
...
.a({b1,b0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x69_ten_7,noconn_dft_hex0x69_ten_6,noconn_dft_hex0x69_ten_5,noconn_dft_hex0x69_ten_4,noconn_dft_hex0x69_ten_3,ten_status_Xdftstatus1,ten_hijacki_Xdfthijack1,ten_hijack_Xdfthijack1}),
.tma({b0,b1,b1,b0,b1,b0,b0,b1}),
.tmi(tmi[4:0])
);
...
.i(done_telemetry),
.TAI(TAI_XUTELEMETRYmeasureTELEMETRYdone),
