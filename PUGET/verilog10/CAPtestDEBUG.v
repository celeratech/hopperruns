...
module dftprobeModel0_9e1e8bd6 (i,tdi,ten,CELG,CELSUB,CELV);
input  i;
output  tdi;
input  ten;
input  CELG;
...
.a({a1,a0}),
.SUB(CELSUB40948),
.tdi({tdi_XUCAPtestSTART,tdi_XUCAPtestOVERFLOW,tdi_XUCAPtestOKSINK,tdi_XUCAPtestLOADREGISTER,tdi_XUCAPtestLOAD,tdi_XUCAPtestEQUAL,tdi_XUCAPtestDONE,tdi_XUCAPtestCOUNT}),
.tdo(tdo),
.ten({ten_XUCAPtestSTART,ten_XUCAPtestOVERFLOW,ten_XUCAPtestOKSINK,ten_XUCAPtestLOADREGISTER,ten_XUCAPtestLOAD,ten_XUCAPtestEQUAL,ten_XUCAPtestDONE,ten_XUCAPtestCOUNT}),
...
.a({b1,b0}),
.SUB(CELSUB40948),
.tdi({b0,b0,b0,b0,b0,b0,b0,tdi_XUCAPtestTIME}),
.tdo(tdo),
.ten({noconn_dft_hex0x0F_ten_7,noconn_dft_hex0x0F_ten_6,noconn_dft_hex0x0F_ten_5,noconn_dft_hex0x0F_ten_4,noconn_dft_hex0x0F_ten_3,noconn_dft_hex0x0F_ten_2,noconn_dft_hex0x0F_ten_1,ten_XUCAPtestTIME}),
...
dftprobeModel0_9e1e8bd6 XUCAPtestLOAD (
.i(dft_load),
.tdi(tdi_XUCAPtestLOAD),
.ten(ten_XUCAPtestLOAD),
.CELG(CELG59462),
.CELV(CELV96848),
.CELSUB(CELSUB40948)
);
