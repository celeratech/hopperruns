// ------------------------ Module Definitions -----------
module dftprobeModel0_b6543f46 (i,tdi,ten,CELG,CELSUB,CELV);
input  i;
output  tdi;
input  ten;
input  CELG;
...
module dftprobeModel0_57a65950 (i,tdi,ten,CELG,CELSUB,CELV);
input  i;
output  tdi;
input  ten;
input  CELG;
...
module dftprobeModel0_39e70f33 (i,tdi,ten,CELG,CELSUB,CELV);
input  i;
output  tdi;
input  ten;
input  CELG;
...
// ------------------------ Networks ---------------------
dftprobeModel0_b6543f46 XUDRIVERbst (
.i(ok_bst),
.tdi(tdi_XUDRIVERbst),
.ten(ten_XUDRIVERbst),
.CELG(CELG59462),
...
.a({a1,a0}),
.SUB(CELSUB40948),
.tdi({a0,a0,a0,a0,a0,tdi_XUDRIVERbst,tdi_XUDRIVERbbmTOP,tdi_XUDRIVERbbmBOTTOM}),
.tdo(tdo),
.ten({ten_XUDRIVERbbmTOP,ten_XUDRIVERbbmBOTTOM,ten_hijacki_Xdfthijack3,ten_hijack_Xdfthijack3,ten_hijacki_Xdfthijack2,ten_hijack_Xdfthijack2,ten_hijacki_Xdfthijack1,ten_hijack_Xdfthijack1}),
...
.a({b1,b0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x29_ten_7,noconn_dft_hex0x29_ten_6,noconn_dft_hex0x29_ten_5,noconn_dft_hex0x29_ten_4,noconn_dft_hex0x29_ten_3,noconn_dft_hex0x29_ten_2,noconn_dft_hex0x29_ten_1,ten_XUDRIVERbst}),
.tma({b0,b0,b1,b0,b1,b0,b0,b1}),
.tmi(tmi[4:0])
);

dftprobeModel0_57a65950 XUDRIVERbbmTOP (
.i(dft_bbmtop),
.tdi(tdi_XUDRIVERbbmTOP),
.ten(ten_XUDRIVERbbmTOP),
.CELG(CELG59462),
.CELV(CELV96848),
.CELSUB(CELSUB40948)
);

dftprobeModel0_39e70f33 XUDRIVERbbmBOTTOM (
.i(dft_bbmbottom),
.tdi(tdi_XUDRIVERbbmBOTTOM),
.ten(ten_XUDRIVERbbmBOTTOM),
.CELG(CELG59462),
.CELV(CELV96848),
.CELSUB(CELSUB40948)
);
