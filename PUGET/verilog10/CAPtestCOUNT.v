...
//Celera:delayclock_68063ecf
//TYPE:clock  EDGE:fall DFT:no ACC:no%
module delayclock_68063ecf (in,CELV,out,clock,celeraporb,
CELG,CELSUB);
input CELV;
input in;
output out;
...
.global_count(global_count_f6745a37_XU4)
);
...
.a({a1,a0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x12_ten_7,noconn_dft_hex0x12_ten_6,noconn_dft_hex0x12_ten_5,noconn_dft_hex0x12_ten_4,noconn_dft_hex0x12_ten_3,noconn_dft_hex0x12_ten_2,noconn_dft_hex0x12_ten_1,global_count_f6745a37_XU4}),
