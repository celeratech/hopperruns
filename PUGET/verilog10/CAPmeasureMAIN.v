// ------------------------ Module Definitions -----------
module CAPmeasureDIFFfour (CAP4,DIFF4,SIMPV,CELG59462,CELV96848,CELSUB40948,IP_373ccde4,kelvin_CAP3,kelvin_CAP4,kelvin_GNDcap,ok_measurediff4,enable_measurediff4,trim_amplifiernegative_373ccde4,trim_amplifierpositive_373ccde4);
  input  CAP4;
  inout  DIFF4;
  input  SIMPV;
  input  CELG59462;
...
module CAPmeasureDIFFthree (CAP3,DIFF3,SIMPV,CELG59462,CELV96848,CELSUB40948,IP_6a204806,kelvin_CAP2,kelvin_CAP3,kelvin_GNDcap,ok_measurediff3,enable_measurediff3,trim_amplifiernegative_6a204806,trim_amplifierpositive_6a204806);
  input  CAP3;
  inout  DIFF3;
  input  SIMPV;
  input  CELG59462;
...
module CAPmeasureDIFFtwo (CAP2,DIFF2,SIMPV,CELG59462,CELV96848,CELSUB40948,IP_6177b54e,kelvin_CAP1,kelvin_CAP2,kelvin_GNDcap,ok_measurediff2,enable_measurediff2,trim_amplifiernegative_6177b54e,trim_amplifierpositive_6177b54e);
  input  CAP2;
  inout  DIFF2;
  input  SIMPV;
  input  CELG59462;
...
//Celera:vbuffer_0fbdbf76
//Celera Confidential Symbol Generator
//GAIN:2 Input:p with 100K Impedance
module vbuffer_0fbdbf76 (SIMPV,IN,IP,OUT,enable_vbuffer,ok_vbuffer,global_vbuffer,
...
// ------------------------ Module Verilog ---------------
module CAPmeasureMAIN (CAP2, CAP3, CAP4, SIMPV, CELG59462, CELV96848, PORB97836, CELSUB40948, IP_028cac62, IP_0bfa8e10, IP_373ccde4, IP_6177b54e, IP_6a204806, kelvin_CAP1, kelvin_CAP2, kelvin_CAP3, kelvin_CAP4, CAPmeasure_0, CAPmeasure_1, clock_measure, kelvin_CAPRTN, kelvin_GNDcap, CAPmeasureDIFF, ready_capmeasure, enable_measurecap, factory_delay_ecf7598b, trim_vbuffer_negative_0bfa8e10, trim_vbuffer_positive_0bfa8e10, trim_amplifiernegative_028cac62, trim_amplifiernegative_373ccde4, trim_amplifiernegative_6177b54e, trim_amplifiernegative_6a204806, trim_amplifierpositive_028cac62, trim_amplifierpositive_373ccde4, trim_amplifierpositive_6177b54e, trim_amplifierpositive_6a204806);
input  CAP2;
input  CAP3;
input  CAP4;
input  SIMPV;
...
.factory_delay({factory_delay_ecf7598b[1],factory_delay_ecf7598b[0]})
);
...
.global_vbuffer(tl0),
.trim_vbuffer_negative({trim_vbuffer_negative_0bfa8e10[6],trim_vbuffer_negative_0bfa8e10[5],trim_vbuffer_negative_0bfa8e10[4],trim_vbuffer_negative_0bfa8e10[3],trim_vbuffer_negative_0bfa8e10[2],trim_vbuffer_negative_0bfa8e10[1],trim_vbuffer_negative_0bfa8e10[0]}),
.trim_vbuffer_positive({trim_vbuffer_positive_0bfa8e10[6],trim_vbuffer_positive_0bfa8e10[5],trim_vbuffer_positive_0bfa8e10[4],trim_vbuffer_positive_0bfa8e10[3],trim_vbuffer_positive_0bfa8e10[2],trim_vbuffer_positive_0bfa8e10[1],trim_vbuffer_positive_0bfa8e10[0]})
);

capacitorfixed_ff691357 Xcapacitor1 (
.CN(kelvin_GNDcap),
.CP(net_148)
);
