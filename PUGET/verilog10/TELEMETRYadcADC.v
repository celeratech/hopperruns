...
.a({b1,b0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x7A_ten_7,noconn_dft_hex0x7A_ten_6,noconn_dft_hex0x7A_ten_5,noconn_dft_hex0x7A_ten_4,noconn_dft_hex0x7A_ten_3,noconn_dft_hex0x7A_ten_2,noconn_dft_hex0x7A_ten_1,global_vbuffer_3ce2d6bc_Xvbuffer1}),
.tma({b0,b1,b1,b1,b1,b0,b1,b0}),
.tmi(tmi[4:0])
);
...
STONEnoconn XNCnoconn_dft_hex0x7A_ten_1 (
.noconn(noconn_dft_hex0x7A_ten_1)
);

STONEnoconn XNCnoconn_dft_hex0x7A_ten_2 (
.noconn(noconn_dft_hex0x7A_ten_2)
);

STONEnoconn XNCnoconn_dft_hex0x7A_ten_3 (
.noconn(noconn_dft_hex0x7A_ten_3)
);

STONEnoconn XNCnoconn_dft_hex0x7A_ten_4 (
.noconn(noconn_dft_hex0x7A_ten_4)
);

STONEnoconn XNCnoconn_dft_hex0x7A_ten_5 (
.noconn(noconn_dft_hex0x7A_ten_5)
);

STONEnoconn XNCnoconn_dft_hex0x7A_ten_6 (
.noconn(noconn_dft_hex0x7A_ten_6)
);

STONEnoconn XNCnoconn_dft_hex0x7A_ten_7 (
.noconn(noconn_dft_hex0x7A_ten_7)
);
