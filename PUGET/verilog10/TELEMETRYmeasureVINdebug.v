...
dftprobeModel2_2dcf28df XUINoutput (
.i(VIN),
.TAI(TAI_98ffcc73_XUINoutput),
.ten(ten_98ffcc73_XUINoutput),
.CELG(CELG59462),
.CELV(CELV96848),
.CELSUB(CELSUB40948)
);

dftprobeModel0_80e43a5a XUINstartup (
.i(net_14),
.tdi(tdi_a27bdd28_XUINstartup),
.ten(ten_a27bdd28_XUINstartup),
.CELG(CELG59462),
.CELV(CELV96848),
.CELSUB(CELSUB40948)
);
...
.CELV(CELV96848),
.CELSUB(CELSUB40948),
.ten_hijack(ten_hijack_92e574dd_Xdfthijack1),
...
.a({a1,a0}),
.SUB(CELSUB40948),
.TAI({a0,a0,a0,a0,a0,a0,a0,TAI_98ffcc73_XUINoutput}),
.TAO(TAO),
