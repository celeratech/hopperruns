...
//Celera:currentsenseamplifier_dda35502
//Celera Confidential Symbol Generator
...
//Celera:currentsenseamplifier_4324b6cf
//Celera Confidential Symbol Generator
//Sense Type: resistor, Usage: p, Max Input Voltage: 30V, Max Sense Voltage: 0.065V
//Output Current: 20uA, Output Voltage: 1.0725V, Output Type: voltage, Accuracy: yes, DFT: no
...
//Celera:amplifier_5eb05a6d
//Celera Confidential Symbol Generator
//Gain Adjust:openloop, Input Type:p, Bandwidth:low
module amplifier_5eb05a6d (SIMPV,INP,IP,OUT,enable_amplifier,ok_amplifier,global_amplifier,
INN,
CELG,CELSUB);
input SIMPV;
input INP;
...
currentsenseamplifier_dda35502 XCSA1 (
.IP(IP_710ca24c),
...
currentsenseamplifier_4324b6cf XCSA2 (
.IP(IP_5edb1fba),
.RTN(kelvin_GNDcurrentsense),
.CELG(CELG59462),
.CELV(CELV96848),
...
amplifier_5eb05a6d Xamplifier1 (
.IP(IP_5df77333),
.INN(net_233),
.INP(net_156),
.OUT(net_233),
