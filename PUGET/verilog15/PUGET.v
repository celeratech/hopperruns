...
// ------------------------ Module Verilog ---------------
module PUGET (IN, RT, SW, VC, BST, CFN, CFP, GPI, PFI, PFO, SCL, SDA, CAP1, CAP2, CAP3, CAP4, ICAP, ITST, PGND, SGND, VCAP, ALERT, BGATE, CAPFB, CAPGD, CELIN, DRVCC, INFET, OUTFB, TGATE, CAPRTN, CELOUT, INTVCC, OUTFET, VCAPP5, VCC2P5, VOUTM5, VOUTSN, VOUTSP, PINTVCC, CAPSLCT0, CAPSLCT1);
inout  IN;
inout  RT;
inout  SW;
inout  VC;
