...
module PUGETceleraRING (IN,RT,SW,VC,BST,CFN,CFP,GPI,PFI,PFO,SCL,SDA,TAO,tdo,tmi,CAP1,CAP2,CAP3,CAP4,GOTP,ICAP,ITST,PGND,SGND,VCAP,VOTP,ALERT,BGATE,CAPFB,CAPGD,DRVCC,INFET,OUTFB,TAEXT,TGATE,CAPRTN,INTVCC,OUTFET,VCAPP5,VCC2P5,VOUTM5,VOUTSN,VOUTSP,PINTVCC,CAPSLCT0,CAPSLCT1,GPIinput,CELG59462,CELV96848,GNDcapesr,INservice,CAP4capesr,GNDcharger,GNDservice,sense_ITST,CELSENSE_RF,CELSUB40948,CELV_SERDES,INpowerpath,PGNDcharger,DRVCCcharger,GNDpowergood,GNDtelemetry,INTVCCcapesr,INcapmanager,dftstatusLSB,dftstatusMSB,CAPSLCT0input,CAPSLCT1input,INTVCCcharger,VCAPP5charger,VOUTSNservice,VOUTSPcharger,CAP1capmanager,CAP2capmanager,CAP3capmanager,CAP4capmanager,GNDpowerpathin,PGNDchargepump,VCAPchargepump,INTVCCcapdecode,INTVCCpowergood,INTVCCtelemetry,VCC2P5capdecode,CAPRTNcapmanager,INTVCCcapmanager,INTVCCchargepump,SENSE_G_05e8d170,kelvin_GNDcapesr,kelvin_INservice,INTVCCpowerpathin,PINTVCCchargepump,VOUTSPpowerpathin,kelvin_GNDservice,GNDpowerpathcharge,INTVCCfaultmanager,kelvin_ICAPcharger,kelvin_INtelemetry,kelvin_VCAPcharger,kelvin_VCAPservice,VCAPpowerpathcharge,kelvin_DRVCCservice,kelvin_GNDcapdecode,kelvin_GNDpowergood,kelvin_GNDtelemetry,kelvin_INTVCCcapesr,kelvin_CAP1telemetry,kelvin_CAP2telemetry,kelvin_CAP3telemetry,kelvin_CAP4telemetry,kelvin_CFPchargepump,kelvin_GNDcapmanager,kelvin_GNDchargepunp,kelvin_GNDregulation,kelvin_INTVCCservice,kelvin_VCAPtelemetry,kelvin_VCC2P5service,kelvin_VOUTSNcharger,kelvin_VOUTSNservice,INTVCCpowerpathcharge,VCAPP5powerpathcharge,kelvin_VCAPchargepump,kelvin_CAPRTNtelemetry,kelvin_VOUTSNtelemetry,celkelvin_SGND_2b3a9b82,celkelvin_SGND_47887109,celkelvin_SGND_a235ee47,celkelvin_SGND_ad75a0ae,celkelvin_SGND_caab0eec,celkelvin_SGND_d3b67ad0,celkelvin_SGND_fb33d1d2,kelvin_GNDcapacitorgood,kelvin_VCAPP5chargepump,kelvin_GNDcurrentsensein,kelvin_VOUTSPpowerpathin,celkelvin_INTVCC_04cc16be,celkelvin_INTVCC_e8bee33d,kelvin_GNDcurrentsensecharge,kelvin_VOUTSNpowerpathcharge,celkelvin_INpowerpath_a235ee47,celkelvin_VCAPpowerpathcharge_fb33d1d2);
  ...
  inout [7:0] dftstatusLSB;
  inout [7:0] dftstatusMSB;
  output  CAPSLCT0input;
  output  CAPSLCT1input;
...
register_msk_mon_status, register_sequencer_reset, register_vcap_ov_lvl, register_vcap_uv_lvl,
register_vcapfb_dac, register_vin_ov_lvl, register_vin_uv_lvl, register_vout_ov_lvl,
register_vout_uv_lvl, register_vshunt, i2cbus, i2cmiso, CELG, CELSUB, CELV,
chipid, chiprevision, status_FAULTMANAGERstatus, status_PUGETfaultmanager, status_alarm_reg,
status_chrg_status, status_meas_cap, status_meas_dtemp, status_meas_esr, status_meas_esrgain,
status_meas_gpi, status_meas_ichrg, status_meas_iin, status_meas_vcap1, status_meas_vcap2,
status_meas_vcap3, status_meas_vcap4, status_meas_vcap, status_meas_vin, status_meas_vout,
status_mon_status, status_num_caps );
...
// ------------------------ Module Verilog ---------------
module PUGET (IN, RT, SW, VC, BST, CFN, CFP, GPI, PFI, PFO, SCL, SDA, CAP1, CAP2, CAP3, CAP4, ICAP, ITST, PGND, SGND, VCAP, ALERT, BGATE, CAPFB, CAPGD, DRVCC, INFET, OUTFB, TGATE, CAPRTN, INTVCC, OUTFET, VCAPP5, VCC2P5, VOUTM5, VOUTSN, VOUTSP, PINTVCC, CAPSLCT0, CAPSLCT1);
inout  IN;
inout  RT;
inout  SW;
inout  VC;
...
.VOUTM5(VOUTM5),
.i2cbusy(i2cbusy),
.CAPSLCT0(CAPSLCT0input),
.CAPSLCT1(CAPSLCT1input),
.CELG59462(CELG59462),
.CELV96848(CELV96848),
.GNDcapesr(GNDcapesr),
.INservice(INservice),
...
.dftstatusLSB(dftstatusLSB[7:0]),
.dftstatusMSB(dftstatusMSB[7:0]),
.CAPSLCT0input(CAPSLCT0input),
.CAPSLCT1input(CAPSLCT1input),
.INTVCCcharger(INTVCCcharger),
.VCAPP5charger(VCAPP5charger),
.VOUTSNservice(VOUTSNservice),
.VOUTSPcharger(VOUTSPcharger),
...
.register_sequencer_reset(register_sequencer_reset_0),
