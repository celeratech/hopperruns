...
module pad_PUGET_VOUTSP (VOUTSN,VOUTSP,VOUTSPcharger,kelvin_VOUTSPpowerpathin);
  input  VOUTSN;
  inout  VOUTSP;
...
.a({x1,x0}),
.SUB(CELSUB40948),
.ten({noconn_dftby7,noconn_dftby6,noconn_dftby5,noconn_dftby4,noconn_dftby3,noconn_dftby2,PAD_outputTXO_XCAPGD_BYPASSoutputTXOdiode_1,PAD_outputTXO_XCAPGD_BYPASSoutputTXOdiode_0}),
...
.a({b1,b0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0xFF_ten_7,noconn_dft_hex0xFF_ten_6,noconn_dft_hex0xFF_ten_5,noconn_dft_hex0xFF_ten_4,noconn_dft_hex0xFF_ten_3,noconn_dft_hex0xFF_ten_2,ten_tdext_XCELIN,ten_taext_XCELIN}),
...
STONEnoconn XNCnoconn_dftby2 (
.noconn(noconn_dftby2)
);

STONEnoconn XNCnoconn_dftby3 (
.noconn(noconn_dftby3)
);
...
BYPASSoutputTXOdiode XCAPGD_BYPASSoutputTXOdiode (
.PAD(CAPGD),
.TAO(TAO),
.tdo(tdo),
.CELG(CELG59462),
...
.CELSUB(CELSUB40948),
.PADout(CAPGD_inout),
.bypass_output({PAD_outputTXO_XCAPGD_BYPASSoutputTXOdiode_1,PAD_outputTXO_XCAPGD_BYPASSoutputTXOdiode_0})
);

STONEnoconn XNCnoconn_dft_hex0xFF_ten_2 (
.noconn(noconn_dft_hex0xFF_ten_2)
);
