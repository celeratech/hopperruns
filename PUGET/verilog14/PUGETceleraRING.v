...
//Verilog HDL for "BYPASS", "BYPASSinputTAOlow" "functional"


module BYPASSinputTAOlow ( PADin, PAD, CELG, CELSUB, CELV, TAO, bypass_output
);
...
//Verilog HDL for "BYPASS", "BYPASSinputTDOlow" "functional"


module BYPASSinputTDOlow ( PADin, PAD, CELG, CELSUB, CELV, bypass_output, tdo
);
...
.a({z1,z0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0xFF_ten_7,noconn_dft_hex0xFF_ten_6,noconn_dft_hex0xFF_ten_5,noconn_dft_hex0xFF_ten_4,noconn_dft_hex0xFF_ten_3,ten_TAEXT_bypass,ten_TAO_bypass,ten_tdo_bypass}),
.tma({z1,z1,z1,z1,z1,z1,z1,z1}),
.tmi(tmi[4:0])
);
...
BYPASSinputTAOlow XTAO_BYPASSinputTAOlow (
.PAD(CAPSLCT0),
.TAO(TAO),
.CELG(SGND),
.CELV(INTVCC),
.PADin(CAPSLCT0input),
.CELSUB(CELSUB40948),
.bypass_output(ten_TAO_bypass)
);

BYPASSinputTDOlow XTDO_BYPASSinputTDOlow (
.PAD(CAPSLCT1),
.tdo(tdo),
.CELG(SGND),
.CELV(INTVCC),
.PADin(CAPSLCT1input),
.CELSUB(CELSUB40948),
.bypass_output(ten_tdo_bypass)
);

STONEnoconn XNCnoconn_dft_hex0xFF_ten_3 (
.noconn(noconn_dft_hex0xFF_ten_3)
);
...
BYPASSinputANALOGlive XTAEXT_BYPASSinputANALOGlive (
.PAD(GPI),
.CELG(SGND),
.MUDV(INTVCC),
.PADin(GPIinput),
