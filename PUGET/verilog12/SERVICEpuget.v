...
.SERVICEconfiguration_756df643(SERVICEconfiguration_756df643[1:0])
);
...
.SUB(CELSUB40948),
.tmi(tmi[4:0]),
.drm0({trim_ref_3e4f0b79[5],trim_ref_3e4f0b79[4],trim_ref_3e4f0b79[3],trim_ref_3e4f0b79[2],trim_ref_3e4f0b79[1],trim_ref_3e4f0b79[0],SERVICEconfiguration_756df643[1],SERVICEconfiguration_756df643[0]}),
...
.CELG(CELG59462),
.CELV(CELV96848),
.ISET(IP_SERVICEpuget1),
.CELSUB(CELSUB40948),
.ok_currentmirror(noconn_5b647337),
.enable_currentmirror(enable_)
);

STONEnoconn XNCnoconn_5b647337 (
.noconn(noconn_5b647337)
);
