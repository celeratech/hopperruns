...
.bbm_powerpathin(net_236),
.BBMconfiguration_0(net_186),
.BBMconfiguration_1(net_187),
.enable_powerpathin(enable_powerpathin),
.on_powerpathcharge(on_powerpathcharge),
.bbm_powerpathcharge(net_237),
...
.BBMconfiguration_0(net_186),
.BBMconfiguration_1(net_187),
.select_powerpathin(net_232),
.select_powerpathcharge(net_234),
...
.enable_chargepump(enable_chargepump),
.hijack_ok_service(net_233),
.hijack_fault_puget(net_238),
.bbm_powerpathcharge(net_237),
...
.enable_telemetry(enable_telemetry),
.enable_faultmanager(enable_faultmanager),
.enable_chargereference(ok_capcalculate)
);
