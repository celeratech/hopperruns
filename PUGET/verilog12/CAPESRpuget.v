...
.mon_cap_done(net_353),
.mon_esr_done(net_356),
.allow_charger(allow_charger),
.enable_capesr(enable_capesr),
.mon_cap_failed(net_359),
.mon_esr_failed(net_361),
.mon_capesr_active(net_350),
.mon_capesr_pending(net_354),
.status_mon_status_9(status_mon_status_9[9:0]),
.mon_capesr_scheduled(net_352),
...
.cap_esr_per_0(net_306),
.cap_esr_per_1(net_307),
.cap_esr_per_2(net_308),
.cap_esr_per_3(net_309),
.cap_esr_per_4(net_310),
.cap_esr_per_5(net_311),
.cap_esr_per_6(net_312),
.cap_esr_per_7(net_313),
.cap_esr_per_8(net_314),
.cap_esr_per_9(net_315),
.cap_esr_per_10(net_316),
.cap_esr_per_11(net_317),
.cap_esr_per_12(net_318),
.cap_esr_per_13(net_319),
.cap_esr_per_14(net_320),
.cap_esr_per_15(net_321),
.request_clockRT(request_clockRT),
.CONTROLregister_0(net_322),
.CONTROLregister_1(net_323),
.CONTROLregister_2(net_324),
.CONTROLregister_3(net_325),
...
.cap_esr_per_14(net_320),
.cap_esr_per_15(net_321),
.request_capesr(net_362),
.CONTROLregister_0(net_322),
.CONTROLregister_1(net_323),
.CONTROLregister_2(net_324),
.CONTROLregister_3(net_325),
.blank_charger_cap(net_365),
.blank_charger_esr(net_366),
...
.power_good(power_good),
.CELSUB40948(CELSUB40948),
.hijack_mode_cv(net_372),
.hijack_power_good(net_371),
.fail_capacitorgood(fail_capacitorgood),
.hijack_fail_capacitorgood(net_373)
);
...
.enable_capesr(enable_capesr),
.fault_captest(net_349),
.fault_esrtest(net_369),
.fault_overflow(net_351),
.mon_cap_failed(net_359),
.mon_esr_failed(net_361),
.request_capesr(net_362),
.fault_sequencer(net_370),
...
.disable_esr(net_357),
.clock_capesr(clock_capesr),
.done_captest(net_347),
.done_esrtest(net_364),
.blank_charger(net_365),
.enable_captest(net_358),
.enable_esrtest(net_367),
.request_capesr(net_362),
.fault_sequencer(net_370),
.done_capcalculate(done_capcalculate),
.mon_capesr_active(net_350),
.fail_capacitorgood(net_373),
.mon_capesr_pending(net_354),
...
.drm3({ESRalgorithm_fc7686ad,ESRtestBUSY_a0d26352,ESRrelaxTIME_291ff990[1],ESRrelaxTIME_291ff990[0],GMInominal_2667fe69[3],GMInominal_2667fe69[2],GMInominal_2667fe69[1],GMInominal_2667fe69[0]}),
...
.drm6({ESRcalculator_92321f89[7],ESRcalculator_92321f89[6],ESRcalculator_92321f89[5],ESRcalculator_92321f89[4],ESRcalculator_92321f89[3],ESRcalculator_92321f89[2],ESRcalculator_92321f89[1],ESRcalculator_92321f89[0]}),
.drm7({noconn_drm_hex0x01_drm7_7,CAPtestBUSY_7a7c1745,ESRtestSEQUENCER_Rev2_statecontrol_02a05032[3],ESRtestSEQUENCER_Rev2_statecontrol_02a05032[2],ESRtestSEQUENCER_Rev2_statecontrol_02a05032[1],ESRtestSEQUENCER_Rev2_statecontrol_02a05032[0],ESRpretime_5e789ff3[1],ESRpretime_5e789ff3[0]}),
.por0({a0,a1,a0,a0,a0,a0,a0,a0}),
.por1({a0,a0,a0,a0,a0,a0,a0,a0}),
.por2({a0,a1,a1,a0,a1,a1,a0,a1}),
.por3({a1,a1,a1,a1,a1,a1,a1,a1}),
.por4({a0,a0,a0,a1,a0,a0,a0,a0}),
.por5({a0,a0,a0,a0,a0,a0,a0,a1}),
.por6({a1,a0,a1,a1,a1,a0,a0,a1}),
.por7({a0,a1,a0,a0,a0,a0,a1,a1}),
.bypload(a0),
.lastdrm(a0)
);
