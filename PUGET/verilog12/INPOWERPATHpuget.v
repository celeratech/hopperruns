...
module INPOWERPATHpugetMAIN (IN,tdo,tmi,INFET,SIMPV,VOUTM5,VOUTSP,ok_infet,on_infet,CELG59462,CELV96848,PORB97836,CELREF84329,CELSUB40948,IP_989bdf2c,IP_af6d18cd,kelvin_VOUTSP,voutm5_enable,GNDpowerpathin,in_startuptime,ok_powerpathin,on_powerpathin,clock_powerpathin,enable_powerpathin,celkelvin_SGND_a235ee47,trim_floatingreturn_af6d18cd,celkelvin_INpowerpath_a235ee47,trim_powerpathnegative_989bdf2c,trim_powerpathpositive_989bdf2c,trim_powerpathfloatingreturn_989bdf2c);
  input  IN;
  inout  tdo;
  input [4:0] tmi;
  output  INFET;
...
.voutm5_enable(net_60),
.in_startuptime(net_59),
.POWERPATHINvoutm5_987ddae4(POWERPATHINvoutm5_987ddae4),
.POWERPATHINstartupTime_7ea55d45(POWERPATHINstartupTime_7ea55d45)
);
...
.hijack_enable_powerpathin(net_61)
);
...
.SUB(CELSUB40948),
.tmi(tmi[4:0]),
.drm0({noconn_drm_hex0x0F_drm0_7,noconn_drm_hex0x0F_drm0_6,trim_floatingreturn_af6d18cd[3],trim_floatingreturn_af6d18cd[2],trim_floatingreturn_af6d18cd[1],trim_floatingreturn_af6d18cd[0],POWERPATHINvoutm5_987ddae4,POWERPATHINstartupTime_7ea55d45}),
