...
.ok_capacitorgood(net_388),
.REF_CAPACITORGOOD(net_391),
.fail_capacitorgood(fail_capacitorgood),
.enable_capacitorgood(net_387),
...
.go_softstart(net_373),
.allow_charger(allow_charger),
.blank_charger(blank_charger),
.go_regulation(net_378),
.mode_stepdown(net_352),
.ok_regulation(net_365),
.enable_charger(enable_charger),
.freeze_charger(net_370),
.enable_regulation(net_350),
.ok_currentsensein(net_369),
.completed_softstart(net_376),
.clock_chargercontrol(clock_charger),
.enable_currentsensein(net_358),
.ok_currentsensecharge(net_364),
.enable_currentsensecharge(net_353),
...
.CELSUB40948(CELSUB40948),
.refresh_bst(net_384),
.bbm_bottomon(net_383),
.bottom_state(net_398),
.bottom_status(net_402),
.enable_driver(net_394),
...
.CELV96848(CELV96848),
.CELSUB40948(CELSUB40948),
.fault_stepup(net_399),
.fault_charger(fault_charger),
.fault_stepdown(net_367),
.fault_regulation(net_403),
...
.ok_currentsense(net_369),
.clock_currentsense(clock_charger),
.enable_currentsense(net_358),
...
.mode_stepup(net_357),
.bottom_state(net_398),
.clock_stepup(net_392),
.start_stepup(net_389),
.top_stepdown(net_359),
.bottom_status(net_402),
.bottom_stepup(net_397),
.enable_driver(net_394),
.mode_stepdown(net_352),
.clock_stepdown(net_366),
.start_stepdown(net_354),
.bottom_stepdown(net_363),
.enable_driver_stepup(net_390),
.enable_driver_stepdown(net_351)
);
...
.bbm_bottomon(net_383),
.state_bottom(net_375),
.clock_charger(net_366),
.driver_bottom(net_363),
.enable_driver(net_351),
...
.fault_stepup(net_399),
.start_stepup(net_389),
.clock_charger(net_392),
.driver_bottom(net_397),
.enable_driver(net_390),
.go_regulation(net_393),
.freeze_charger(net_370),
...
.drm4({REGULATIONconfiguration_CAP_4ab97568[1],REGULATIONconfiguration_CAP_4ab97568[0],REGULATIONichargeMinimum_57e8bf17[1],REGULATIONichargeMinimum_57e8bf17[0],trim_slopecomp_8ccaa412[3],trim_slopecomp_8ccaa412[2],trim_slopecomp_8ccaa412[1],trim_slopecomp_8ccaa412[0]}),
.drm5({noconn_drm_hex0x09_drm5_7,trim_vbuffer_negative_7083b26d[6],trim_vbuffer_negative_7083b26d[5],trim_vbuffer_negative_7083b26d[4],trim_vbuffer_negative_7083b26d[3],trim_vbuffer_negative_7083b26d[2],trim_vbuffer_negative_7083b26d[1],trim_vbuffer_negative_7083b26d[0]}),
.drm6({noconn_drm_hex0x09_drm6_7,trim_vbuffer_positive_7083b26d[6],trim_vbuffer_positive_7083b26d[5],trim_vbuffer_positive_7083b26d[4],trim_vbuffer_positive_7083b26d[3],trim_vbuffer_positive_7083b26d[2],trim_vbuffer_positive_7083b26d[1],trim_vbuffer_positive_7083b26d[0]}),
.drm7({noconn_drm_hex0x09_drm7_7,trim_vbuffer_negative_3ae58f1d[6],trim_vbuffer_negative_3ae58f1d[5],trim_vbuffer_negative_3ae58f1d[4],trim_vbuffer_negative_3ae58f1d[3],trim_vbuffer_negative_3ae58f1d[2],trim_vbuffer_negative_3ae58f1d[1],trim_vbuffer_negative_3ae58f1d[0]}),
.por0({c0,c0,c1,c0,c0,c1,c0,c0}),
.por1({c0,c0,c0,c0,c1,c0,c0,c0}),
.por2({c0,c0,c0,c0,c0,c0,c0,c0}),
.por3({c0,c1,c0,c1,c0,c1,c0,c1}),
.por4({c1,c0,c0,c0,c0,c0,c0,c0}),
...
.SUB(CELSUB40948),
.tmi(tmi[4:0]),
.drm0({noconn_drm_hex0x0A_drm0_7,trim_vbuffer_positive_3ae58f1d[6],trim_vbuffer_positive_3ae58f1d[5],trim_vbuffer_positive_3ae58f1d[4],trim_vbuffer_positive_3ae58f1d[3],trim_vbuffer_positive_3ae58f1d[2],trim_vbuffer_positive_3ae58f1d[1],trim_vbuffer_positive_3ae58f1d[0]}),
...
.drm3({REGULATIONconfiguration_OUT_b4dbc1b8[1],REGULATIONconfiguration_OUT_b4dbc1b8[0],trim_resistor_6d2de901[5],trim_resistor_6d2de901[4],trim_resistor_6d2de901[3],trim_resistor_6d2de901[2],trim_resistor_6d2de901[1],trim_resistor_6d2de901[0]}),
.drm4({noconn_drm_hex0x0A_drm4_7,trim_daconegative_5318332e[6],trim_daconegative_5318332e[5],trim_daconegative_5318332e[4],trim_daconegative_5318332e[3],trim_daconegative_5318332e[2],trim_daconegative_5318332e[1],trim_daconegative_5318332e[0]}),
.drm5({noconn_drm_hex0x0A_drm5_7,trim_dacopositive_5318332e[6],trim_dacopositive_5318332e[5],trim_dacopositive_5318332e[4],trim_dacopositive_5318332e[3],trim_dacopositive_5318332e[2],trim_dacopositive_5318332e[1],trim_dacopositive_5318332e[0]}),
.drm6({noconn_drm_hex0x0A_drm6_7,trim_vbuffer_negative_105ca7a5[6],trim_vbuffer_negative_105ca7a5[5],trim_vbuffer_negative_105ca7a5[4],trim_vbuffer_negative_105ca7a5[3],trim_vbuffer_negative_105ca7a5[2],trim_vbuffer_negative_105ca7a5[1],trim_vbuffer_negative_105ca7a5[0]}),
.drm7({noconn_drm_hex0x0A_drm7_7,trim_vbuffer_positive_105ca7a5[6],trim_vbuffer_positive_105ca7a5[5],trim_vbuffer_positive_105ca7a5[4],trim_vbuffer_positive_105ca7a5[3],trim_vbuffer_positive_105ca7a5[2],trim_vbuffer_positive_105ca7a5[1],trim_vbuffer_positive_105ca7a5[0]}),
.por0({d0,d0,d0,d0,d0,d0,d0,d0}),
.por1({d0,d0,d0,d0,d0,d0,d0,d0}),
.por2({d0,d0,d0,d0,d0,d0,d0,d0}),
.por3({d1,d0,d0,d0,d0,d0,d0,d0}),
...
.SUB(CELSUB40948),
.tmi(tmi[4:0]),
.drm0({noconn_drm_hex0x0B_drm0_7,noconn_drm_hex0x0B_drm0_6,noconn_drm_hex0x0B_drm0_5,noconn_drm_hex0x0B_drm0_4,REGULATIONconfiguration_IIN_d07b1bd1[1],REGULATIONconfiguration_IIN_d07b1bd1[0],REGULATIONconfiguration_CHARGE_cff1127f[1],REGULATIONconfiguration_CHARGE_cff1127f[0]}),
.drm1({noconn_drm_hex0x0B_drm1_7,trim_vbuffer_negative_6a90c8ee[6],trim_vbuffer_negative_6a90c8ee[5],trim_vbuffer_negative_6a90c8ee[4],trim_vbuffer_negative_6a90c8ee[3],trim_vbuffer_negative_6a90c8ee[2],trim_vbuffer_negative_6a90c8ee[1],trim_vbuffer_negative_6a90c8ee[0]}),
.drm2({noconn_drm_hex0x0B_drm2_7,trim_vbuffer_positive_6a90c8ee[6],trim_vbuffer_positive_6a90c8ee[5],trim_vbuffer_positive_6a90c8ee[4],trim_vbuffer_positive_6a90c8ee[3],trim_vbuffer_positive_6a90c8ee[2],trim_vbuffer_positive_6a90c8ee[1],trim_vbuffer_positive_6a90c8ee[0]}),
.drm3({noconn_drm_hex0x0B_drm3_7,trim_vbuffer_negative_0966dad2[6],trim_vbuffer_negative_0966dad2[5],trim_vbuffer_negative_0966dad2[4],trim_vbuffer_negative_0966dad2[3],trim_vbuffer_negative_0966dad2[2],trim_vbuffer_negative_0966dad2[1],trim_vbuffer_negative_0966dad2[0]}),
.drm4({noconn_drm_hex0x0B_drm4_7,trim_vbuffer_positive_0966dad2[6],trim_vbuffer_positive_0966dad2[5],trim_vbuffer_positive_0966dad2[4],trim_vbuffer_positive_0966dad2[3],trim_vbuffer_positive_0966dad2[2],trim_vbuffer_positive_0966dad2[1],trim_vbuffer_positive_0966dad2[0]}),
.drm5({noconn_drm_hex0x0B_drm5_7,trim_vbuffer_negative_7772143f[6],trim_vbuffer_negative_7772143f[5],trim_vbuffer_negative_7772143f[4],trim_vbuffer_negative_7772143f[3],trim_vbuffer_negative_7772143f[2],trim_vbuffer_negative_7772143f[1],trim_vbuffer_negative_7772143f[0]}),
.drm6({noconn_drm_hex0x0B_drm6_7,trim_vbuffer_positive_7772143f[6],trim_vbuffer_positive_7772143f[5],trim_vbuffer_positive_7772143f[4],trim_vbuffer_positive_7772143f[3],trim_vbuffer_positive_7772143f[2],trim_vbuffer_positive_7772143f[1],trim_vbuffer_positive_7772143f[0]}),
.drm7({noconn_drm_hex0x0B_drm7_7,trim_vbuffer_negative_0e0c92f3[6],trim_vbuffer_negative_0e0c92f3[5],trim_vbuffer_negative_0e0c92f3[4],trim_vbuffer_negative_0e0c92f3[3],trim_vbuffer_negative_0e0c92f3[2],trim_vbuffer_negative_0e0c92f3[1],trim_vbuffer_negative_0e0c92f3[0]}),
.por0({e0,e0,e0,e0,e1,e0,e1,e0}),
...
.SUB(CELSUB40948),
.tmi(tmi[4:0]),
.drm0({noconn_drm_hex0x0C_drm0_7,trim_vbuffer_positive_0e0c92f3[6],trim_vbuffer_positive_0e0c92f3[5],trim_vbuffer_positive_0e0c92f3[4],trim_vbuffer_positive_0e0c92f3[3],trim_vbuffer_positive_0e0c92f3[2],trim_vbuffer_positive_0e0c92f3[1],trim_vbuffer_positive_0e0c92f3[0]}),
.drm1({noconn_drm_hex0x0C_drm1_7,trim_gm_negative_c94c94b3[6],trim_gm_negative_c94c94b3[5],trim_gm_negative_c94c94b3[4],trim_gm_negative_c94c94b3[3],trim_gm_negative_c94c94b3[2],trim_gm_negative_c94c94b3[1],trim_gm_negative_c94c94b3[0]}),
.drm2({noconn_drm_hex0x0C_drm2_7,trim_gm_positive_c94c94b3[6],trim_gm_positive_c94c94b3[5],trim_gm_positive_c94c94b3[4],trim_gm_positive_c94c94b3[3],trim_gm_positive_c94c94b3[2],trim_gm_positive_c94c94b3[1],trim_gm_positive_c94c94b3[0]}),
.drm3({noconn_drm_hex0x0C_drm3_7,trim_gm_negative_b4150cea[6],trim_gm_negative_b4150cea[5],trim_gm_negative_b4150cea[4],trim_gm_negative_b4150cea[3],trim_gm_negative_b4150cea[2],trim_gm_negative_b4150cea[1],trim_gm_negative_b4150cea[0]}),
.drm4({noconn_drm_hex0x0C_drm4_7,trim_gm_positive_b4150cea[6],trim_gm_positive_b4150cea[5],trim_gm_positive_b4150cea[4],trim_gm_positive_b4150cea[3],trim_gm_positive_b4150cea[2],trim_gm_positive_b4150cea[1],trim_gm_positive_b4150cea[0]}),
.drm5({noconn_drm_hex0x0C_drm5_7,trim_gm_negative_fec6b98a[6],trim_gm_negative_fec6b98a[5],trim_gm_negative_fec6b98a[4],trim_gm_negative_fec6b98a[3],trim_gm_negative_fec6b98a[2],trim_gm_negative_fec6b98a[1],trim_gm_negative_fec6b98a[0]}),
.drm6({noconn_drm_hex0x0C_drm6_7,trim_gm_positive_fec6b98a[6],trim_gm_positive_fec6b98a[5],trim_gm_positive_fec6b98a[4],trim_gm_positive_fec6b98a[3],trim_gm_positive_fec6b98a[2],trim_gm_positive_fec6b98a[1],trim_gm_positive_fec6b98a[0]}),
.drm7({noconn_drm_hex0x0C_drm7_7,trim_gm_negative_1695702d[6],trim_gm_negative_1695702d[5],trim_gm_negative_1695702d[4],trim_gm_negative_1695702d[3],trim_gm_negative_1695702d[2],trim_gm_negative_1695702d[1],trim_gm_negative_1695702d[0]}),
...
.SUB(CELSUB40948),
.tmi(tmi[4:0]),
.drm0({noconn_drm_hex0x0D_drm0_7,trim_gm_positive_1695702d[6],trim_gm_positive_1695702d[5],trim_gm_positive_1695702d[4],trim_gm_positive_1695702d[3],trim_gm_positive_1695702d[2],trim_gm_positive_1695702d[1],trim_gm_positive_1695702d[0]}),
.drm1({noconn_drm_hex0x0D_drm1_7,noconn_drm_hex0x0D_drm1_6,trim_currentgenerator_4b9a0f83[5],trim_currentgenerator_4b9a0f83[4],trim_currentgenerator_4b9a0f83[3],trim_currentgenerator_4b9a0f83[2],trim_currentgenerator_4b9a0f83[1],trim_currentgenerator_4b9a0f83[0]}),
.drm2({noconn_drm_hex0x0D_drm2_7,noconn_drm_hex0x0D_drm2_6,noconn_drm_hex0x0D_drm2_5,CHARGERalgorithm1p5_statecontrol_e7a1674f[4],CHARGERalgorithm1p5_statecontrol_e7a1674f[3],CHARGERalgorithm1p5_statecontrol_e7a1674f[2],CHARGERalgorithm1p5_statecontrol_e7a1674f[1],CHARGERalgorithm1p5_statecontrol_e7a1674f[0]}),
.drm3({noconn_drm_hex0x0D_drm3_7,noconn_drm_hex0x0D_drm3_6,noconn_drm_hex0x0D_drm3_5,CHARGERalgorithm3p1_statecontrol_5fe11ac3[4],CHARGERalgorithm3p1_statecontrol_5fe11ac3[3],CHARGERalgorithm3p1_statecontrol_5fe11ac3[2],CHARGERalgorithm3p1_statecontrol_5fe11ac3[1],CHARGERalgorithm3p1_statecontrol_5fe11ac3[0]}),
.por0({g0,g0,g0,g0,g0,g0,g0,g0}),
.por1({g0,g0,g0,g0,g0,g0,g0,g0}),
.por2({g0,g0,g0,g1,g0,g0,g0,g0}),
.por3({g0,g0,g0,g1,g0,g0,g0,g0}),
.bypload(g0),
.lastdrm(g0)
);
...
STONEnoconn XNCnoconn_drm_hex0x0A_drm7_7 (
.noconn(noconn_drm_hex0x0A_drm7_7)
);

STONEnoconn XNCnoconn_drm_hex0x0B_drm0_4 (
.noconn(noconn_drm_hex0x0B_drm0_4)
);

STONEnoconn XNCnoconn_drm_hex0x0B_drm0_5 (
.noconn(noconn_drm_hex0x0B_drm0_5)
);

STONEnoconn XNCnoconn_drm_hex0x0B_drm0_6 (
.noconn(noconn_drm_hex0x0B_drm0_6)
);
...
STONEnoconn XNCnoconn_drm_hex0x0D_drm3_5 (
.noconn(noconn_drm_hex0x0D_drm3_5)
);

STONEnoconn XNCnoconn_drm_hex0x0D_drm3_6 (
.noconn(noconn_drm_hex0x0D_drm3_6)
);

STONEnoconn XNCnoconn_drm_hex0x0D_drm3_7 (
.noconn(noconn_drm_hex0x0D_drm3_7)
);
