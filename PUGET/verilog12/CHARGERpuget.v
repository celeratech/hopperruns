...
module CURRENTSENSEcharge (TAO,tdo,tmi,SIMPV,VCAPP5,ICHARGE,GMCHARGE,CELG59462,CELV96848,PORB97836,ok_icharge,CELSUB40948,IP_5df77333,IP_5edb1fba,IP_6ba43ce2,IP_710ca24c,IP_86cef67b,IP_9a0a05e4,IP_d9771bce,kelvin_ICAP,kelvin_VCAP,mode_stepdown,measure_icharge,ok_currentsense,ICHARGE_TELEMETRY,clock_currentsense,enable_currentsense,kelvin_GNDcurrentsense,trim_csainput_5edb1fba,trim_csainput_710ca24c,trim_csaoutput_5edb1fba,trim_csaoutput_710ca24c,trim_vbuffer_negative_6ba43ce2,trim_vbuffer_negative_86cef67b,trim_vbuffer_negative_9a0a05e4,trim_vbuffer_positive_6ba43ce2,trim_vbuffer_positive_86cef67b,trim_vbuffer_positive_9a0a05e4,CURRENTSENSEchargeGain_73418860,factory_adjust_resistor_355938d3,factory_adjust_resistor_8855f5d6,CURRENTSENSEchargeMEASUREdelay_765a216f);
  inout  TAO;
  inout  tdo;
  input [4:0] tmi;
  input  SIMPV;
...
.trim_vbuffer_negative_86cef67b(trim_vbuffer_negative_86cef67b[6:0]),
.trim_vbuffer_negative_9a0a05e4(trim_vbuffer_negative_9a0a05e4[3:0]),
.trim_vbuffer_positive_6ba43ce2(trim_vbuffer_positive_6ba43ce2[6:0]),
.trim_vbuffer_positive_86cef67b(trim_vbuffer_positive_86cef67b[6:0]),
.trim_vbuffer_positive_9a0a05e4(trim_vbuffer_positive_9a0a05e4[3:0]),
...
.SUB(CELSUB40948),
.tmi(tmi[4:0]),
.drm0({CURRENTSENSEinAVERAGE_61254302,trim_vbuffer_negative_9a0a05e4[3],trim_vbuffer_negative_9a0a05e4[2],trim_vbuffer_negative_9a0a05e4[1],trim_vbuffer_negative_9a0a05e4[0],CURRENTSENSEchargeGain_73418860,CURRENTSENSEchargeMEASUREdelay_765a216f[1],CURRENTSENSEchargeMEASUREdelay_765a216f[0]}),
.drm1({REGULATIONvcSTEPDOWNzeroEnable_e63c870f,trim_csainput_710ca24c[6],trim_csainput_710ca24c[5],trim_csainput_710ca24c[4],trim_csainput_710ca24c[3],trim_csainput_710ca24c[2],trim_csainput_710ca24c[1],trim_csainput_710ca24c[0]}),
.drm2({REGULATIONvcSTEPUPzeroEnable_719d180b,trim_csaoutput_710ca24c[6],trim_csaoutput_710ca24c[5],trim_csaoutput_710ca24c[4],trim_csaoutput_710ca24c[3],trim_csaoutput_710ca24c[2],trim_csaoutput_710ca24c[1],trim_csaoutput_710ca24c[0]}),
.drm3({REGULATIONdisableSlope_44800eb7,trim_csainput_5edb1fba[6],trim_csainput_5edb1fba[5],trim_csainput_5edb1fba[4],trim_csainput_5edb1fba[3],trim_csainput_5edb1fba[2],trim_csainput_5edb1fba[1],trim_csainput_5edb1fba[0]}),
.drm4({noconn_drm_hex0x07_drm4_7,trim_csaoutput_5edb1fba[6],trim_csaoutput_5edb1fba[5],trim_csaoutput_5edb1fba[4],trim_csaoutput_5edb1fba[3],trim_csaoutput_5edb1fba[2],trim_csaoutput_5edb1fba[1],trim_csaoutput_5edb1fba[0]}),
.drm5({noconn_drm_hex0x07_drm5_7,trim_vbuffer_negative_6ba43ce2[6],trim_vbuffer_negative_6ba43ce2[5],trim_vbuffer_negative_6ba43ce2[4],trim_vbuffer_negative_6ba43ce2[3],trim_vbuffer_negative_6ba43ce2[2],trim_vbuffer_negative_6ba43ce2[1],trim_vbuffer_negative_6ba43ce2[0]}),
.drm6({noconn_drm_hex0x07_drm6_7,trim_vbuffer_positive_6ba43ce2[6],trim_vbuffer_positive_6ba43ce2[5],trim_vbuffer_positive_6ba43ce2[4],trim_vbuffer_positive_6ba43ce2[3],trim_vbuffer_positive_6ba43ce2[2],trim_vbuffer_positive_6ba43ce2[1],trim_vbuffer_positive_6ba43ce2[0]}),
.drm7({noconn_drm_hex0x07_drm7_7,factory_adjust_resistor_355938d3[2],factory_adjust_resistor_355938d3[1],factory_adjust_resistor_355938d3[0],trim_vbuffer_positive_9a0a05e4[3],trim_vbuffer_positive_9a0a05e4[2],trim_vbuffer_positive_9a0a05e4[1],trim_vbuffer_positive_9a0a05e4[0]}),
...
.SUB(CELSUB40948),
.tmi(tmi[4:0]),
.drm0({noconn_drm_hex0x08_drm0_7,trim_vbuffer_negative_86cef67b[6],trim_vbuffer_negative_86cef67b[5],trim_vbuffer_negative_86cef67b[4],trim_vbuffer_negative_86cef67b[3],trim_vbuffer_negative_86cef67b[2],trim_vbuffer_negative_86cef67b[1],trim_vbuffer_negative_86cef67b[0]}),
.drm1({noconn_drm_hex0x08_drm1_7,trim_vbuffer_positive_86cef67b[6],trim_vbuffer_positive_86cef67b[5],trim_vbuffer_positive_86cef67b[4],trim_vbuffer_positive_86cef67b[3],trim_vbuffer_positive_86cef67b[2],trim_vbuffer_positive_86cef67b[1],trim_vbuffer_positive_86cef67b[0]}),
...
.drm7({trim_vbuffer_positive_236470a4[3],trim_vbuffer_positive_236470a4[2],trim_vbuffer_positive_236470a4[1],trim_vbuffer_positive_236470a4[0],trim_vbuffer_negative_236470a4[3],trim_vbuffer_negative_236470a4[2],trim_vbuffer_negative_236470a4[1],trim_vbuffer_negative_236470a4[0]}),
...
currentmirror_291539a5 XCurrentMirror6 (
.I0(IP_05cb8bff),
.I1(IP_459d03f9),
.I2(IP_f21311f1),
.I3(IP_d4ca9582),
...
STONEnoconn XNCnoconn_drm_hex0x07_drm4_7 (
.noconn(noconn_drm_hex0x07_drm4_7)
);

STONEnoconn XNCnoconn_drm_hex0x07_drm5_7 (
.noconn(noconn_drm_hex0x07_drm5_7)
);
