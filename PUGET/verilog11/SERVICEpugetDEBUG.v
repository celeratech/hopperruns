...
module dftprobeModel0_2e247067 (i,tdi,ten,CELG,CELSUB,CELV);
input  i;
output  tdi;
input  ten;
input  CELG;
...
.a({b1,b0}),
.SUB(CELSUB40948),
.tdi({b0,b0,b0,b0,b0,tdi_XUSERVICEsyncstepup,tdi_XUSERVICEstartup,tdi_XUSERVICEoverin}),
.tdo(tdo),
.ten({noconn_dft_hex0x55_ten_7,noconn_dft_hex0x55_ten_6,ten_XUSERVICEsyncstepup,ten_XUSERVICEstartup,ten_XUSERVICEreference,ten_XUSERVICEoverin,ten_XUSERVICEokvcc2p5,ten_XUSERVICEokintvcc}),
.tma({b0,b1,b0,b1,b0,b1,b0,b1}),
.tmi(tmi[4:0])
);
...
dftprobeModel0_2e247067 XUSERVICEsyncstepup (
.i(dft_sync_stepup),
.tdi(tdi_XUSERVICEsyncstepup),
.ten(ten_XUSERVICEsyncstepup),
.CELG(CELG59462),
.CELV(CELV96848),
.CELSUB(CELSUB40948)
);
