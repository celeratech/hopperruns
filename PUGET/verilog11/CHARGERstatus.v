...
WRAPPER1 XWRAPstatus_chrg_status_11_0 (
.i(chrg_stepdown),
.o(status_chrg_status_11[0])
);

WRAPPER1 XWRAPstatus_chrg_status_11_1 (
.i(chrg_stepup),
.o(status_chrg_status_11[1])
);

WRAPPER1 XWRAPstatus_chrg_status_11_2 (
.i(chrg_cv),
.o(status_chrg_status_11[2])
);

WRAPPER1 XWRAPstatus_chrg_status_11_3 (
.i(chrg_uvlo),
.o(status_chrg_status_11[3])
);

WRAPPER1 XWRAPstatus_chrg_status_11_4 (
.i(chrg_input_ilim),
.o(status_chrg_status_11[4])
);

WRAPPER1 XWRAPstatus_chrg_status_11_5 (
.i(chrg_capg),
.o(status_chrg_status_11[5])
);

WRAPPER1 XWRAPstatus_chrg_status_11_6 (
.i(chrg_shunt),
.o(status_chrg_status_11[6])
);

WRAPPER1 XWRAPstatus_chrg_status_11_7 (
.i(chrg_bal),
.o(status_chrg_status_11[7])
);

WRAPPER1 XWRAPstatus_chrg_status_11_8 (
.i(chrg_dis),
.o(status_chrg_status_11[8])
);

WRAPPER1 XWRAPstatus_chrg_status_11_9 (
.i(chrg_ci),
.o(status_chrg_status_11[9])
);

WRAPPER1 XWRAPstatus_chrg_status_11_10 (
.i(net_47),
.o(status_chrg_status_11[10])
);

WRAPPER1 XWRAPstatus_chrg_status_11_11 (
.i(chrg_pfo),
