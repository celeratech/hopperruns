...
.mode_stepdown(net_261),
.ok_comparator(net_277),
.disable_slopecomp(net_265),
.enable_regulation(net_258),
...
.ok_gmcharge(net_274),
.enable_clock(net_270),
.ok_reference(net_262),
.go_regulation(net_278),
.ok_comparator(net_277),
.ok_regulation(ok_regulation),
.enable_charger(enable_charger),
.enable_softstart(net_272),
...
.hijack_mode_stepup(net_280),
.hijack_go_regulation(net_278),
.hijack_mode_stepdown(net_261),
.hijack_enable_regulation(net_258)
);
...
.ok_gmcharge(net_274),
.REF_GMCHARGE(net_260),
.enable_gmcharge(net_258),
