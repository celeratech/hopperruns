...
module TELEMETRYadcCLOCK (tdo,tmi,SIMPV,CELG59462,CELV96848,PORB97836,clock_adc,enable_adc,CELREF84329,CELSUB40948,IP_43a4af64,ok_adcclock,CLOCKselect_0,CLOCKselect_1,fault_adcclock,clock_converter,trim_oscillatorring_43a4af64);
  inout  tdo;
  input [4:0] tmi;
  input  SIMPV;
  input  CELG59462;
...
.clock_converter(net_142),
.done_adcconvert(net_140),
...
.hijack_adcin(net_147),
.dft_sampletime(net_143),
.enable_adcsample(net_137),
.start_adcconvert(net_138),
.hijack_enable_adc(net_136),
.dft_conversiontime(net_151),
.hijack_measure_adcin(net_148),
.hijack_enable_adcsample(net_144),
