...
module dftprobeModel0_8152f46f (i,tdi,ten,CELG,CELSUB,CELV);
input  i;
output  tdi;
input  ten;
input  CELG;
...
.a({c1,c0}),
.SUB(CELSUB40948),
.tdi({c0,tdi_XUSEQUENCERok_powerpathin,tdi_XUSEQUENCERok_powergood,tdi_XUSEQUENCERok_chargepump,tdi_XUSEQUENCERfault_sequencer,tdi_XUSEQUENCERenable_telemetry,tdi_XUSEQUENCERenable_powergood,tdi_XUSEQUENCERenable_limiter}),
.tdo(tdo),
.ten({ten_XUSEQUENCERfault_sequencer,ten_XUSEQUENCERenable_telemetry,ten_XUSEQUENCERenable_powergood,ten_XUSEQUENCERenable_limiter,ten_XUSEQUENCERenable_faultmanager,ten_XUSEQUENCERenable_charger,ten_XUSEQUENCERenable_chargepump,ten_XUSEQUENCERenable_capesr}),
.tma({c0,c1,c0,c0,c1,c1,c1,c1}),
.tmi(tmi[4:0])
);
...
dftprobeModel0_8152f46f XUSEQUENCERfault_sequencer (
.i(fault_sequencer),
.tdi(tdi_XUSEQUENCERfault_sequencer),
.ten(ten_XUSEQUENCERfault_sequencer),
.CELG(CELG59462),
.CELV(CELV96848),
.CELSUB(CELSUB40948)
);
