...
//Celera Confidential Do Not Copy delayclock_f77fd28a
//CONTROL:Pin:4 outputs
module delayclock_f77fd28a (in,CELV,out,clock,celeraporb,
delay,
CELG,CELSUB);
input CELV;
input in;
...
.CELV (CELV),
.i0 ({do,d1,d1,do,do,d1,do,do,do}),
.i1 ({d1,do,do,d1,do,d1,d1,do,do}),
.i2 ({d1,d1,do,do,d1,do,do,do,do}),
.i3 ({d1,d1,d1,d1,d1,do,d1,do,do}),
.sel (delay [1:0]),
