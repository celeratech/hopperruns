...
//Celera Confidential Do Not Copy ibiasmirror_sandh_3865bc65_IBIASMIRROR.v
//Celera:ibiasmirror_sandh_3865bc65_IBIASMIRROR
//Celera Confidential Symbol Generator
//OUTPUTS:2 VMAX:6V DFT:no
module ibiasmirror_sandh_3865bc65_IBIASMIRROR (SIMPV,IP,enable_ibiasmirror,global_ibiasmirror,ok_ibiasmirror,IPO,
CELG,CELSUB);
input SIMPV;
input IP;
...
//Celera Confidential Do Not Copy amplifier_sandh_3865bc65_Xampin.v
//Celera:amplifier_sandh_3865bc65_Xampin
//Celera Confidential Symbol Generator
//Gain Adjust:openloop, Input Type:p, Bandwidth:medium
module amplifier_sandh_3865bc65_Xampin (SIMPV,INP,IP,OUT,enable_amplifier,ok_amplifier,global_amplifier,
INN,
CELG,CELSUB);
input SIMPV;
input INP;
...
//Celera Confidential Do Not Copy amplifier_sandh_3865bc65_Xampout.v
//Celera:amplifier_sandh_3865bc65_Xampout
//Celera Confidential Symbol Generator
//Gain Adjust:openloop, Input Type:p, Bandwidth:medium
module amplifier_sandh_3865bc65_Xampout (SIMPV,INP,IP,OUT,enable_amplifier,ok_amplifier,global_amplifier,
INN,
CELG,CELSUB);
input SIMPV;
input INP;
...
//Celera Confidential Do Not Copy delayfixed_sandh_3865bc65_Xholddelay.v
//Celera:delayfixed_sandh_3865bc65_Xholddelay
//Celera Confidential Symbol Generator
//TYPE:fixed Egde:rise
module delayfixed_sandh_3865bc65_Xholddelay (CELV,i,o,
CELG,CELSUB);
input CELV;
input i;
output o;
...
//Celera Confidential Do Not Copy sandh_3865bc65
//Celera Confidential Symbol Generator
...
//Celera Confidential Do Not Copy ibiasmirror_sandh_3865bc65_IBIASMIRROR
ibiasmirror_sandh_3865bc65_IBIASMIRROR Xibias(
.SIMPV (SIMPV),
.IP (IP),
...
//,diesize,ibiasmirror_sandh_3865bc65_IBIASMIRROR

//Celera Confidential Do Not Copy amplifier_sandh_3865bc65_Xampin
amplifier_sandh_3865bc65_Xampin Xampin(
.SIMPV (SIMPV),
.INP (IN),
.IP (IPO0),
...
//,diesize,amplifier_sandh_3865bc65_Xampin
...
//Celera Confidential Do Not Copy amplifier_sandh_3865bc65_Xampout
amplifier_sandh_3865bc65_Xampout Xampout(
.SIMPV (SIMPV),
.INP (CAP),
.IP (IPO1),
.enable_amplifier (enable),
...
//,diesize,amplifier_sandh_3865bc65_Xampout
...
//Celera Confidential Do Not Copy delayfixed_sandh_3865bc65_Xholddelay
delayfixed_sandh_3865bc65_Xholddelay Xholddelay(
.CELV (SIMPV),
.i (hold),
.o (delay_hold),
.CELSUB (CELSUB),
...
//,diesize,delayfixed_sandh_3865bc65_Xholddelay
