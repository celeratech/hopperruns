...
//Celera Confidential Do Not Copy rlpp3000rpo13p3u2p0u
//Celera Confidential Symbol Generator
//poly 7.984314Kohm Resistor
module rlpp3000rpo13p3u2p0u (RP, RN, ISO);
inout RP;
inout RN;
input ISO;
endmodule

//Celera Confidential Do Not Copy resistor_54b8beaf
//Celera Confidential Symbol Generator
...
rlpp3000rpo8p8u2p0u XRA1_0(
.RP (RA0),
.RN (RA1),
.ISO (CELG)
);
rlpp3000rpo8p8u2p0u XRA1_1(
.RP (RA0),
.RN (RA1),
.ISO (CELG)
);
rlpp3000rpo8p8u2p0u XRA1_2(
.RP (RA0),
.RN (RA1),
.ISO (CELG)
);
rlpp3000rpo8p8u2p0u XRA1_3(
.RP (RA0),
.RN (RA1),
.ISO (CELG)
);
...
rlpp3000rpo13p3u2p0u XRA2_0(
.RP (RA1),
.RN (RA2),
.ISO (CELG)
);
rlpp3000rpo13p3u2p0u XRA2_1(
.RP (RA1),
.RN (RA2),
.ISO (CELG)
);
rlpp3000rpo13p3u2p0u XRA2_2(
.RP (RA1),
.RN (RA2),
.ISO (CELG)
);
rlpp3000rpo13p3u2p0u XRA2_3(
.RP (RA1),
.RN (RA2),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo13p3u2p0u

//Die Size Calculator rlpp3000rpo13p3u2p0u
//,diesize,rlpp3000rpo13p3u2p0u,4
