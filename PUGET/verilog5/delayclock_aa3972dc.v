...
//Celera Confidential Do Not Copy delayclock_aa3972dc
//TYPE:clock  EDGE:rise DFT:no ACC:no%
module delayclock_aa3972dc (in,CELV,out,clock,celeraporb,
CELG,CELSUB);
input CELV;
input in;
output out;
...
.in (in),
.out (out),
.del ({do,do,d1,d1,do,do,d1,do,do}),
.d0 (do),
.d1 (d1),
.G (CELG),
.SUB (CELSUB)
