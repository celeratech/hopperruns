...
//CORE:IPOTTpowerpath
//NAME:IPOTTpowerpath40Vinternal_da9dbc6b
//GENERATOR REVISION:0.5.2
//TYPE:n
//VMAX:6V

//Celera Confidential Do Not Copy IPOTTSTONEpowerpath40Vinternal
//Verilog HDL for "IPOTT", "IPOTTSTONEpowerpath40Vinternal" "functional"


module IPOTTSTONEpowerpath40Vinternal ( IP_1, REF, GATE, CELG, SIMPV, kelvin_OUT,
CELSUB, kelvin_CELG, enable_powerpath, trim_amplifierpositive, kelvin_IN, IP_2,
trim_amplifiernegative, global_powerpath, IN, ok_powerpath, on_powerpath, IP_3,
global_floatingreturn, PGND, trim_floatingreturn );
...
//Celera Confidential Do Not Copy ibiasmirror_IPOTTpowerpath40Vinternal_da9dbc6b_IBIASMIRROR.v
//Celera:ibiasmirror_IPOTTpowerpath40Vinternal_da9dbc6b_IBIASMIRROR
//Celera Confidential Symbol Generator
//OUTPUTS:3 VMAX:6V DFT:no
module ibiasmirror_IPOTTpowerpath40Vinternal_da9dbc6b_IBIASMIRROR (SIMPV,IP,enable_ibiasmirror,global_ibiasmirror,ok_ibiasmirror,IPO,
CELG,CELSUB);
input SIMPV;
input IP;
...
//Celera Confidential Do Not Copy IPOTTpowerpath40Vinternal_da9dbc6b
//Celera Confidential Symbol Generator
...
//Celera Confidential Do Not Copy Pin trim_floatingreturn
...
//Celera Confidential Do Not Copy IPOTTSTONEpowerpath40Vinternal
IPOTTSTONEpowerpath40Vinternal Xipott(
.IN (IN),
...
.PGND (PGND),
.IP_3 (IPO2),
.trim_floatingreturn (trim_powerpathfloatingreturn [3:0]),
.global_floatingreturn (global_powerpath),
.CELG (CELG),
.CELSUB (CELSUB)
);
//,diesize,IPOTTSTONEpowerpath40Vinternal
//Celera Confidential Do Not Copy ibiasmirror_IPOTTpowerpath40Vinternal_da9dbc6b_IBIASMIRROR
ibiasmirror_IPOTTpowerpath40Vinternal_da9dbc6b_IBIASMIRROR Xibiasmirror(
.SIMPV (SIMPV),
...
//,diesize,ibiasmirror_IPOTTpowerpath40Vinternal_da9dbc6b_IBIASMIRROR
