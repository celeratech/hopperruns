...
//Celera Confidential Do Not Copy clockrequest_183395c1
...
.rst_n (celeraporb),
.clkosc (clock),
.clkreq ({tl0,tl0,enable_clock5,enable_clock4,enable_clock3,enable_clock2,enable_clock1,enable_clock0}),
.clken (th0),
.force_osc_on (tl0),
.force_gclk_on (tl0),
.osc_en (noconn_oscen0),
.osc_stdby (noconn_standby0),
.gclk ({noconn_gclk7,noconn_gclk6,clock5,clock4,clock3,clock2,clock1,clock0}),
.th (th0),
.tl (tl0),
...
.clkdiv5 ({tl0,tl0,tl0,th0,tl0,tl0,tl0,tl0}),
