...
//Celera Confidential Do Not Copy delayclock_a8db9d9d
...
.CELV (CELV),
.i0 ({do,do,do,d1,d1,d1,d1,d1,d1}),
.i1 ({do,do,do,d1,do,d1,do,d1,d1}),
.i2 ({do,do,do,do,d1,do,d1,d1,d1}),
.i3 ({do,do,do,do,do,do,do,d1,d1}),
