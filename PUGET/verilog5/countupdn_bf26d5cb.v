...
//Celera Confidential Do Not Copy dmux2b_countupdn_bf26d5cb_Xdmux.v
//Celera:dmux2b_countupdn_bf26d5cb_Xdmux
...
dmux2b_countupdn_bf26d5cb_Xdmux Xdmux(
.CELV (CELV),
.s (enable_count),
.a ({start3,start2,start1,start0}),
.b ({q3,q2,q1,q0}),
.o ({dmux3,dmux2,dmux1,dmux0}),
.CELG (CELG),
.CELSUB (CELSUB)
);
//,diesize,dmux2b_countupdn_bf26d5cb_Xdmux
//Celera Confidential Do Not Copy STONEcounterupdnstartcode
