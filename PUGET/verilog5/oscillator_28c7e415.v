...
//Celera Confidential Do Not Copy comparatornoctlpins_oscillator_28c7e415_Xcomparator.v
//Celera:comparatornoctlpins_oscillator_28c7e415_Xcomparator
//Celera Confidential Symbol Generator
//Type p Hysteris Mode:fixed 20mV Hysteresis,Edge rising without deglitch
//Low IQ:no DFT:no
module comparatornoctlpins_oscillator_28c7e415_Xcomparator (enable_comparator,IP,out_comparator,INP_COMPARATOR,
...
module mim34_2f19p0x14p3 (CP,CN);
inout CP;
inout CN;
endmodule

//Celera Confidential Do Not Copy COSC Capacitor
module mim34_2f7p1x5p4 (CP,CN);
inout CP;
inout CN;
endmodule

//Celera Confidential Do Not Copy oscillator_28c7e415
//Celera Confidential Symbol Generator
...
//Celera Confidential Do Not Copy comparatornoctlpins_oscillator_28c7e415_Xcomparator
comparatornoctlpins_oscillator_28c7e415_Xcomparator Xcomparator(
.SIMPV (SIMPV),
...
//,diesize,comparatornoctlpins_oscillator_28c7e415_Xcomparator
//Celera Confidential Do Not Copy STONEnoconn
...
mim34_2f19p0x14p3 XCOSC0(
.CP (COSC),
.CN (celkelvin_GNDoscillator)
);

//Celera Confidential Do Not Copy CT0
mim34_2f7p1x5p4 XCT00(
.CP (CT0),
.CN (celkelvin_GNDoscillator)
);

//Celera Confidential Do Not Copy CT1_
mim34_2f7p1x5p4 XCT1_0(
.CP (CT1),
.CN (celkelvin_GNDoscillator)
);
mim34_2f7p1x5p4 XCT1_1(
.CP (CT1),
.CN (celkelvin_GNDoscillator)
);

//Celera Confidential Do Not Copy CT2_
mim34_2f7p1x5p4 XCT2_0(
.CP (CT2),
.CN (celkelvin_GNDoscillator)
);
mim34_2f7p1x5p4 XCT2_1(
.CP (CT2),
.CN (celkelvin_GNDoscillator)
);
mim34_2f7p1x5p4 XCT2_2(
.CP (CT2),
.CN (celkelvin_GNDoscillator)
);
mim34_2f7p1x5p4 XCT2_3(
.CP (CT2),
.CN (CT2_A)
);
mim34_2f7p1x5p4 XCT2_4(
.CP (CT2_A),
.CN (celkelvin_GNDoscillator)
);
