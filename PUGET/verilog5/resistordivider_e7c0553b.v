...
module rlpp3000rpo2p9u1p0u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule
...
//Celera Confidential Do Not Copy Resistor Divider
module rlpp3000rpo29p2u1p0u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule
...
//Celera Confidential Do Not Copy Resistor Divider
module rlpp3000rpo21p4u1p0u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule

//Celera Confidential Do Not Copy resistordivider_e7c0553b
...
rlpp3000rpo29p2u1p0u XRTAP1_0(
.RP (TAP1),
.RN (TAP0),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo29p2u1p0u

//Die Size Calculator rlpp3000rpo29p2u1p0u
//,diesize,rlpp3000rpo29p2u1p0u,1

//Celera Confidential Do Not Copy RTAP0
rlpp3000rpo2p9u1p0u XRTAP0_0(
.RP (TAP0),
.RN (BOTTOM),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo2p9u1p0u

//Die Size Calculator rlpp3000rpo2p9u1p0u
//,diesize,rlpp3000rpo2p9u1p0u,1
