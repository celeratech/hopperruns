...
//Celera Confidential Do Not Copy vbuffer_thermometer_7c641ed9_Xbuffer.v
//Celera:vbuffer_thermometer_7c641ed9_Xbuffer
//Celera Confidential Symbol Generator
//GAIN:1.0 Input:np with 1000.0K Impedance
module vbuffer_thermometer_7c641ed9_Xbuffer (SIMPV,IN,IP,OUT,enable_vbuffer,ok_vbuffer,global_vbuffer,
CELG,CELSUB);
input SIMPV;
input IN;
input IP;
...
//Celera Confidential Do Not Copy ibiasmirror_thermometer_7c641ed9_IBIASMIRROR.v
//Celera:ibiasmirror_thermometer_7c641ed9_IBIASMIRROR
//Celera Confidential Symbol Generator
//OUTPUTS:2 VMAX:6V DFT:no
module ibiasmirror_thermometer_7c641ed9_IBIASMIRROR (SIMPV,IP,enable_ibiasmirror,global_ibiasmirror,ok_ibiasmirror,IPO,
CELG,CELSUB);
input SIMPV;
input IP;
...
//Celera Confidential Do Not Copy resistor_thermometer_7c641ed9_Xbottom.v
//Celera:resistor_thermometer_7c641ed9_Xbottom
//Celera Confidential Symbol Generator
//RESISTOR:16.78KOhm TYPE:poly DFT:no
module resistor_thermometer_7c641ed9_Xbottom (RP,
CELG,
RN);
inout RP;
inout RN;
...
//Celera Confidential Do Not Copy resistor_thermometer_7c641ed9_Xtop.v
//Celera:resistor_thermometer_7c641ed9_Xtop
//Celera Confidential Symbol Generator
//RESISTOR:105.44KOhm TYPE:poly DFT:no
module resistor_thermometer_7c641ed9_Xtop (RP,
CELG,
RN);
inout RP;
inout RN;
...
//Celera Confidential Do Not Copy resistor_thermometer_7c641ed9_Xoffset.v
//Celera:resistor_thermometer_7c641ed9_Xoffset
//Celera Confidential Symbol Generator
...
//Celera Confidential Do Not Copy thermometer_7c641ed9
//Celera Confidential Symbol Generator
//THERMOMETER: with output Buffer
module thermometer_7c641ed9 (SIMPV,IP,OUT_THERMOMETER,ok_thermometer,celkelvin_GNDthermometer,
enable_thermometer,
...
//Celera Confidential Do Not Copy vbuffer_thermometer_7c641ed9_Xbuffer
vbuffer_thermometer_7c641ed9_Xbuffer Xbuffer(
.SIMPV (SIMPV),
.IN (THERMOMETER_OUT),
.IP (IPO1),
...
//,diesize,vbuffer_thermometer_7c641ed9_Xbuffer

//Celera Confidential Do Not Copy ibiasmirror_thermometer_7c641ed9_IBIASMIRROR
ibiasmirror_thermometer_7c641ed9_IBIASMIRROR Xibias(
.SIMPV (SIMPV),
.IP (IP),
...
//,diesize,ibiasmirror_thermometer_7c641ed9_IBIASMIRROR
...
//Celera Confidential Do Not Copy resistor_thermometer_7c641ed9_Xbottom
resistor_thermometer_7c641ed9_Xbottom Xbottom(
.RN (ROFFSET),
.RP (RBOTTOM),
.CELG (CELG)
);
//,diesize,resistor_thermometer_7c641ed9_Xbottom
//Celera Confidential Do Not Copy resistor_thermometer_7c641ed9_Xtop
resistor_thermometer_7c641ed9_Xtop Xtop(
.RN (RBOTTOM),
.RP (RTOP),
.CELG (CELG)
);
//,diesize,resistor_thermometer_7c641ed9_Xtop
//Celera Confidential Do Not Copy resistor_thermometer_7c641ed9_Xoffset
resistor_thermometer_7c641ed9_Xoffset Xoffset(
.CELV (SIMPV),
.CELSUB (CELSUB),
...
//,diesize,resistor_thermometer_7c641ed9_Xoffset
