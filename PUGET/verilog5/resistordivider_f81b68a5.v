...
module rlpp3000rpo8p0u1p0u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule
...
//Celera Confidential Do Not Copy Resistor Divider
module rlpp3000rpo37p1u1p0u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule
...
//Celera Confidential Do Not Copy Resistor Divider
module rlpp3000rpo46p5u1p0u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule

//Celera Confidential Do Not Copy resistordivider_f81b68a5
...
rlpp3000rpo46p5u1p0u XRTOP_0(
.RP (disconnect),
.RN (disconnectTAP1_1),
.ISO (CELG)
);
rlpp3000rpo46p5u1p0u XRTOP_1(
.RP (disconnectTAP1_1),
.RN (disconnectTAP1_2),
.ISO (CELG)
);
rlpp3000rpo46p5u1p0u XRTOP_2(
.RP (disconnectTAP1_2),
.RN (disconnectTAP1_3),
.ISO (CELG)
);
rlpp3000rpo46p5u1p0u XRTOP_3(
.RP (disconnectTAP1_3),
.RN (TAP1),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo46p5u1p0u

//Die Size Calculator rlpp3000rpo46p5u1p0u
//,diesize,rlpp3000rpo46p5u1p0u,4

//Celera Confidential Do Not Copy RTAP1
rlpp3000rpo37p1u1p0u XRTAP1_0(
.RP (TAP1),
.RN (TAP1TAP0_1),
.ISO (CELG)
);
rlpp3000rpo37p1u1p0u XRTAP1_1(
.RP (TAP1TAP0_1),
.RN (TAP0),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo37p1u1p0u

//Die Size Calculator rlpp3000rpo37p1u1p0u
//,diesize,rlpp3000rpo37p1u1p0u,2

//Celera Confidential Do Not Copy RTAP0
rlpp3000rpo8p0u1p0u XRTAP0_0(
.RP (TAP0),
.RN (BOTTOM),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo8p0u1p0u

//Die Size Calculator rlpp3000rpo8p0u1p0u
//,diesize,rlpp3000rpo8p0u1p0u,1
