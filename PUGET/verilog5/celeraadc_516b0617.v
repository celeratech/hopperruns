...
//ENABLE:pin
//DFT:no
//CLOCK FREQUENCY:3330KHz
//WAIT CALCULATE:no
//WAIT TIME:1*16 clocks
//DATASHEET:text
//Vmax:6V

//Celera Confidential Do Not Copy celeradacr2r_celeraadc_516b0617_Xdac.v
...
//Celera Confidential Do Not Copy comparatornoctlpins_celeraadc_516b0617_Xcomparator.v
//Celera:comparatornoctlpins_celeraadc_516b0617_Xcomparator
//Celera Confidential Symbol Generator
//Type np Hysteris Mode:fixed 0mV Hysteresis,Edge rising without deglitch
//Low IQ:no DFT:no
module comparatornoctlpins_celeraadc_516b0617_Xcomparator (enable_comparator,IP,out_comparator,INP_COMPARATOR,
...
//Celera Confidential Do Not Copy ibiasmirror_celeraadc_516b0617_IBIASMIRROR.v
//Celera:ibiasmirror_celeraadc_516b0617_IBIASMIRROR
//Celera Confidential Symbol Generator
//OUTPUTS:2 VMAX:6V DFT:no
module ibiasmirror_celeraadc_516b0617_IBIASMIRROR (SIMPV,IP,enable_ibiasmirror,global_ibiasmirror,ok_ibiasmirror,IPO,
CELG,CELSUB);
input SIMPV;
input IP;
...
//Celera Confidential Do Not Copy delay0_celeraadc_516b0617_Xdelay.v
//Celera:delay0_celeraadc_516b0617_Xdelay
//TYPE:fixed 20.0us EDGE:rise DFT:no ACC:no
module delay0_celeraadc_516b0617_Xdelay (i,CELV,o,
CELG,CELSUB);
input CELV;
input i;
output o;
...
//Celera Confidential Do Not Copy celeraadc_516b0617
//Celera Confidential Symbol Generator
...
//Celera Confidential Do Not Copy Pin ten_daccontrol
wire[7:0] ten_daccontrol;
...
//Celera Confidential Do Not Copy Pin trim_dacopositive
wire[6:0] trim_dacopositive;

//Celera Confidential Do Not Copy Pin trim_daconegative
...
celeradacr2r_celeraadc_516b0617_Xdac Xdac(
.SIMPV (SIMPV),
.enable_dac (enable),
...
.TAI_DAC (noconn_TAIADCDAC),
.DAC (ADCDAC),
.trim_dacopositive ({trim_dacopositive6,
trim_dacopositive5,
trim_dacopositive4,
trim_dacopositive3,
trim_dacopositive2,
trim_dacopositive1,
trim_dacopositive0}),
.trim_daconegative ({trim_daconegative6,
trim_daconegative5,
trim_daconegative4,
trim_daconegative3,
trim_daconegative2,
...
.DACREF (ADCREF),
.strobe_dac (startadc),
.ten_daccontrol ({a0,a0,a0,a0,a0,a0,a0,a0}),
.ten_daccontrolmsb ({a0,a0,a0,a0}),
.ok_dac (ok_dac),
.CELSUB (CELSUB),
.CELG (CELG)
);
//,diesize,celeradacr2r_celeraadc_516b0617_Xdac

//Celera Confidential Do Not Copy ibiasmirror_celeraadc_516b0617_IBIASMIRROR
ibiasmirror_celeraadc_516b0617_IBIASMIRROR Xibiasmirror(
.SIMPV (SIMPV),
...
//,diesize,ibiasmirror_celeraadc_516b0617_IBIASMIRROR

//Celera Confidential Do Not Copy comparatornoctlpins_celeraadc_516b0617_Xcomparator
comparatornoctlpins_celeraadc_516b0617_Xcomparator Xcomp(
.SIMPV (SIMPV),
...
//,diesize,comparatornoctlpins_celeraadc_516b0617_Xcomparator

//Celera Confidential Do Not Copy delay0_celeraadc_516b0617_Xdelay
delay0_celeraadc_516b0617_Xdelay Xdelay(
.CELV (SIMPV),
.i (enable),
.o (enabledelay),
.CELG (CELG),
...
//,diesize,delay0_celeraadc_516b0617_Xdelay
...
//Celera Confidential Do Not Copy WRAPPER7
WRAPPER7 Xbufferopositve(
.i (trim_adcdacopositive [6:0]),
.o6 (trim_dacopositive6),
.o5 (trim_dacopositive5),
.o4 (trim_dacopositive4),
.o3 (trim_dacopositive3),
.o2 (trim_dacopositive2),
.o1 (trim_dacopositive1),
.o0 (trim_dacopositive0)
);
//,diesize,WRAPPER7

//Celera Confidential Do Not Copy WRAPPER7
WRAPPER7 Xbufferonegative(
.i (trim_adcdaconegative [6:0]),
.o6 (trim_daconegative6),
.o5 (trim_daconegative5),
.o4 (trim_daconegative4),
.o3 (trim_daconegative3),
.o2 (trim_daconegative2),
.o1 (trim_daconegative1),
.o0 (trim_daconegative0)
);
//,diesize,WRAPPER7
