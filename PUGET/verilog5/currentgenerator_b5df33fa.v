...
//NAME:currentgenerator_b5df33fa
...
//Celera Confidential Do Not Copy STONEcascodemirrornmos50uhv30
//Verilog HDL for "Generate", "STONEcascodemirrornmos50uhv30" "functional"


module STONEcascodemirrornmos50uhv30 ( IN, CELV, OUT, SUB );
...
//Celera Confidential Do Not Copy currentgenerator_b5df33fa
//Celera Confidential Symbol Generator
//Number of outputs: 1, Max Vout: 30V, Accuracy: no%, Temperature Coefficient: zero, Temperature Gain: 3, DFT: no
//POLARITY0:sink, OUTPUT0:20
module currentgenerator_b5df33fa (SIMPV,CELSUB,enable_currentgenerator,global_currentgenerator,IP,ok_currentgenerator,
I0,
CELG);
input SIMPV;
input CELG;
...
//Celera Confidential Do Not Copy STONEcascodemirrornmos50uhv30
STONEcascodemirrornmos50uhv30 XcascodemirrorNMOS50UHV300(
.CELV (SIMPV),
.OUT (I0),
.IN (IN0),
.SUB (CELSUB)
);
//,diesize,STONEcascodemirrornmos50uhv30
//Celera Confidential Do Not Copy CASCODEnmos10u
