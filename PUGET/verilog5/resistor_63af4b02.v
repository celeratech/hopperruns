...
//Celera Confidential Do Not Copy resistor_63af4b02
//Celera Confidential Symbol Generator
...
rlpp3000rpo1p6u0p4u XRA0_1(
.RP (RP),
.RN (RA0),
.ISO (CELG)
);
rlpp3000rpo1p6u0p4u XRA0_2(
.RP (RP),
.RN (RA0),
.ISO (CELG)
);
rlpp3000rpo1p6u0p4u XRA0_3(
.RP (RP),
.RN (RA0),
.ISO (CELG)
);
...
rlpp3000rpo1p6u0p4u XRA3_0(
.RP (RA2),
.RN (RN),
.ISO (CELG)
);
rlpp3000rpo1p6u0p4u XRA3_1(
.RP (RA2),
.RN (RN),
.ISO (CELG)
);
rlpp3000rpo1p6u0p4u XRA3_2(
.RP (RA2),
.RN (RN),
.ISO (CELG)
);
rlpp3000rpo1p6u0p4u XRA3_3(
.RP (RA2),
.RN (RN),
.ISO (CELG)
);
