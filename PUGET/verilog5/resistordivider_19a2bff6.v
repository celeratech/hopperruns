...
module rlpp3000rpo6p4u1p0u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule
...
//Celera Confidential Do Not Copy Resistor Divider
module rlpp3000rpo20p4u1p0u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule

//Celera Confidential Do Not Copy resistordivider_19a2bff6
...
rlpp3000rpo20p4u1p0u XRTOP_0(
.RP (disconnect),
.RN (TAP0),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo20p4u1p0u

//Die Size Calculator rlpp3000rpo20p4u1p0u
//,diesize,rlpp3000rpo20p4u1p0u,1

//Celera Confidential Do Not Copy RTAP0
rlpp3000rpo6p4u1p0u XRTAP0_0(
.RP (TAP0),
.RN (BOTTOM),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo6p4u1p0u

//Die Size Calculator rlpp3000rpo6p4u1p0u
//,diesize,rlpp3000rpo6p4u1p0u,1
