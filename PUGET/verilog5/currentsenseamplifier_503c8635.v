...
//NAME:currentsenseamplifier_503c8635
...
//OUTPUT CURRENT:20uA
//OUTPUT VOLTAGE:1.56V
//OUTPUT TYPE:voltage
//ACCURACY:yes
//DFT:no

//Celera Confidential Do Not Copy resistor_currentsenseamplifier_503c8635_XinputRES.v
//Celera:resistor_currentsenseamplifier_503c8635_XinputRES
...
//Celera Confidential Do Not Copy resistor_currentsenseamplifier_503c8635_XoutputRES.v
//Celera:resistor_currentsenseamplifier_503c8635_XoutputRES
//Celera Confidential Symbol Generator
//RESISTOR:78.00KOhm TYPE:poly Accuracy:1.000% DFT:no
module resistor_currentsenseamplifier_503c8635_XoutputRES (RP,
CELV,
CELG,
CELSUB,
trim_resistor,
...
//Celera Confidential Do Not Copy currentsenseamplifier_503c8635
//Celera Confidential Symbol Generator
//Sense Type: resistor, Usage: p, Max Input Voltage: 30V, Max Sense Voltage: 0.07V
//Output Current: 20uA, Output Voltage: 1.56V, Output Type: voltage, Accuracy: yes, DFT: no
module currentsenseamplifier_503c8635 (enable_currentsenseamplifier,IP,ok_currentsenseamplifier,
...
resistor_currentsenseamplifier_503c8635_XinputRES XinputRES(
.RN (INNAMP),
.CELSUB (CELSUB),
.RP (INN_CURRENTSENSEAMPLIFIER)
);
//,diesize,resistor_currentsenseamplifier_503c8635_XinputRES
//Celera Confidential Do Not Copy resistor_currentsenseamplifier_503c8635_XoutputRES
resistor_currentsenseamplifier_503c8635_XoutputRES XoutputRES(
.CELV (CELV),
...
//,diesize,resistor_currentsenseamplifier_503c8635_XoutputRES
