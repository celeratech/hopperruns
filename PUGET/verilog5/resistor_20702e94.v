...
//Celera Confidential Do Not Copy resistor_20702e94
//Celera Confidential Symbol Generator
...
rlpp3000rpo2p8u0p4u XRA0_1(
.RP (RP),
.RN (RA0),
.ISO (CELG)
);
rlpp3000rpo2p8u0p4u XRA0_2(
.RP (RP),
.RN (RA0),
.ISO (CELG)
);
rlpp3000rpo2p8u0p4u XRA0_3(
.RP (RP),
.RN (RA0),
.ISO (CELG)
);
...
rlpp3000rpo1p8u0p4u XRA1_1(
.RP (RA0),
.RN (RA1),
.ISO (CELG)
);
rlpp3000rpo1p8u0p4u XRA1_2(
.RP (RA0),
.RN (RA1),
.ISO (CELG)
);
rlpp3000rpo1p8u0p4u XRA1_3(
.RP (RA0),
.RN (RA1),
.ISO (CELG)
);
...
rlpp3000rpo2p8u0p4u XRA2_0(
.RP (RA1),
.RN (RA2),
.ISO (CELG)
);
rlpp3000rpo2p8u0p4u XRA2_1(
.RP (RA1),
.RN (RA2),
.ISO (CELG)
);
rlpp3000rpo2p8u0p4u XRA2_2(
.RP (RA1),
.RN (RA2),
.ISO (CELG)
);
rlpp3000rpo2p8u0p4u XRA2_3(
.RP (RA1),
.RN (RA2),
.ISO (CELG)
);
