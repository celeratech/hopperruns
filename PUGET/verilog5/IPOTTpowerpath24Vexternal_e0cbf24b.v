...
//CORE:IPOTTpowerpath
//NAME:IPOTTpowerpath24Vexternal_e0cbf24b
//GENERATOR REVISION:0.5.2
//TYPE:n
//VMAX:6V

//Celera Confidential Do Not Copy IPOTTSTONEpowerpath24Vexternal
//Verilog HDL for "IPOTT", "IPOTTSTONEpowerpath24Vexternal" "functional"


module IPOTTSTONEpowerpath24Vexternal ( IP_1, REF, GATE, CELG, SIMPV, GATEV,
kelvin_OUT, CELSUB, kelvin_CELG, enable_powerpath, trim_amplifierpositive, kelvin_IN,
IP_2, trim_amplifiernegative, global_powerpath, IN, ok_powerpath, on_powerpath
);
...
//Celera Confidential Do Not Copy ibiasmirror_IPOTTpowerpath24Vexternal_e0cbf24b_IBIASMIRROR.v
//Celera:ibiasmirror_IPOTTpowerpath24Vexternal_e0cbf24b_IBIASMIRROR
//Celera Confidential Symbol Generator
//OUTPUTS:2 VMAX:6V DFT:no
module ibiasmirror_IPOTTpowerpath24Vexternal_e0cbf24b_IBIASMIRROR (SIMPV,IP,enable_ibiasmirror,global_ibiasmirror,ok_ibiasmirror,IPO,
CELG,CELSUB);
input SIMPV;
input IP;
...
//Celera Confidential Do Not Copy IPOTTpowerpath24Vexternal_e0cbf24b
//Celera Confidential Symbol Generator
...
//Celera Confidential Do Not Copy IPOTTSTONEpowerpath24Vexternal
IPOTTSTONEpowerpath24Vexternal Xipott(
.GATEV (GATEV),
.IN (IN),
...
.IP_1 (IPO0),
.IP_2 (IPO1),
.enable_powerpath (ok_ibiasmirror),
...
//,diesize,IPOTTSTONEpowerpath24Vexternal
//Celera Confidential Do Not Copy ibiasmirror_IPOTTpowerpath24Vexternal_e0cbf24b_IBIASMIRROR
ibiasmirror_IPOTTpowerpath24Vexternal_e0cbf24b_IBIASMIRROR Xibiasmirror(
.SIMPV (SIMPV),
...
//,diesize,ibiasmirror_IPOTTpowerpath24Vexternal_e0cbf24b_IBIASMIRROR
