...
//Celera Confidential Do Not Copy resistor_3bdd3d4d
//Celera Confidential Symbol Generator
...
rlpp3000rpo16p6u2p0u XRT2_0(
.RP (RT2),
.RN (RT1),
.ISO (CELG)
);
rlpp3000rpo16p6u2p0u XRT2_1(
.RP (RT2),
.RN (RT1),
.ISO (CELG)
);
rlpp3000rpo16p6u2p0u XRT2_2(
.RP (RT2),
.RN (RT1),
.ISO (CELG)
);
rlpp3000rpo16p6u2p0u XRT2_3(
.RP (RT2),
.RN (RT1),
.ISO (CELG)
);
...
rlpp3000rpo11p1u2p0u XRT1_0(
.RP (RT1),
.RN (RT0),
.ISO (CELG)
);
rlpp3000rpo11p1u2p0u XRT1_1(
.RP (RT1),
.RN (RT0),
.ISO (CELG)
);
rlpp3000rpo11p1u2p0u XRT1_2(
.RP (RT1),
.RN (RT0),
.ISO (CELG)
);
rlpp3000rpo11p1u2p0u XRT1_3(
.RP (RT1),
.RN (RT0),
.ISO (CELG)
);
...
rlpp3000rpo8p3u2p0u XRT0_0(
.RP (RT0),
.RN (RN),
.ISO (CELG)
);
rlpp3000rpo8p3u2p0u XRT0_1(
.RP (RT0),
.RN (RN),
.ISO (CELG)
);
rlpp3000rpo8p3u2p0u XRT0_2(
.RP (RT0),
.RN (RN),
.ISO (CELG)
);
rlpp3000rpo8p3u2p0u XRT0_3(
.RP (RT0),
.RN (RN),
.ISO (CELG)
);
rlpp3000rpo8p3u2p0u XRT0_4(
.RP (RT0),
.RN (RN),
.ISO (CELG)
);
rlpp3000rpo8p3u2p0u XRT0_5(
.RP (RT0),
.RN (RN),
.ISO (CELG)
);
