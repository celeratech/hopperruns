...
//Celera Confidential Do Not Copy logicshifter0L2H_fetdriver_f58be4d0_Xglobal.v
//Celera:logicshifter0L2H_fetdriver_f58be4d0_Xglobal
//Logic Level shifter with Enable
module logicshifter0L2H_fetdriver_f58be4d0_Xglobal (enable_logicshifter,
VIN1,VIN2,
in,
out,
CELG,CELSUB);
...
//Celera Confidential Do Not Copy fet_fetdriver_f58be4d0_Xnmos0.v
//Celera:fet_fetdriver_f58be4d0_Xnmos0
//Celera Confidential Symbol Generator
//power NMOS:Ron:400.000 Ohm
//Vgs 6V Vds 6V
//Kelvin:no

module fet_fetdriver_f58be4d0_Xnmos0 (GATE,SOURCE,DRAIN,NMOSiso6,SUB);
input GATE;
inout SOURCE;
inout DRAIN;
input SUB;
...
//Celera Confidential Do Not Copy fet_fetdriver_f58be4d0_Xpmos0.v
//Celera:fet_fetdriver_f58be4d0_Xpmos0
//Celera Confidential Symbol Generator
//power PMOS:Ron:400.000 Ohm
//Vgs 6V Vds 6V
//Kelvin:no

module fet_fetdriver_f58be4d0_Xpmos0 (GATE,DRAIN,
SOURCE,
PMOSiso6,SUB);
input GATE;
inout SOURCE;
...
//Celera Confidential Do Not Copy resistor_resistor_fetdriver_f58be4d0_Xpassive.v
//Celera:resistor_resistor_fetdriver_f58be4d0_Xpassive
//Celera Confidential Symbol Generator
//RESISTOR:2000.00KOhm TYPE:poly DFT:no
module resistor_resistor_fetdriver_f58be4d0_Xpassive (RP,
CELG,
RN);
inout RP;
inout RN;
...
//Celera Confidential Do Not Copy fetdriver_f58be4d0
//Celera Confidential Symbol Generator
...
//Celera Confidential Do Not Copy logicshifter0L2H_fetdriver_f58be4d0_Xglobal
logicshifter0L2H_fetdriver_f58be4d0_Xglobal Xglobal(
.VIN1 (CELV),
.VIN2 (HVPOS),
.in (global_fetdriver),
...
//,diesize,logicshifter0L2H_fetdriver_f58be4d0_Xglobal

//Celera Confidential Do Not Copy fet_fetdriver_f58be4d0_Xnmos0
fet_fetdriver_f58be4d0_Xnmos0 Xpowernmos0(
.GATE (ndrive0),
.SOURCE (HVNEG),
.DRAIN (GATE),
.NMOSiso6 (HVPOS),
...
//,diesize,fet_fetdriver_f58be4d0_Xnmos0
...
//Celera Confidential Do Not Copy fet_fetdriver_f58be4d0_Xpmos0
fet_fetdriver_f58be4d0_Xpmos0 Xpowerpmos0(
.GATE (pdrive0),
.SOURCE (HVPOS),
.DRAIN (GATE),
.SUB (CELSUB),
...
//,diesize,fet_fetdriver_f58be4d0_Xpmos0
...
//Celera Confidential Do Not Copy resistor_resistor_fetdriver_f58be4d0_Xpassive
resistor_resistor_fetdriver_f58be4d0_Xpassive Xpassive(
.RP (GATE),
.RN (HVNEG),
.CELG (HVNEG)
);
//,diesize,resistor_resistor_fetdriver_f58be4d0_Xpassive
