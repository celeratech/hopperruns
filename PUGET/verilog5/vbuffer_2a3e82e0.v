...
//Celera Confidential Do Not Copy resistordivider_vbuffer_2a3e82e0_Xrfb.v
//Celera:resistordivider_vbuffer_2a3e82e0_Xrfb
...
//Celera Confidential Do Not Copy vbuffer_2a3e82e0
//Celera Confidential Symbol Generator
...
.CELV (SIMPV),
.ISP (ISP),
.trim_vbufferneg ({a0,a0,a0,trimn3,trimn2,trimn1,trimn0}),
.trim_vbufferpos ({a0,a0,a0,trimp3,trimp2,trimp1,trimp0}),
.IN (IN),
.IDPP (IDPP),
.IDNP (IDNP),
.OUTS (TAP0),
...
resistordivider_vbuffer_2a3e82e0_Xrfb Xrfbo(
.TOP (OUT),
.TAP0 (TAP0),
.BOTTOM (GNDSENSE),
.CELG (CELG)
);
//,diesize,resistordivider_vbuffer_2a3e82e0_Xrfb
//Celera Confidential Do Not Copy WRAPPER4
WRAPPER4 XwrapPositive(
.i (trim_vbuffer_positive [3:0]),
.o0 (trimp0),
.o1 (trimp1),
.o2 (trimp2),
.o3 (trimp3)
...
//,diesize,WRAPPER4
//Celera Confidential Do Not Copy WRAPPER4
WRAPPER4 XwrapNegative(
.i (trim_vbuffer_negative [3:0]),
.o0 (trimn0),
.o1 (trimn1),
.o2 (trimn2),
.o3 (trimn3)
