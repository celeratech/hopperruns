...
//Celera:clamp_4e0636a1
//Celera Confidential Symbol Generator
//CLAMP:high 2.800V with  0.050mA Max shunt
module clamp_4e0636a1 (SIMPV,enable_clamp,global_clamp,IP,CELREF,IN,SHUNT,
CELG,CELSUB);
input SIMPV;
input enable_clamp;
input global_clamp;
...
//Celera:currentgenerator_3072c3e9
//Celera Confidential Symbol Generator
...
module currentgenerator_3072c3e9 (SIMPV,CELSUB,enable_currentgenerator,global_currentgenerator,IP,ok_currentgenerator,
I0,
...
.tdo(tdo),
.ten({noconn_dft_hex0x39_ten_7,ten_taext_currentgenerator_Xcurrentgenerator1,ten_currentgenerator_Xcurrentgenerator1,ten_tai_p500nref_Xcurrentgenerator1,ten_tai_n500nref_Xcurrentgenerator1,ten_tai_p50nref_Xcurrentgenerator1,ten_tai_p5uref_Xcurrentgenerator1,ten_tai_n5uref_Xcurrentgenerator1}),
.tma({a0,a0,a1,a1,a1,a0,a0,a1}),
.tmi(tmi[4:0])
);

currentgenerator_3072c3e9 Xcurrentgenerator1 (
.I0(net_167),
.IP(IP_4b9a0f83),
.CELG(CELG59462),
.SIMPV(SIMPV),
