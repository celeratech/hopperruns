...
//,diesize,rlpp3000rpo95p6u0p8u,5
...
//Die Size Calculator rlpp3000rpo95p6u0p8u
//,diesize,rlpp3000rpo95p6u0p8u,4
...
//,diesize,rlpp3000rpo1p0u0p4u,16
...
rlpp3000rpo1p0u0p4u XRT2_0(
.RP (RREF2),
.RN (RREF3),
.ISO (CELG)
);
rlpp3000rpo1p0u0p4u XRT2_1(
.RP (RREF2),
.RN (RREF3),
.ISO (CELG)
);
rlpp3000rpo1p0u0p4u XRT2_2(
.RP (RREF2),
.RN (RREF3),
.ISO (CELG)
);
rlpp3000rpo1p0u0p4u XRT2_3(
.RP (RREF2),
.RN (RREF3),
.ISO (CELG)
);
...
rlpp3000rpo1p0u0p4u XRT3_0(
.RP (RREF3),
.RN (RREF4),
.ISO (CELG)
);
rlpp3000rpo1p0u0p4u XRT3_1(
.RP (RREF3),
.RN (RREF4),
.ISO (CELG)
);
...
rlpp3000rpo1p0u0p4u XRT5_0(
.RP (RREF5),
.RN (RREF5BGS_1),
.ISO (CELG)
);
rlpp3000rpo1p0u0p4u XRT5_1(
.RP (RREF5BGS_1),
.RN (BGS),
.ISO (CELG)
);
