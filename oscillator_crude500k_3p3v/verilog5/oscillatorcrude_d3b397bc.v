...
module mim34_2f23p9x19p2 (CP,CN);
inout CP;
inout CN;
endmodule
...
//Celera Confidential Do Not Copy oscillatorcrude_d3b397bc
//Celera Confidential Symbol Generator
//VMAX:globalV,Crude:500.000KHz
module oscillatorcrude_d3b397bc (SIMPV,ok_oscillator,osc,global_oscillator,
enable_oscillator,
IP,
CELG,SENSE_G,CELSUB);
input SIMPV;
...
mim34_2f23p9x19p2 XCAPon_0(
.CP (CR),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CAPoff_
mim34_2f23p9x19p2 XCAPoff_0(
.CP (CL),
.CN (SENSE_G)
);
