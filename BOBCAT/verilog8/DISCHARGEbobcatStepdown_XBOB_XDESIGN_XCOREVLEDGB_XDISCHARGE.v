// ------------------------ Module Definitions -----------
module MUDdischargeLATCH6V_XBOB_XDESIGN_XCOREVLEDGB_XDISCHARGE_XU2 (tmi,MUDV,enable,CELG59462,CELV96848,force_OUT,sense_OUT,CELSUB40948,done_discharge,senseCELG38473,IP_XBOB_XDESIGN_XCOREVLEDGB_XDISCHARGE_XU2_XU3_XU2,register_DISCHARGE_XBOB_XDESIGN_XCOREVLEDGB_XDISCHARGE_XU2_XU3_XU3);
  input [4:0] tmi;
  input  MUDV;
  input  enable;
  input  CELG59462;
...
// ------------------------ Networks ---------------------
MUDdischargeLATCH6V_XBOB_XDESIGN_XCOREVLEDGB_XDISCHARGE_XU2 XU2 (
.tmi(tmi[4:0]),
.MUDV(MUDV),
.enable(net_21),
.CELG59462(CELG59462),
...
MUDdischargeATEyes_XBOB_XDESIGN_XCOREVLEDGB_XDISCHARGE_XU4 XU4 (
.tdo(tdo),
.tmi(tmi[4:0]),
.enable(net_21),
.CELG59462(CELG59462),
