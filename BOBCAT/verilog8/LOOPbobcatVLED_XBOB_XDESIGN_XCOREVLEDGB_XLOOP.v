...
module STEPDOWNalgorithmCONTROL1p3_DYES_XBOB_XDESIGN_XCOREVLEDGB_XLOOP_XCONTROL (tdo,tmi,porb,clock,botstate,topstate,CELG59462,CELV96848,go_driver,ok_driver,botswipeak,topswipeak,CELSUB40948,botswzcross,enable_control,freeze_control,switch_control,fault_controller);
  inout  tdo;
  inout [4:0] tmi;
  input  porb;
  input  clock;
...
module FEEDBACKbobcatVLED_XBOB_XDESIGN_XCOREVLEDGB_XLOOP_XFEEDBACK (FBI,tdo,tmi,CELG59462,CELV96848,sense_OUT,CELSUB40948,kelvin_MUDG,ok_feedback,enable_feedback,register_OUTPUT_XBOB_XDESIGN_XCOREVLEDGB_XLOOP_XFEEDBACK_XU1_XU5);
  inout  FBI;
  inout  tdo;
  inout [4:0] tmi;
  input  CELG59462;
...
// ------------------------ Networks ---------------------
DRIVERateBobcat1A_XBOB_XDESIGN_XCOREVLEDGB_XLOOP_XATE XATE (
.go(net_97),
.tdo(tdo),
.tmi(tmi[4:0]),
.clock(net_99),
...
STEPDOWNalgorithmCONTROL1p3_DYES_XBOB_XDESIGN_XCOREVLEDGB_XLOOP_XCONTROL XCONTROL (
.tdo(tdo),
.tmi(tmi[4:0]),
.porb(porb),
.clock(net_99),
...
MUDdriverSdBobcat1A_XBOB_XDESIGN_XCOREVLEDGB_XLOOP_XDRIVER XDRIVER (
.SW(SW),
.tdo(tdo),
.tmi(tmi[4:0]),
.MUDV(MUDV),
...
FEEDBACKbobcatVLED_XBOB_XDESIGN_XCOREVLEDGB_XLOOP_XFEEDBACK XFEEDBACK (
.FBI(FB_REGULATION),
.tdo(tdo),
.tmi(tmi[4:0]),
.CELG59462(CELG59462),
...
REGULATIONbobcatVLEDfixedfreq_XBOB_XDESIGN_XCOREVLEDGB_XLOOP_XREGULATION XREGULATION (
.TAO(TAO),
.tdo(tdo),
.tmi(tmi[4:0]),
.MUDV(MUDV),
