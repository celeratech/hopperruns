...
//CORE:oscillator
//NAME:oscillator_XBOB_XSERVICE_XOSCILLATOR_XU1
//GENERATOR REVISION:0.5.1
//TYPE:external
//EXT FREQ:3000KHz@50KOhm
//INT FREQ OPTION:no
//DUTY CYCLE:90%
//IREPLICA:1
//VMAX:6
...
//Celera Confidential Do Not Copy comparatornoctlpins_oscillator_XBOB_XSERVICE_XOSCILLATOR_XU1_Xcomparator.v
//Celera:comparatornoctlpins_oscillator_XBOB_XSERVICE_XOSCILLATOR_XU1_Xcomparator
//Celera Confidential Symbol Generator
//Type p Hysteris Mode:fixed 20mV Hysteresis,Edge rising without deglitch
//Low IQ:no DFT:no
module comparatornoctlpins_oscillator_XBOB_XSERVICE_XOSCILLATOR_XU1_Xcomparator (enable_comparator,IP,out_comparator,INP_COMPARATOR,
...
//Celera Confidential Do Not Copy oscillator_XBOB_XSERVICE_XOSCILLATOR_XU1
//Celera Confidential Symbol Generator
//VMAX:6External :3000KHz with 50KOhm
module oscillator_XBOB_XSERVICE_XOSCILLATOR_XU1 (SIMPV,IP,REF,fault_oscillator,ok_oscillator,osc,global_oscillator,
RF,
...
//,diesize,STONEoscillatorRFbufferGAIN
//Celera Confidential Do Not Copy STONEoscillatorRFbufferGAIN
STONEoscillatorRFbufferGAIN Xbuffergain6(
.CELV (SIMPV),
.GATE (GATE),
.IEXT (IRFi),
.SUB (CELSUB)
...
//,diesize,STONEoscillatorRFbufferGAIN
//Celera Confidential Do Not Copy STONEoscillatorRFbufferGAIN
STONEoscillatorRFbufferGAIN Xbuffergain7(
.CELV (SIMPV),
.GATE (GATE),
.IEXT (IRFi),
.SUB (CELSUB)
...
//,diesize,STONEoscillatorRFbufferGAIN
//Celera Confidential Do Not Copy STONEoscillatorRFbufferGAIN
STONEoscillatorRFbufferGAIN Xbuffergain8(
.CELV (SIMPV),
.GATE (GATE),
.IEXT (IRFi),
.SUB (CELSUB)
...
//,diesize,STONEoscillatorRFbufferGAIN
//Celera Confidential Do Not Copy STONEoscillatorRFbufferGAIN
STONEoscillatorRFbufferGAIN Xbuffergain9(
.CELV (SIMPV),
.GATE (GATE),
.IEXT (IRFi),
.SUB (CELSUB)
...
//,diesize,STONEoscillatorRFbufferGAIN
//Celera Confidential Do Not Copy STONEoscillatorRFbufferGAIN
STONEoscillatorRFbufferGAIN Xbuffergain10(
.CELV (SIMPV),
.GATE (GATE),
.IEXT (IRFi),
.SUB (CELSUB)
...
//,diesize,STONEoscillatorRFbufferGAIN
//Celera Confidential Do Not Copy STONEoscillatorRFbufferGAIN
STONEoscillatorRFbufferGAIN Xbuffergain11(
.CELV (SIMPV),
.GATE (GATE),
.IEXT (IRFi),
.SUB (CELSUB)
...
//Celera Confidential Do Not Copy comparatornoctlpins_oscillator_XBOB_XSERVICE_XOSCILLATOR_XU1_Xcomparator
comparatornoctlpins_oscillator_XBOB_XSERVICE_XOSCILLATOR_XU1_Xcomparator Xcomparator(
.SIMPV (SIMPV),
.INN_COMPARATOR (RF),
.INP_COMPARATOR (COSC),
.IP (IPO2),
...
//,diesize,comparatornoctlpins_oscillator_XBOB_XSERVICE_XOSCILLATOR_XU1_Xcomparator
//Celera Confidential Do Not Copy STONEoscillatorRFcontrol2
