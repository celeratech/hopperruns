...
//CELL SOURCE:delay2
//NAME:delay0_delayfixed_XBOB_XFAULTMANAGER_XU7_delay0
...
module mim34_2f26p1x19p1 (CP,CN);
inout CP;
inout CN;
endmodule
...
//Celera Confidential Do Not Copy delay0_delayfixed_XBOB_XFAULTMANAGER_XU7_delay0
//TYPE:fixed 10ms EDGE:rise DFT:no ACC:no%
module delay0_delayfixed_XBOB_XFAULTMANAGER_XU7_delay0 (i,CELV,o,
CELG,CELSUB);
input CELV;
input i;
output o;
...
mim34_2f26p1x19p1 XC0_0(
.CP (C0),
.CN (CELG)
);
mim34_2f26p1x19p1 XC0_1(
.CP (C0),
.CN (CELG)
);

//Celera Confidential Do Not Copy //DieSize,mim34_2f26p1x19p1

//Die Size Calculator mim34_2f26p1x19p1
//,diesize,mim34_2f26p1x19p1,2
