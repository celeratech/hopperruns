...
//NAME:resistordivider_vbuffer_XBOB_XDESIGN_XCOREVDDR_XFAULT_XU1_XU4_Xrfb
...
rlpp3000rpo11p3u1p0u XRTOP_1(
.RP (disconnectTAP0_1),
.RN (disconnectTAP0_2),
.ISO (CELG)
);
rlpp3000rpo11p3u1p0u XRTOP_2(
.RP (disconnectTAP0_2),
.RN (disconnectTAP0_3),
.ISO (CELG)
);
rlpp3000rpo11p3u1p0u XRTOP_3(
.RP (disconnectTAP0_3),
.RN (disconnectTAP0_4),
.ISO (CELG)
);
rlpp3000rpo11p3u1p0u XRTOP_4(
.RP (disconnectTAP0_4),
.RN (disconnectTAP0_5),
.ISO (CELG)
);
rlpp3000rpo11p3u1p0u XRTOP_5(
.RP (disconnectTAP0_5),
.RN (disconnectTAP0_6),
.ISO (CELG)
);
rlpp3000rpo11p3u1p0u XRTOP_6(
.RP (disconnectTAP0_6),
.RN (disconnectTAP0_7),
.ISO (CELG)
);
rlpp3000rpo11p3u1p0u XRTOP_7(
.RP (disconnectTAP0_7),
.RN (disconnectTAP0_8),
.ISO (CELG)
);
rlpp3000rpo11p3u1p0u XRTOP_8(
.RP (disconnectTAP0_8),
.RN (disconnectTAP0_9),
.ISO (CELG)
);
rlpp3000rpo11p3u1p0u XRTOP_9(
.RP (disconnectTAP0_9),
.RN (disconnectTAP0_10),
.ISO (CELG)
);
rlpp3000rpo11p3u1p0u XRTOP_10(
...
//,diesize,rlpp3000rpo11p3u1p0u,11
...
//Die Size Calculator rlpp3000rpo11p3u1p0u
//,diesize,rlpp3000rpo11p3u1p0u,14
