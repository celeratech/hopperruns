...
//CELL SOURCE:delay0
//NAME:delay0_delayfixed_XBOB_XDESIGN_XCOREVDDR_XSOFTSTART_XU8_XU18_delay0
...
module mim34_2f20p5x14p4 (CP,CN);
inout CP;
inout CN;
endmodule
...
mim34_2f20p5x14p4 XC0_0(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x14p4 XC0_1(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x14p4 XC0_2(
.CP (C0),
.CN (CELG)
);

//Celera Confidential Do Not Copy //DieSize,mim34_2f20p5x14p4

//Die Size Calculator mim34_2f20p5x14p4
//,diesize,mim34_2f20p5x14p4,3
