...
//NAME:voltage2current_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XREGULATION_XU7_XU3
...
//Celera Confidential Do Not Copy voltage2current_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XREGULATION_XU7_XU3
//Celera Confidential Symbol Generator
//Gain: 10, Direction: source, Iout Clamp: no
//DFT:no, Accuracy: no, Input Stage Type: p
module voltage2current_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XREGULATION_XU7_XU3 (CELV,SUB,enable_voltage2current,IP,ok_voltage2current,IOUT,VIN,ten,
CELG);
input CELV;
input SUB;
