...
//NAME:currentlimitfet_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU2
//GENERATOR REVISION:0.4.7
//SENSE ELEMENT:fet
//FET CONNECTION:pmos_drain
//USAGE:highside
...
//Celera Confidential Do Not Copy STONEcurrentlimitcompinn
//Verilog HDL for "Generate", "STONEcurrentlimitcompinn" "functional"


module STONEcurrentlimitcompinn ( currentlimit, currentlimitlive, CELNEG, CELPOS,
...
//Celera Confidential Do Not Copy STONEcurrentlimithighsidepmos6vbuck_en
//Verilog HDL for "Generate", "STONEcurrentlimithighsidepmos6vbuck_en" "functional"


module STONEcurrentlimithighsidepmos6vbuck_en ( VREFS, en, CELG, CELNEG, CELPOS,
CELV, IREFTRIM, IREPLICA, SUB, VSENSE, currentlimit, enable_currentlimit, measure_currentlimit
);
...
//Celera Confidential Do Not Copy currentlimitfet_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU2
...
module currentlimitfet_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU2 (SIMPV,SUB,measure_currentlimit,VSENSE,IREPLICA,currentlimit,enable_currentlimit,
trim_currentlimit,
...
//Celera Confidential Do Not Copy STONEcurrentlimitcompinn
STONEcurrentlimitcompinn Xclcompinn(
.CELNEG (CELG),
.VREFS (VREFS),
...
//,diesize,STONEcurrentlimitcompinn
//Celera Confidential Do Not Copy STONEcurrentlimithighsidepmos6vbuck_en
STONEcurrentlimithighsidepmos6vbuck_en Xhigh_pmos_drain_en(
.CELNEG (CELG),
.CELV (SIMPV),
.VSENSE (VSENSE),
.CELPOS (SIMPV),
...
//,diesize,STONEcurrentlimithighsidepmos6vbuck_en
//Celera Confidential Do Not Copy STONEcurrentlimitdft
