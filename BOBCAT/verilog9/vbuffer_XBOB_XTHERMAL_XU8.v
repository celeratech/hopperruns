...
//CORE:vbuffer
//NAME:vbuffer_XBOB_XTHERMAL_XU8
...
//Celera Confidential Do Not Copy vbuffer_XBOB_XTHERMAL_XU8
//Celera Confidential Symbol Generator
//GAIN:1.0 Input:p with 1000K Impedance
module vbuffer_XBOB_XTHERMAL_XU8 (SIMPV,IN,IP,OUT,enable_vbuffer,ok_vbuffer,global_vbuffer,
CELG,CELSUB);
input SIMPV;
input IN;
input IP;
