...
module padopendrain_XBOB_XDESIGN_XCOREVLEDGB_XDISCHARGE_XU2_XU14 (CELV,input_padopendrain,PAD,CELG,SUB);
  inout  PAD;
  input  SUB;
  input  CELG;
  input  CELV;
...
// ------------------------ Networks ---------------------
MUDdischargeLATCHcore_XBOB_XDESIGN_XCOREVLEDGB_XDISCHARGE_XU2_XU3 XU3 (
.tmi(tmi[4:0]),
.MUDV(MUDV),
.enable(enable),
.sense_FB(sense_OUT),
...
padopendrain_XBOB_XDESIGN_XCOREVLEDGB_XDISCHARGE_XU2_XU14 XU14 (
.PAD(force_OUT),
.SUB(CELSUB40948),
.CELG(CELG59462),
.CELV(CELV96848),
