...
// ------------------------ Networks ---------------------
MUDdriverSdAteSyncBobcat_XBOB_XDESIGN_XCOREVDDL_XLOOP_XDRIVER_XATE XATE (
.tdo(tdo),
.tmi(tmi[4:0]),
.botstate(botstate),
.topstate(topstate),
...
MUDbbmBobcat1A_XBOB_XDESIGN_XCOREVDDL_XLOOP_XDRIVER_XBBM XBBM (
.tdo(tdo),
.tmi(tmi[4:0]),
.botswon(net_59),
.topswon(net_57),
...
MUDbotswnmosSdIlimBobcat0A2_XBOB_XDESIGN_XCOREVDDL_XLOOP_XDRIVER_XBOTSW XBOTSW (
.SW(SW),
.tdo(tdo),
.tmi(tmi[4:0]),
.MUDV(MUDV),
...
MUDtopswpmos5SdIrefBobcat0A2_XBOB_XDESIGN_XCOREVDDL_XLOOP_XDRIVER_XTOPSW XTOPSW (
.SW(SW),
.tdo(tdo),
.tmi(tmi[4:0]),
.MUDV(MUDV),
