// ------------------------ Module Definitions -----------
module vbuffer_XBOB_XDESIGN_XCOREVLEDR_XPOWERGOOD_XU11_XU8 (SIMPV,IN,IP,OUT,enable_vbuffer,ok_vbuffer,global_vbuffer,CELG,CELSUB);
  input  IN;
  input  IP;
  output  OUT;
  input  CELG;
...
module delayfixed_XBOB_XDESIGN_XCOREVLEDR_XPOWERGOOD_XU11_XU10 (CELV,i,o,CELG,CELSUB);
  input  i;
  output  o;
  input  CELG;
  input  CELV;
...
module resistordivider_XBOB_XDESIGN_XCOREVLEDR_XPOWERGOOD_XU11_XU30 (TOP,enable_resistordivider,global_resistordivider,CELV,CELSUB,TAP0,TAP1,TAP2,CELG,BOTTOM);
  inout  TOP;
  input  CELG;
  input  CELV;
  output  TAP0;
...
// ------------------------ Networks ---------------------
vbuffer_XBOB_XDESIGN_XCOREVLEDR_XPOWERGOOD_XU11_XU8 XU8 (
.IN(REF_POWERGOOD),
.IP(IP_XBOB_XDESIGN_XCOREVLEDR_XPOWERGOOD_XU11_XU8),
.OUT(ovr),
.CELG(CELG59462),
.SIMPV(MUDV),
.CELSUB(CELSUB40948),
...
delayfixed_XBOB_XDESIGN_XCOREVLEDR_XPOWERGOOD_XU11_XU10 XU10 (
.i(net_43),
.o(ready_buffer),
.CELG(CELG59462),
.CELV(CELV96848),
...
resistordivider_XBOB_XDESIGN_XCOREVLEDR_XPOWERGOOD_XU11_XU30 XU30 (
.TOP(ovr),
.CELG(CELG59462),
.CELV(CELV96848),
.TAP0(uvf),
...
.a({a1,a0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x95_ten_7,noconn_dft_hex0x95_ten_6,noconn_dft_hex0x95_ten_5,noconn_dft_hex0x95_ten_4,noconn_dft_hex0x95_ten_3,noconn_dft_hex0x95_ten_2,global_vbuffer_XU8,global_resistordivider_XU30}),
