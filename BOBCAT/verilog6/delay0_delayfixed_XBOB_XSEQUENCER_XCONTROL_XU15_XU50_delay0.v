...
//CELL SOURCE:delay2
//NAME:delay0_delayfixed_XBOB_XSEQUENCER_XCONTROL_XU15_XU50_delay0
...
//Celera Confidential Do Not Copy STONEdelaytimeDFFR4
//Verilog HDL for "Generate", "STONEdelaytimeDFFR4" "functional"


module STONEdelaytimeDFFR4 ( V, clk, endffr, G, o, SUB );
...
module mim34_2f24p2x17p6 (CP,CN);
inout CP;
inout CN;
endmodule
...
//Celera Confidential Do Not Copy delay0_delayfixed_XBOB_XSEQUENCER_XCONTROL_XU15_XU50_delay0
//TYPE:fixed 400us EDGE:rise DFT:no ACC:no%
module delay0_delayfixed_XBOB_XSEQUENCER_XCONTROL_XU15_XU50_delay0 (i,CELV,o,
CELG,CELSUB);
input CELV;
input i;
output o;
...
mim34_2f24p2x17p6 XC0_0(
.CP (C0),
.CN (CELG)
);
mim34_2f24p2x17p6 XC0_1(
.CP (C0),
.CN (CELG)
);
mim34_2f24p2x17p6 XC0_2(
.CP (C0),
.CN (CELG)
);

//Celera Confidential Do Not Copy //DieSize,mim34_2f24p2x17p6

//Die Size Calculator mim34_2f24p2x17p6
//,diesize,mim34_2f24p2x17p6,3
