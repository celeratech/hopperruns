...
//CELL SOURCE:delay0
//NAME:delay0_delayfixed_XBOB_XSEQUENCER_XCONTROL_XU83_XU1_delay0
...
module mim34_2f20p5x13p5 (CP,CN);
inout CP;
inout CN;
endmodule
...
mim34_2f20p5x13p5 XC0_0(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x13p5 XC0_1(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x13p5 XC0_2(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x13p5 XC0_3(
.CP (C0),
.CN (CELG)
);

//Celera Confidential Do Not Copy //DieSize,mim34_2f20p5x13p5

//Die Size Calculator mim34_2f20p5x13p5
//,diesize,mim34_2f20p5x13p5,4
