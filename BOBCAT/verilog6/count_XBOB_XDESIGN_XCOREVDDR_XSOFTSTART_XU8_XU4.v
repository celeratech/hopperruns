...
//CORE:count
//NAME:count_XBOB_XDESIGN_XCOREVDDR_XSOFTSTART_XU8_XU4
...
//Celera Confidential Do Not Copy count_XBOB_XDESIGN_XCOREVDDR_XSOFTSTART_XU8_XU4
//Celera Confidential Symbol Generator
//Type down Number of bits:6 Enable:pin Rollover:no Done:yes
//Down start:63 Down stop:0
module count_XBOB_XDESIGN_XCOREVDDR_XSOFTSTART_XU8_XU4 (CELV,global_count,clk,CELSUB,
q,
enable_count,
count_done,
CELG );
...
.counter_stopup ({a0,a0,a0,a0,a0,a0}),
.SUB (CELSUB),
.CELG (CELG)
);
...
.counter_direction (dir),
.counter_startdown ({a1,a1,a1,a1,a1,a1}),
.SUB (CELSUB),
.CELG (CELG)
);
