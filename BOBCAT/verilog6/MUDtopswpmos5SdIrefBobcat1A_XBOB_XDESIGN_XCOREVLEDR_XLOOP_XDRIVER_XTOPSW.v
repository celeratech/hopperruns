// ------------------------ Module Definitions -----------
module dbufdft_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28 (i,o,CELG,CELV,CELSUB,tdi_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28,ten_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28_dbuf0,ten_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28_dbuf1);
  input  i;
  output  o;
  input  CELG;
  input  CELV;
  input  CELSUB;
  output  tdi_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28;
  input  ten_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28_dbuf0;
  input  ten_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28_dbuf1;
endmodule

module currentlimitfet_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU2 (SIMPV,SUB,measure_currentlimit,VSENSE,IREPLICA,currentlimit,enable_currentlimit,trim_currentlimit,factory_currentlimit_blanking,IREF,ten_currentlimit,ten_taext_currentlimit,ten_measure_currentlimit,TAEXT_CURRENTLIMIT,tdi_currentlimit,tdi_currentlimitlive,ten_currentlimit_delay,CELG);
  input  SUB;
  input  CELG;
  input  IREF;
  input  SIMPV;
...
module fet_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU5 (GATE,DRAIN,SOURCE,SOURCEk,DRAINk,IREPLICA,PMOSiso6,SUB);
  input  SUB;
  input  GATE;
  inout  DRAIN;
  inout  DRAINk;
...
module delayfixed_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU11 (CELV,i,o,CELG,CELSUB);
  input  i;
  output  o;
  input  CELG;
  input  CELV;
...
module fetdriver_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU13 (HVPOS,enable_fetdriverhv,global_fetdriver,fetin,GATE,gate_status,factory_fetdriver_statusadjust,CELG,SIMPV,HVNEG,CELSUB);
  input  CELG;
  output  GATE;
  input  HVNEG;
  input  HVPOS;
...
module timingskew_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU16 (CELV,in,out,factory_timingskew,CELG,CELSUB);
  input  in;
  output  out;
  input  CELG;
  input  CELV;
...
module timingskew_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU17 (CELV,in,out,factory_timingskew,CELG,CELSUB);
  input  in;
  output  out;
  input  CELG;
  input  CELV;
...
module nand2_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU18 (CELV,CELG,i0,i1,o,SUB);
  output  o;
  input  i0;
  input  i1;
  input  SUB;
...
module inv_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU19 (CELV,CELG,i,o,SUB);
  input  i;
  output  o;
  input  SUB;
  input  CELG;
...
module inv_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU24 (CELV,CELG,i,o,SUB);
  input  i;
  output  o;
  input  SUB;
  input  CELG;
...
module inv_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU25 (CELV,CELG,i,o,SUB);
  input  i;
  output  o;
  input  SUB;
  input  CELG;
...
module nor2_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU26 (CELV,CELG,i0,i1,o,SUB);
  output  o;
  input  i0;
  input  i1;
  input  SUB;
...
module dff_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU27 (CELV,CELG,d,rb,ck,q,qb,SUB);
  input  d;
  output  q;
  input  ck;
  output  qb;
...
module inv_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU30 (CELV,CELG,i,o,SUB);
  input  i;
  output  o;
  input  SUB;
  input  CELG;
...
module inv_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU33 (CELV,CELG,i,o,SUB);
  input  i;
  output  o;
  input  SUB;
  input  CELG;
...
module dbuf_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU34 (CELV,CELG,i,o,SUB);
  input  i;
  output  o;
  input  SUB;
  input  CELG;
...
module nand2_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU35 (CELV,CELG,i0,i1,o,SUB);
  output  o;
  input  i0;
  input  i1;
  input  SUB;
...
module nand2_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU36 (CELV,CELG,i0,i1,o,SUB);
  output  o;
  input  i0;
  input  i1;
  input  SUB;
...
module tie_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU39 (CELV,CELG,a1,SUB);
  output  a1;
  input  SUB;
  input  CELG;
  input  CELV;
...
// ------------------------ Module Verilog ---------------
module MUDtopswpmos5SdIrefBobcat1A_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW (SW, tdo, tmi, MUDV, PMUDG, PMUDV, TAEXT, enable, topswon, CELG59462, CELV96848, ok_driver, topswipeak, CELSUB40948, IREF_DRIVER, topswstatus);
inout  SW;
inout  tdo;
inout [4:0] tmi;
input  MUDV;
...
// ------------------------ Networks ---------------------
dbufdft_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28 XU28 (
.i(net_40),
.o(topswipeak),
.CELG(CELG59462),
.CELV(CELV96848),
.CELSUB(CELSUB40948),
.tdi_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28(tdi_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28_XU28),
.ten_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28_dbuf0(ten_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28_dbuf0_XU28),
.ten_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28_dbuf1(ten_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28_dbuf1_XU28)
);

currentlimitfet_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU2 XU2 (
.SUB(CELSUB40948),
.CELG(CELG59462),
.IREF(IREF_DRIVER),
.SIMPV(MUDV),
...
fet_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU5 XU5 (
.SUB(CELSUB40948),
.GATE(net_44),
.DRAIN(SW),
.DRAINk(net_72),
...
delayfixed_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU11 XU11 (
.i(enable),
.o(ok_driver),
.CELG(CELG59462),
.CELV(CELV96848),
...
fetdriver_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU13 XU13 (
.CELG(CELG59462),
.GATE(net_44),
.HVNEG(PMUDG),
.HVPOS(PMUDV),
...
timingskew_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU16 XU16 (
.in(topswstatus),
.out(net_52),
.CELG(CELG59462),
.CELV(CELV96848),
...
timingskew_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU17 XU17 (
.in(net_52),
.out(net_53),
.CELG(CELG59462),
.CELV(CELV96848),
...
nand2_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU18 XU18 (
.o(net_49),
.i0(net_34),
.i1(net_52),
.SUB(CELSUB40948),
...
inv_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU19 XU19 (
.i(net_49),
.o(net_50),
.SUB(CELSUB40948),
.CELG(CELG59462),
...
inv_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU24 XU24 (
.i(net_46),
.o(net_41),
.SUB(CELSUB40948),
.CELG(CELG59462),
...
inv_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU25 XU25 (
.i(net_32),
.o(net_38),
.SUB(CELSUB40948),
.CELG(CELG59462),
...
nor2_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU26 XU26 (
.o(net_39),
.i0(net_31),
.i1(net_41),
.SUB(CELSUB40948),
...
dff_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU27 XU27 (
.d(net_47),
.q(net_48),
.ck(net_29),
.qb(net_51),
...
inv_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU30 XU30 (
.i(net_39),
.o(net_40),
.SUB(CELSUB40948),
.CELG(CELG59462),
...
inv_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU33 XU33 (
.i(net_30),
.o(net_31),
.SUB(CELSUB40948),
.CELG(CELG59462),
...
dbuf_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU34 XU34 (
.i(net_50),
.o(net_29),
.SUB(CELSUB40948),
.CELG(CELG59462),
...
nand2_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU35 XU35 (
.o(net_46),
.i0(net_38),
.i1(net_48),
.SUB(CELSUB40948),
...
nand2_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU36 XU36 (
.o(net_30),
.i0(net_29),
.i1(net_32),
.SUB(CELSUB40948),
...
tie_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU39 XU39 (
.a1(net_47),
.SUB(CELSUB40948),
.CELG(CELG59462),
.CELV(CELV96848)
...
.a({a1,a0}),
.SUB(CELSUB40948),
.tdi({a0,a0,a0,a0,a0,tdi_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28_XU28,tdi_currentlimitlive_XU2,tdi_currentlimit_XU2}),
.tdo(tdo),
...
.a({b1,b0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x8e_ten_7,noconn_dft_hex0x8e_ten_6,noconn_dft_hex0x8e_ten_5,noconn_dft_hex0x8e_ten_4,noconn_dft_hex0x8e_ten_3,ten_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28_dbuf1_XU28,ten_XBOB_XDESIGN_XCOREVLEDR_XLOOP_XDRIVER_XTOPSW_XU28_dbuf0_XU28,ten_measure_currentlimit_XU2}),
.tma({b1,b0,b0,b0,b1,b1,b1,b0}),
.tmi(tmi[4:0])
);
