...
//CELL SOURCE:delay2
//NAME:delay0_delayfixed_XBOB_XDESIGN_XCOREVLEDGB_XCONVERTER_XU7_delay0
...
//Celera Confidential Do Not Copy STONEdelaytimeDFFR7
//Verilog HDL for "Generate", "STONEdelaytimeDFFR7" "functional"


module STONEdelaytimeDFFR7 ( V, clk, endffr, G, o, SUB );
...
module mim34_2f28p4x20p7 (CP,CN);
inout CP;
inout CN;
endmodule
...
mim34_2f28p4x20p7 XC0_0(
.CP (C0),
.CN (CELG)
);
mim34_2f28p4x20p7 XC0_1(
.CP (C0),
.CN (CELG)
);

//Celera Confidential Do Not Copy //DieSize,mim34_2f28p4x20p7

//Die Size Calculator mim34_2f28p4x20p7
//,diesize,mim34_2f28p4x20p7,2
