...
module oscillatorcrude_f0d3ab2b (SIMPV,ok_oscillator,osc,global_oscillator,enable_oscillator,IP,CELG,SENSE_G,CELSUB);
  input  IP;
  output  osc;
  input  CELG;
  input  SIMPV;
...
oscillatorcrude_f0d3ab2b XIXosccrude (
.IP(IP_27552fb4_XIXosccrude),
.osc(osc),
.CELG(CELG59462),
.SIMPV(SIMPV),
.CELSUB(CELSUB40948),
.SENSE_G(SENSE_G_27552fb4),
