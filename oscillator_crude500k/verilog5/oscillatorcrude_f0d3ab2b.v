...
module mim34_2f18p6x14p9 (CP,CN);
inout CP;
inout CN;
endmodule
...
//Celera Confidential Do Not Copy oscillatorcrude_f0d3ab2b
//Celera Confidential Symbol Generator
//VMAX:globalV,Crude:500.000KHz
module oscillatorcrude_f0d3ab2b (SIMPV,ok_oscillator,osc,global_oscillator,
enable_oscillator,
IP,
CELG,SENSE_G,CELSUB);
input SIMPV;
...
mim34_2f18p6x14p9 XCAPon_0(
.CP (CR),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CAPoff_
mim34_2f18p6x14p9 XCAPoff_0(
.CP (CL),
.CN (SENSE_G)
);
