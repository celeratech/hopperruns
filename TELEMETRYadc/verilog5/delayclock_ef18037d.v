...
//Celera Confidential Do Not Copy delayclock_ef18037d
//TYPE:clock  EDGE:rise DFT:no ACC:no%
module delayclock_ef18037d (in,CELV,out,clock,celeraporb,
CELG,CELSUB);
input CELV;
input in;
output out;
...
.d0 (do),
.d1 (d1),
.del ({do,do,do,d1,do,do,do,d1,do}),
.G (CELG),
.SUB (CELSUB)
);
