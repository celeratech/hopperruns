...
//NAME:paddigitaloutput_2802354f
...
//Celera Confidential Do Not Copy fet_paddigitaloutput_2802354f_Xnmos.v
//Celera:fet_paddigitaloutput_2802354f_Xnmos
//Celera Confidential Symbol Generator
//power NMOS:Ron:10.000 Ohm
//Vgs 6V Vds 6V
//Kelvin:no

module fet_paddigitaloutput_2802354f_Xnmos (GATE,SOURCE,DRAIN,NMOSiso6,SUB);
input GATE;
inout SOURCE;
inout DRAIN;
input NMOSiso6;
...
//Celera Confidential Do Not Copy fet_paddigitaloutput_2802354f_Xpmos.v
//Celera:fet_paddigitaloutput_2802354f_Xpmos
//Celera Confidential Symbol Generator
//power PMOS:Ron:10.000 Ohm
//Vgs 6V Vds 6V
//Kelvin:no

module fet_paddigitaloutput_2802354f_Xpmos (GATE,SOURCE,DRAIN,SUB);
input GATE;
inout SOURCE;
inout DRAIN;
input SUB;
...
//Celera Confidential Do Not Copy paddigitaloutput_2802354f
//Celera Confidential Symbol Generator
//PAD Digital Output Ron:10 Ohm 
module paddigitaloutput_2802354f (SIMPV,in,out,
...
//Celera Confidential Do Not Copy fet_paddigitaloutput_2802354f_Xnmos
fet_paddigitaloutput_2802354f_Xnmos Xnmos0(
.DRAIN (out),
.GATE (ngate),
.SOURCE (CELG),
.NMOSiso6 (SIMPV),
...
//,diesize,fet_paddigitaloutput_2802354f_Xnmos

//Celera Confidential Do Not Copy fet_paddigitaloutput_2802354f_Xpmos
fet_paddigitaloutput_2802354f_Xpmos Xpmos0(
.DRAIN (out),
.GATE (pgate),
.SOURCE (SIMPV),
.SUB (CELSUB)
);
//,diesize,fet_paddigitaloutput_2802354f_Xpmos
