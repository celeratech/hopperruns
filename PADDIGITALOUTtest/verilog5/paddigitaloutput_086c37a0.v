...
//NAME:paddigitaloutput_086c37a0
...
//Celera Confidential Do Not Copy fet_paddigitaloutput_086c37a0_Xnmos.v
//Celera:fet_paddigitaloutput_086c37a0_Xnmos
//Celera Confidential Symbol Generator
//power NMOS:Ron:500.000 Ohm
//Vgs 6V Vds 6V
//Kelvin:no

module fet_paddigitaloutput_086c37a0_Xnmos (GATE,SOURCE,DRAIN,NMOSiso6,SUB);
input GATE;
inout SOURCE;
inout DRAIN;
input NMOSiso6;
...
//Celera Confidential Do Not Copy fet_paddigitaloutput_086c37a0_Xpmos.v
//Celera:fet_paddigitaloutput_086c37a0_Xpmos
//Celera Confidential Symbol Generator
//power PMOS:Ron:500.000 Ohm
//Vgs 6V Vds 6V
//Kelvin:no

module fet_paddigitaloutput_086c37a0_Xpmos (GATE,SOURCE,DRAIN,SUB);
input GATE;
inout SOURCE;
inout DRAIN;
input SUB;
...
//Celera Confidential Do Not Copy paddigitaloutput_086c37a0
//Celera Confidential Symbol Generator
//PAD Digital Output Ron:500 Ohm 
module paddigitaloutput_086c37a0 (SIMPV,in,out,
...
//Celera Confidential Do Not Copy fet_paddigitaloutput_086c37a0_Xnmos
fet_paddigitaloutput_086c37a0_Xnmos Xnmos0(
.DRAIN (out),
.GATE (ngate),
.SOURCE (CELG),
.NMOSiso6 (SIMPV),
...
//,diesize,fet_paddigitaloutput_086c37a0_Xnmos

//Celera Confidential Do Not Copy fet_paddigitaloutput_086c37a0_Xpmos
fet_paddigitaloutput_086c37a0_Xpmos Xpmos0(
.DRAIN (out),
.GATE (pgate),
.SOURCE (SIMPV),
.SUB (CELSUB)
);
//,diesize,fet_paddigitaloutput_086c37a0_Xpmos
