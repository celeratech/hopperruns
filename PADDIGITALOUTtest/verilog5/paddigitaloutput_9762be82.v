...
//NAME:paddigitaloutput_9762be82
...
//Celera Confidential Do Not Copy delay0_paddigitaloutput_9762be82_Xflagfilter.v
//Celera:delay0_paddigitaloutput_9762be82_Xflagfilter
//TYPE:fixed 1us EDGE:both DFT:no ACC:no
module delay0_paddigitaloutput_9762be82_Xflagfilter (i,CELV,o,
CELG,CELSUB);
input CELV;
input i;
output o;
...
//Celera Confidential Do Not Copy fet_paddigitaloutput_9762be82_Xnmos.v
//Celera:fet_paddigitaloutput_9762be82_Xnmos
//Celera Confidential Symbol Generator
//power NMOS:Ron:10.000 Ohm
//Vgs 6V Vds 6V
//Kelvin:no

module fet_paddigitaloutput_9762be82_Xnmos (GATE,SOURCE,DRAIN,NMOSiso6,SUB);
input GATE;
inout SOURCE;
inout DRAIN;
input NMOSiso6;
...
//Celera Confidential Do Not Copy fet_paddigitaloutput_9762be82_Xpmos.v
//Celera:fet_paddigitaloutput_9762be82_Xpmos
//Celera Confidential Symbol Generator
//power PMOS:Ron:10.000 Ohm
//Vgs 6V Vds 6V
//Kelvin:no

module fet_paddigitaloutput_9762be82_Xpmos (GATE,SOURCE,DRAIN,SUB);
input GATE;
inout SOURCE;
inout DRAIN;
input SUB;
...
//Celera Confidential Do Not Copy paddigitaloutput_9762be82
//Celera Confidential Symbol Generator
...
//Celera Confidential Do Not Copy delay0_paddigitaloutput_9762be82_Xflagfilter
delay0_paddigitaloutput_9762be82_Xflagfilter Xfilter(
.CELV (SIMPV),
.i (fault),
...
//,diesize,delay0_paddigitaloutput_9762be82_Xflagfilter
...
//Celera Confidential Do Not Copy fet_paddigitaloutput_9762be82_Xnmos
fet_paddigitaloutput_9762be82_Xnmos Xnmos0(
.DRAIN (out),
.GATE (ngate),
.SOURCE (CELG),
.NMOSiso6 (SIMPV),
...
//,diesize,fet_paddigitaloutput_9762be82_Xnmos

//Celera Confidential Do Not Copy fet_paddigitaloutput_9762be82_Xpmos
fet_paddigitaloutput_9762be82_Xpmos Xpmos0(
.DRAIN (out),
.GATE (pgate),
.SOURCE (SIMPV),
.SUB (CELSUB)
);
//,diesize,fet_paddigitaloutput_9762be82_Xpmos
