...
//Celera Confidential Do Not Copy Resistor Divider
module rlpp3000rpo26p4u0p4u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule
...
//Celera Confidential Do Not Copy Resistor Divider
module rlpp3000rpo22p0u0p4u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule
...
rlpp3000rpo22p0u0p4u XRTOP_0(
.RP (disconnect),
.RN (disconnectTAP1_1),
.ISO (CELG)
);
rlpp3000rpo22p0u0p4u XRTOP_1(
.RP (disconnectTAP1_1),
.RN (disconnectTAP1_2),
.ISO (CELG)
);
rlpp3000rpo22p0u0p4u XRTOP_2(
.RP (disconnectTAP1_2),
.RN (TAP1),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo22p0u0p4u

//Die Size Calculator rlpp3000rpo22p0u0p4u
//,diesize,rlpp3000rpo22p0u0p4u,3

//Celera Confidential Do Not Copy RTAP1
rlpp3000rpo26p4u0p4u XRTAP1_0(
.RP (TAP1),
.RN (TAP0),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo26p4u0p4u

//Die Size Calculator rlpp3000rpo26p4u0p4u
//,diesize,rlpp3000rpo26p4u0p4u,1

//Celera Confidential Do Not Copy RTAP0
rlpp3000rpo2p9u0p4u XRTAP0_0(
.RP (TAP0),
.RN (BOTTOM),
.ISO (CELG)
);
