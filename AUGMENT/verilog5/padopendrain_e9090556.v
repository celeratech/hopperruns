...
//Celera Confidential Do Not Copy fet_padopendrain_e9090556_Xnmos.v
//Celera:fet_padopendrain_e9090556_Xnmos
//Celera Confidential Symbol Generator
//power NMOS:Ron:100.000 Ohm
//Vgs 6V Vds 6V
//Kelvin:no

module fet_padopendrain_e9090556_Xnmos (GATE,SOURCE,DRAIN,NMOSiso6,SUB);
input GATE;
inout SOURCE;
inout DRAIN;
input NMOSiso6;
...
//Celera Confidential Do Not Copy padopendrain_e9090556
//Celera Confidential Symbol Generator
//Open Drain output PAD with 6V, Ron 100 Ohms
//No Glitch filter
//ON Logic:noninvert polarity
//DFT:no TESTMODE:no RETURN PIN:no
module padopendrain_e9090556 (CELV, input_padopendrain, PAD, 
CELG, SUB ); 
input CELV;
...
wire[1:0] a;
//Celera Confidential Do Not Copy fet_padopendrain_e9090556_Xnmos
fet_padopendrain_e9090556_Xnmos Xjohnpowernmos(
.NMOSiso6 (PAD),
.SUB (SUB),
.GATE  (control),
.DRAIN (PAD),
...
//,diesize,fet_padopendrain_e9090556_Xnmos
