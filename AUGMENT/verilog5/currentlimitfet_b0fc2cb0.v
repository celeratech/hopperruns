...
//Celera Confidential Do Not Copy currentgenerator_currentlimitfet_b0fc2cb0_Xcg.v
//Celera:currentgenerator_currentlimitfet_b0fc2cb0_Xcg
...
module currentgenerator_currentlimitfet_b0fc2cb0_Xcg (SIMPV,CELSUB,enable_currentgenerator,global_currentgenerator,IP,ok_currentgenerator,
I0,
CELG);
input SIMPV;
input CELG;
...
//Celera Confidential Do Not Copy logicshifter0L2H_currentlimitfet_b0fc2cb0_Xlogice.v
//Celera:logicshifter0L2H_currentlimitfet_b0fc2cb0_Xlogice
//Logic Level shifter with Enable
module logicshifter0L2H_currentlimitfet_b0fc2cb0_Xlogice (enable_logicshifter,
VIN1,VIN2,
in,
out,
CELG,CELSUB);
...
//Celera Confidential Do Not Copy levelshifter0L2H_currentlimitfet_b0fc2cb0_Xmeasure.v
//Celera:levelshifter0L2H_currentlimitfet_b0fc2cb0_Xmeasure
//Celera Confidential Symbol Generator
//Direction: low2high, Maximum high voltage:12V 
//Enable pin:yes
module levelshifter0L2H_currentlimitfet_b0fc2cb0_Xmeasure (SIMPV,CELSUB,HVPOS,HVNEG,in,out,
enable_levelshifter,
CELG);
input SIMPV;
input CELG;
...
//Celera Confidential Do Not Copy levelshifter0H2L_currentlimitfet_b0fc2cb0_Xoutput.v
//Celera:levelshifter0H2L_currentlimitfet_b0fc2cb0_Xoutput
//Celera Confidential Symbol Generator
//Direction: high2low, Maximum high voltage:12V 
//Enable pin:yes
module levelshifter0H2L_currentlimitfet_b0fc2cb0_Xoutput (SIMPV,CELSUB,HVPOS,HVNEG,in,out,
enable_levelshifter,
CELG);
input SIMPV;
input CELG;
...
//Celera Confidential Do Not Copy currentlimitfet_b0fc2cb0
//Celera Confidential Symbol Generator
//Sense element: fet, Fet connection: nmos_source, Usage: lowside, Max sense voltage: 6V, Reference current: internal
//Latch blanking: no,Latch blanking time: 2ns, DFT: partial, Trim: yes
module currentlimitfet_b0fc2cb0 (CELPOS,CELSUB,measure_currentlimit,VSENSE,IREPLICA,enable_currentlimit,
trim_currentlimit,
IP,
global_currentlimit,
currentlimit_lv,
...
//,diesize,STONEnoconn
//Celera Confidential Do Not Copy currentgenerator_currentlimitfet_b0fc2cb0_Xcg
currentgenerator_currentlimitfet_b0fc2cb0_Xcg Xcg(
.SIMPV (CELPOS),
...
//,diesize,currentgenerator_currentlimitfet_b0fc2cb0_Xcg
//Celera Confidential Do Not Copy STONEcurrentlimitreftrim10u
