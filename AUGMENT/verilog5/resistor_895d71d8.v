...
//Celera Confidential Do Not Copy rlpp3000rpo45p1u0p4u
//Celera Confidential Symbol Generator
//poly 1898.260864Kohm Resistor
module rlpp3000rpo45p1u0p4u (RP, RN, ISO);
inout RP;
inout RN;
input ISO;
endmodule

//Celera Confidential Do Not Copy rlpp3000rpo45p6u0p4u
//Celera Confidential Symbol Generator
//poly 2399.121094Kohm Resistor
module rlpp3000rpo45p6u0p4u (RP, RN, ISO);
inout RP;
inout RN;
input ISO;
endmodule

//Celera Confidential Do Not Copy resistor_895d71d8
//Celera Confidential Symbol Generator
//RESISTOR:100.00KOhm TYPE:poly Adjust:100.00Kohm DFT:no
module resistor_895d71d8 (RP,
CELV,
CELG,
CELSUB,
adjust_resistor,
...
rlpp3000rpo33p2u0p4u XRA3_0(
.RP (RA2),
.RN (RA2RA3_1),
.ISO (CELG)
);
rlpp3000rpo33p2u0p4u XRA3_1(
.RP (RA2RA3_1),
.RN (RA3),
.ISO (CELG)
);
...
rlpp3000rpo42p7u0p4u XRA4_0(
.RP (RA3),
.RN (RA3RA4_1),
.ISO (CELG)
);
rlpp3000rpo42p7u0p4u XRA4_1(
.RP (RA3RA4_1),
.RN (RA4),
.ISO (CELG)
);
...
//,diesize,rlpp3000rpo42p7u0p4u,2
...
rlpp3000rpo44p3u0p4u XRA5_0(
.RP (RA4),
.RN (RA4RA5_1),
.ISO (CELG)
);
rlpp3000rpo44p3u0p4u XRA5_1(
.RP (RA4RA5_1),
.RN (RA4RA5_2),
.ISO (CELG)
);
rlpp3000rpo44p3u0p4u XRA5_2(
.RP (RA4RA5_2),
.RN (RA5),
.ISO (CELG)
);
...
//,diesize,rlpp3000rpo44p3u0p4u,3
...
rlpp3000rpo45p1u0p4u XRA6_0(
.RP (RA5),
.RN (RA5RA6_1),
.ISO (CELG)
);
rlpp3000rpo45p1u0p4u XRA6_1(
.RP (RA5RA6_1),
.RN (RA5RA6_2),
.ISO (CELG)
);
rlpp3000rpo45p1u0p4u XRA6_2(
.RP (RA5RA6_2),
.RN (RA5RA6_3),
.ISO (CELG)
);
rlpp3000rpo45p1u0p4u XRA6_3(
.RP (RA5RA6_3),
.RN (RA6),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo45p1u0p4u

//Die Size Calculator rlpp3000rpo45p1u0p4u
//,diesize,rlpp3000rpo45p1u0p4u,4
...
rlpp3000rpo45p6u0p4u XRA7_0(
.RP (RA6),
.RN (RA6RN_1),
.ISO (CELG)
);
rlpp3000rpo45p6u0p4u XRA7_1(
.RP (RA6RN_1),
.RN (RA6RN_2),
.ISO (CELG)
);
rlpp3000rpo45p6u0p4u XRA7_2(
.RP (RA6RN_2),
.RN (RA6RN_3),
.ISO (CELG)
);
rlpp3000rpo45p6u0p4u XRA7_3(
.RP (RA6RN_3),
.RN (RA6RN_4),
.ISO (CELG)
);
rlpp3000rpo45p6u0p4u XRA7_4(
.RP (RA6RN_4),
.RN (RN),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo45p6u0p4u

//Die Size Calculator rlpp3000rpo45p6u0p4u
//,diesize,rlpp3000rpo45p6u0p4u,5
