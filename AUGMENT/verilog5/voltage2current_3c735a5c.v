...
module rlpp3000rpo11p1u2p0u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule
...
//Celera Confidential Do Not Copy voltage2current_3c735a5c
//Celera Confidential Symbol Generator
//Gain: 50, Direction: source, Iout Clamp: no
//DFT:no, Accuracy: no, Input Stage Type: p
module voltage2current_3c735a5c (SIMPV,CELSUB,enable_voltage2current,IP,ok_voltage2current,IOUT,VIN,global_voltage2current,
CELG);
input SIMPV;
input CELSUB;
