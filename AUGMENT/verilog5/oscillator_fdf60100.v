...
//CORE:oscillator
//NAME:oscillator_fdf60100
//GENERATOR REVISION:0.5.7
//TYPE:external
//EXT FREQ:1000KHz@40KOhm
//INT FREQ OPTION:no
//DUTY CYCLE:90%
//IREPLICA:1
//VMAX:6
...
//Celera Confidential Do Not Copy comparatornoctlpins_oscillator_fdf60100_Xcomparator.v
//Celera:comparatornoctlpins_oscillator_fdf60100_Xcomparator
//Celera Confidential Symbol Generator
//Type p Hysteris Mode:fixed 20mV Hysteresis,Edge rising without deglitch
//Low IQ:no DFT:no
module comparatornoctlpins_oscillator_fdf60100_Xcomparator (enable_comparator,IP,out_comparator,INP_COMPARATOR,
...
module mim34_2f21p9x16p5 (CP,CN);
inout CP;
inout CN;
endmodule

//Celera Confidential Do Not Copy COSC Capacitor
module mim34_2f8p2x6p2 (CP,CN);
inout CP;
inout CN;
endmodule

//Celera Confidential Do Not Copy oscillator_fdf60100
//Celera Confidential Symbol Generator
//VMAX:6External :1000KHz with 40KOhm
module oscillator_fdf60100 (SIMPV,IP,CELREF,fault_oscillator,ok_oscillator,osc,global_oscillator,
...
//Celera Confidential Do Not Copy comparatornoctlpins_oscillator_fdf60100_Xcomparator
comparatornoctlpins_oscillator_fdf60100_Xcomparator Xcomparator(
.SIMPV (SIMPV),
...
//,diesize,comparatornoctlpins_oscillator_fdf60100_Xcomparator
//Celera Confidential Do Not Copy STONEnoconn
...
mim34_2f21p9x16p5 XCOSC0(
.CP (COSC),
.CN (celkelvin_GNDoscillator)
);

//Celera Confidential Do Not Copy CT0
mim34_2f8p2x6p2 XCT00(
.CP (CT0),
.CN (celkelvin_GNDoscillator)
);

//Celera Confidential Do Not Copy CT1_
mim34_2f8p2x6p2 XCT1_0(
.CP (CT1),
.CN (celkelvin_GNDoscillator)
);
mim34_2f8p2x6p2 XCT1_1(
.CP (CT1),
.CN (celkelvin_GNDoscillator)
);

//Celera Confidential Do Not Copy CT2_
mim34_2f8p2x6p2 XCT2_0(
.CP (CT2),
.CN (celkelvin_GNDoscillator)
);
mim34_2f8p2x6p2 XCT2_1(
.CP (CT2),
.CN (celkelvin_GNDoscillator)
);
mim34_2f8p2x6p2 XCT2_2(
.CP (CT2),
.CN (celkelvin_GNDoscillator)
);
mim34_2f8p2x6p2 XCT2_3(
.CP (CT2),
.CN (CT2_A)
);
mim34_2f8p2x6p2 XCT2_4(
.CP (CT2_A),
.CN (celkelvin_GNDoscillator)
);
