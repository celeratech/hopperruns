...
//CELL SOURCE:delay2
//NAME:delay0_delayfixed_2d143fb1_delay0
...
//Celera Confidential Do Not Copy STONEdelaytimeDFFR8
//Verilog HDL for "Generate", "STONEdelaytimeDFFR8" "functional"


module STONEdelaytimeDFFR8 ( V, clk, endffr, G, o, SUB );
...
module mim34_2f28p2x20p7 (CP,CN);
inout CP;
inout CN;
endmodule
...
//Celera Confidential Do Not Copy delay0_delayfixed_2d143fb1_delay0
//TYPE:fixed 200ms EDGE:rise DFT:no ACC:no%
module delay0_delayfixed_2d143fb1_delay0 (i,CELV,o,
CELG,CELSUB);
input CELV;
input i;
output o;
...
mim34_2f28p2x20p7 XC0_0(
.CP (C0),
.CN (CELG)
);
mim34_2f28p2x20p7 XC0_1(
.CP (C0),
.CN (CELG)
);

//Celera Confidential Do Not Copy //DieSize,mim34_2f28p2x20p7

//Die Size Calculator mim34_2f28p2x20p7
//,diesize,mim34_2f28p2x20p7,2
