...
//Celera Confidential Do Not Copy subtractor_1b556602
//Celera Confidential Symbol Generator
//SUBTRACTOR
module subtractor_1b556602 (CELV,load,o,a,b,CELPORB,CELG,CELSUB);
input CELV;
output [3:0] o;
input load;
input [3:0] a;
...
.V (CELV),
.AmB ({ nco_15,nco_14,nco_13,nco_12,nco_11,nco_10,nco_9,nco_8,nco_7,nco_6,nco_5,nco_4,o [3:0]}),
.dataA ({d0,d0,d0,d0,d0,d0,d0,d0,d0,d0,d0,d0,a [3:0]}),
.dataB ({d0,d0,d0,d0,d0,d0,d0,d0,d0,d0,d0,d0,b [3:0]}),
.load (loadBUF),
.rstb (CELPORB),
.G (CELG),
.SUB (CELSUB)
