...
//Celera Confidential Do Not Copy subtractor_ab31a15b
...
.V (CELV),
.AmB ({ nco_15,nco_14,nco_13,nco_12,nco_11,nco_10,nco_9,nco_8,o [7:0]}),
.dataA ({d0,d0,d0,d0,d0,d0,d0,d0,a [7:0]}),
.dataB ({d0,d0,d0,d0,d0,d0,d0,d0,b [7:0]}),
.load (loadBUF),
.rstb (CELPORB),
.G (CELG),
.SUB (CELSUB)
