...
// ------------------------ Module Verilog ---------------
module WALTZ (EN, FB, IN, SW, BST, GND, PIN, POK, VCC, BIAS, FSET, PGND, PVCC, SYNC, CELOUTA, CELOUTD);
inout  EN;
inout  FB;
inout  IN;
inout  SW;
