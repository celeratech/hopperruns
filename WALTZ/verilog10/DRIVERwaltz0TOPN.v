...
module fetdriver_3dacaa61 (CELG,CELV,GATE,HVNEG,HVPOS,fetin,CELSUB,gate_status,gate_status_vin,enable_fetdriver,global_fetdriver);
  input  CELG;
  input  CELV;
  output  GATE;
  input  HVNEG;
...
.CELG(CELG59462),
.CELV(CELV96848),
.GATE(TBD_XWALTZ_XceleraCORE_XDRIVER_XTOPSW_Xfetdriver1_GATE),
.HVNEG(TBD_XWALTZ_XceleraCORE_XDRIVER_XTOPSW_Xfetdriver1_HVNEG),
.HVPOS(TBD_XWALTZ_XceleraCORE_XDRIVER_XTOPSW_Xfetdriver1_HVPOS),
.fetin(TBD_XWALTZ_XceleraCORE_XDRIVER_XTOPSW_Xfetdriver1_fetin),
.CELSUB(CELSUB40948),
.gate_status(TBD_XWALTZ_XceleraCORE_XDRIVER_XTOPSW_Xfetdriver1_gate_status),
.gate_status_vin(TBD_XWALTZ_XceleraCORE_XDRIVER_XTOPSW_Xfetdriver1_gate_status_vin),
.enable_fetdriver(TBD_XWALTZ_XceleraCORE_XDRIVER_XTOPSW_Xfetdriver1_enable_fetdriver),
