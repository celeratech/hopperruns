...
module oscillatorcrude_fa6711d9 (IP,osc,CELG,SIMPV,CELSUB,SENSE_G,ok_oscillator,enable_oscillator,global_oscillator);
  input  IP;
  output  osc;
  input  CELG;
  input  SIMPV;
...
oscillatorcrude_fa6711d9 Xoscillator1 (
