...
module dff_fc5ad7bd (d,q,ck,qb,rb,SUB,CELG,CELV);
  input  d;
  output  q;
  input  ck;
  output  qb;
...
module celeradacr2r_1a2f4f0b (i,DAC,CELG,CELV,CELSUB,DACREF,ok_dac,GNDSENSE,enable_dac,global_dac,strobe_dac);
  input [7:0] i;
  output  DAC;
  input  CELG;
  input  CELV;
...
module oscillatorcrude_c20ae7fc (IP,osc,CELG,SIMPV,CELSUB,SENSE_G,ok_oscillator,enable_oscillator,global_oscillator);
  input  IP;
  output  osc;
  input  CELG;
  input  SIMPV;
