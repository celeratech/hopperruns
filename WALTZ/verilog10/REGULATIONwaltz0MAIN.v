...
module vbuffer_f6979412 (IN,IP,OUT,CELG,SIMPV,CELSUB,ok_vbuffer,enable_vbuffer,global_vbuffer,trim_vbuffer_negative,trim_vbuffer_positive);
  input  IN;
  input  IP;
  output  OUT;
  input  CELG;
...
module comparatornoctlpins_85de8a51 (IP,CELG,SIMPV,CELSUB,ok_comparator,INN_COMPARATOR,INP_COMPARATOR,out_comparator,enable_comparator,global_comparator,factory_hyst_comparator);
  input  IP;
  input  CELG;
  input  SIMPV;
  input  CELSUB;
...
module resistor_4c753838 (RN,RP,CELG);
  inout  RN;
  inout  RP;
  input  CELG;
endmodule
...
.trim_gm_negative({trim_gm_negative_9015e2a4_6,trim_gm_negative_9015e2a4_5,trim_gm_negative_9015e2a4_4,trim_gm_negative_9015e2a4_3,trim_gm_negative_9015e2a4_2,trim_gm_negative_9015e2a4_1,trim_gm_negative_9015e2a4_0}),
.trim_gm_positive({trim_gm_positive_9015e2a4_6,trim_gm_positive_9015e2a4_5,trim_gm_positive_9015e2a4_4,trim_gm_positive_9015e2a4_3,trim_gm_positive_9015e2a4_2,trim_gm_positive_9015e2a4_1,trim_gm_positive_9015e2a4_0})
);
...
comparatornoctlpins_85de8a51 XU10 (
.IP(IP_5c7dff44_XU10),
.CELG(CELG59462),
.SIMPV(MUDV),
.CELSUB(CELSUB40948),
...
.SUB(CELSUB40948),
.tmi(tmi[4:0]),
.drm0({noconn_drm48_drm0_7,trim_gm_negative_9015e2a4_6,trim_gm_negative_9015e2a4_5,trim_gm_negative_9015e2a4_4,trim_gm_negative_9015e2a4_3,trim_gm_negative_9015e2a4_2,trim_gm_negative_9015e2a4_1,trim_gm_negative_9015e2a4_0}),
.drm1({noconn_drm48_drm1_7,trim_gm_positive_9015e2a4_6,trim_gm_positive_9015e2a4_5,trim_gm_positive_9015e2a4_4,trim_gm_positive_9015e2a4_3,trim_gm_positive_9015e2a4_2,trim_gm_positive_9015e2a4_1,trim_gm_positive_9015e2a4_0}),
.drm2({noconn_drm48_drm2_7,noconn_drm48_drm2_6,noconn_drm48_drm2_5,noconn_drm48_drm2_4,noconn_drm48_drm2_3,noconn_drm48_drm2_2,factory_hyst_comparator_5c7dff44_1,factory_hyst_comparator_5c7dff44_0}),
.drm3({trim_clamp_b8eb1a18_7,trim_clamp_b8eb1a18_6,trim_clamp_b8eb1a18_5,trim_clamp_b8eb1a18_4,trim_clamp_b8eb1a18_3,trim_clamp_b8eb1a18_2,trim_clamp_b8eb1a18_1,trim_clamp_b8eb1a18_0}),
.drm4({noconn_drm48_drm4_7,trim_vbuffer_negative_866ca25c_6,trim_vbuffer_negative_866ca25c_5,trim_vbuffer_negative_866ca25c_4,trim_vbuffer_negative_866ca25c_3,trim_vbuffer_negative_866ca25c_2,trim_vbuffer_negative_866ca25c_1,trim_vbuffer_negative_866ca25c_0}),
.drm5({noconn_drm48_drm5_7,trim_vbuffer_positive_866ca25c_6,trim_vbuffer_positive_866ca25c_5,trim_vbuffer_positive_866ca25c_4,trim_vbuffer_positive_866ca25c_3,trim_vbuffer_positive_866ca25c_2,trim_vbuffer_positive_866ca25c_1,trim_vbuffer_positive_866ca25c_0}),
...
STONEnoconn XNCnoconn_drm48_drm2_2 (
.noconn(noconn_drm48_drm2_2)
);

STONEnoconn XNCnoconn_drm48_drm2_3 (
.noconn(noconn_drm48_drm2_3)
);

STONEnoconn XNCnoconn_drm48_drm2_4 (
.noconn(noconn_drm48_drm2_4)
);
