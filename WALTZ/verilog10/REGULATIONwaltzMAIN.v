...
//Celera:resistor_4c753838
//Celera Confidential Symbol Generator
//RESISTOR:1000KOhm TYPE:poly DFT:no
module resistor_4c753838 (RP,
CELG,
RN);
inout RP;
inout RN;
...
//Celera:comparatorctlpins_e27cc3e9
//Celera Confidential Symbol Generator
//Type p Hysteris Mode:pin 20mV Hysteresis,Edge rising without deglitch
//Low IQ:no DFT:no
module comparatorctlpins_e27cc3e9 (enable_comparator,IP,out_comparator,INP_COMPARATOR,
...
// ------------------------ Module Verilog ---------------
module REGULATIONwaltzMAIN (VC, MUDG, MUDV, REFINT, CZCOMP_0, CZCOMP_1, CZCOMP_2, RZCOMP_0, RZCOMP_1, RZCOMP_2, CELG59462, CELV96848, go_driver, GAINCOMP_0, GAINCOMP_1, CELREF84329, CELSUB40948, DCMRIPPLE_0, DCMRIPPLE_1, IP_4215aede, IP_866ca25c, IP_b8eb1a18, IP_e44d2b4d, IP_f7f74094, IREF_DRIVER, kelvin_MUDG, FB_REGULATION, ok_regulation, REF_REGULATION, VSS_REGULATION, enable_regulation, trim_clamp_b8eb1a18, trim_gm_negative_e44d2b4d, trim_gm_positive_e44d2b4d, trim_vbuffer_negative_866ca25c, trim_vbuffer_positive_866ca25c);
inout  VC;
inout  MUDG;
input  MUDV;
inout  REFINT;
...
comparatorctlpins_e27cc3e9 Xcomparator1 (
.IP(IP_f7f74094),
.CELG(CELG59462),
.SIMPV(MUDV),
.CELSUB(CELSUB40948),
