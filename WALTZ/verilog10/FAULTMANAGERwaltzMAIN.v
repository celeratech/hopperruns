...
module delayclock_24a0019c (in,out,CELG,CELV,clock,delay,CELSUB,celeraporb);
  input  in;
  output  out;
  input  CELG;
  input  CELV;
...
module delayfixed_8d787d93 (i,o,CELG,CELV,CELSUB);
  input  i;
  output  o;
  input  CELG;
  input  CELV;
...
module thermal_51a067d4 (IP,ten,CELG,CELBG,SIMPV,CELSUB,fault_thermal,enable_thermal,trim_thermal_accuracy);
  input  IP;
  input  ten;
  input  CELG;
  input  CELBG;
