...
module dftprobeModel2_34e306e9 (i,TAI,ten,CELG,CELSUB,CELV);
input  i;
output  TAI;
input  ten;
input  CELG;
...
module dftprobeModel0_74139600 (i,tdi,ten,CELG,CELSUB,CELV);
input  i;
output  tdi;
input  ten;
input  CELG;
...
module dftprobeModel0_176d9f7e (i,tdi,ten,CELG,CELSUB,CELV);
input  i;
output  tdi;
input  ten;
input  CELG;
...
module dftprobeModel0_ba6fda05 (i,tdi,ten,CELG,CELSUB,CELV);
input  i;
output  tdi;
input  ten;
input  CELG;
...
.CELV(CELV96848),
.CELSUB(CELSUB40948),
.ten_hijack(ten_hijack_XU11),
.ten_hijacki(ten_hijacki_XU11)
);
...
.a({a1,a0}),
.SUB(CELSUB40948),
.TAI({a0,a0,a0,a0,a0,a0,a0,TAI_XU10}),
.TAO(TAO),
.tdi({tdi_XU8,tdi_XU7,tdi_XU6,tdi_XU4,tdi_XU3,tdi_XU21,tdi_XU20,tdi_XU19}),
.tdo(tdo),
.ten({ten_XU4,ten_XU3,ten_XU21,ten_XU20,ten_XU19,ten_XU10,ten_hijacki_XU11,ten_hijack_XU11}),
...
.a({b1,b0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x02_ten_7,noconn_dft_hex0x02_ten_6,noconn_dft_hex0x02_ten_5,noconn_dft_hex0x02_ten_4,noconn_dft_hex0x02_ten_3,ten_XU8,ten_XU7,ten_XU6}),
