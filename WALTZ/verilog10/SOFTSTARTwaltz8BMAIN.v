...
//Celera:celeradacr2r_70ff7fbc
//Celera Confidential Symbol Generator
//LADDER DAC:8 Bits 200.0K with no buffer
module celeradacr2r_70ff7fbc (CELV,
...
//Celera:oscillatorcrude_47335509
//Celera Confidential Symbol Generator
//VMAX:globalV,Crude:142.000KHz
module oscillatorcrude_47335509 (SIMPV,ok_oscillator,osc,global_oscillator,
enable_oscillator,
IP,
CELG,SENSE_G,CELSUB);
input SIMPV;
...
// ------------------------ Module Verilog ---------------
module SOFTSTARTwaltz8BMAIN (SS, REF, MUDV, halfway, CELG59462, CELV96848, dft_clock, CELSUB40948, IP_116e6b00, IP_39ab5afe, IP_bca60d43, enable_brick, softstart_1ms, done_softstart, SENSE_G_39ab5afe, enable_softstart, completed_softstart, kelvin_MUDGsoftstart);
inout  SS;
input  REF;
input  MUDV;
input  halfway;
...
oscillatorcrude_47335509 Xoscillator1 (
.IP(IP_39ab5afe),
.osc(net_151),
.CELG(CELG59462),
.SIMPV(MUDV),
.CELSUB(CELSUB40948),
.SENSE_G(SENSE_G_39ab5afe),
.ok_oscillator(net_167),
.enable_oscillator(enable_softstart),
.global_oscillator(a0)
);
