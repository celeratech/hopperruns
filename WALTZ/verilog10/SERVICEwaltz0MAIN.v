...
module delayfixed_a9b86fed (i,o,CELG,CELV,CELSUB);
  input  i;
  output  o;
  input  CELG;
  input  CELV;
...
module reference_d4853e6a (REF,CELG,CELBG,SIMPV,CELSUB,TAI_REF,ten_ref,trim_ref,TAI_REFBG,ten_refbg,trim_refbg,ok_reference,factory_refccn,factory_refccp,celkelvin_GNDref,enable_reference,global_reference);
  output  REF;
  input  CELG;
  output  CELBG;
  input  SIMPV;
...
module comparatornoctlpins_cf3c3952 (IP,CELG,SIMPV,CELSUB,ok_comparator,INN_COMPARATOR,INP_COMPARATOR,out_comparator,enable_comparator,global_comparator);
  input  IP;
  input  CELG;
  input  SIMPV;
  input  CELSUB;
...
module vbias_428cfc85 (IN1,IN2,CELG,VBIAS,CELSUB,ok_vbias,TAI_VBIAS,tdi_vbias,ten_taiv2v5,global_vbias,ten_taiv1v0f,celkelvin_IN1,celkelvin_IN2,trim_vbiasneg,trim_vbiaspos,trim_vbiasref,ENABLE_VBIASHV,ten_taifbvbias,ten_tdiokvbias,celkelvin_VBIAS,ten_enablevbias);
  input  IN1;
  input  IN2;
  input  CELG;
  output  VBIAS;
