// ------------------------ Module Definitions -----------
module dftprobeModel0_21874c17 (i,tdi,ten,CELG,CELV,CELSUB);
  input  i;
  output  tdi;
  input  ten;
  input  CELG;
...
module dftprobeModel0_81688f53 (i,tdi,ten,CELG,CELV,CELSUB);
  input  i;
  output  tdi;
  input  ten;
  input  CELG;
...
module dftprobeModel0_52625d66 (i,tdi,ten,CELG,CELV,CELSUB);
  input  i;
  output  tdi;
  input  ten;
  input  CELG;
...
.a({c1,c0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x0C_ten_7,noconn_dft_hex0x0C_ten_6,noconn_dft_hex0x0C_ten_5,noconn_dft_hex0x0C_ten_4,noconn_dft_hex0x0C_ten_3,noconn_dft_hex0x0C_ten_2,noconn_dft_hex0x0C_ten_1,ten_hijacki_c5202207_Xdfthijack1}),
