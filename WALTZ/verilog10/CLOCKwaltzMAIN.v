...
module timingskew_13ab43f9 (CELV,in,out,s,CELG,CELSUB);
  input [3:0] s;
  input  in;
  output  out;
  input  CELG;
...
module paddigitalinput_2a35d913 (SIMPV,CELV,IN,out,CELG,CELSUB);
  input  IN;
  output  out;
  input  CELG;
  input  CELV;
...
module clocksync_3aed083e (CELV,clocksync_in,clk,enable_clocksync,global_clocksync,clocksync_out,clocksync_high,clocksync_low,CELG,CELSUB);
  input  clk;
  input  CELG;
  input  CELV;
  input  CELSUB;
...
.tdo(tdo),
.ten({noconn_dft_hex0x03_ten_7,noconn_dft_hex0x03_ten_6,noconn_dft_hex0x03_ten_5,noconn_dft_hex0x03_ten_4,noconn_dft_hex0x03_ten_3,global_clocksync_fbf1a785_XU30,global_oscillator_90c263a6_XOSCEXT,ten_osc_90c263a6_XOSCEXT}),
