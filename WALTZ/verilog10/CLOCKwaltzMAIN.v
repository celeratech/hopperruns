...
module timingskew_13ab43f9 (s,in,out,CELG,CELV,CELSUB);
  input [3:0] s;
  input  in;
  output  out;
  input  CELG;
...
module clocksync_3aed083e (clk,CELG,CELV,CELSUB,clocksync_in,clocksync_low,clocksync_out,clocksync_high,enable_clocksync,global_clocksync);
  input  clk;
  input  CELG;
  input  CELV;
  input  CELSUB;
