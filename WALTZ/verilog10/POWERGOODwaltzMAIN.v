...
module comparatornoctlpins_f82fa5a6 (enable_comparator,IP,out_comparator,INP_COMPARATOR,INN_COMPARATOR,SIMPV,global_comparator,ok_comparator,CELG,CELSUB);
  input  IP;
  input  CELG;
  input  SIMPV;
  input  CELSUB;
...
module padopendrain_ff7ffa6a (CELV,input_padopendrain,PAD,ten_padopendrain,tdi_padopendrain,CELG,SUB);
  inout  PAD;
  input  SUB;
  input  CELG;
  input  CELV;
...
module delayclock_722c4018 (in,CELV,out,clock,celeraporb,delay,CELG,CELSUB);
  input  in;
  output  out;
  input  CELG;
  input  CELV;
...
module delayfixed_ec7ad93c (CELV,i,o,CELG,CELSUB);
  input  i;
  output  o;
  input  CELG;
  input  CELV;
...
module comparatornoctlpins_490d0ceb (enable_comparator,IP,out_comparator,INP_COMPARATOR,INN_COMPARATOR,SIMPV,global_comparator,ok_comparator,CELG,CELSUB);
  input  IP;
  input  CELG;
  input  SIMPV;
  input  CELSUB;
