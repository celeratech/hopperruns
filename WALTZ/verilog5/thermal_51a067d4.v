...
//Thermal Protector:Rise 165C Fall naC
 module thermal_51a067d4 (SIMPV,CELBG,IP,enable_thermal,fault_thermal,ten,
...
rlpp3000rpo113p6u0p5u XR2_4(
.RP (TRIPHYST_B),
.RN (HYST),
.ISO (CELG)
);
rlpp3000rpo113p6u0p5u XR2_5(
.RP (TRIPHYST_B),
.RN (HYST),
.ISO (CELG)
);
rlpp3000rpo113p6u0p5u XR2_6(
.RP (TRIPHYST_B),
.RN (HYST),
.ISO (CELG)
);
