...
//Celera Confidential Do Not Copy STONEvbiasbgcomp60vin2ACCURATE
//Verilog HDL for "Generate", "STONEvbiasbgcomp60vin2ACCURATE" "functional"


module STONEvbiasbgcomp60vin2ACCURATE ( IN1, CELG, CELSUB, ok_vbiasbg, ok_in1,
enable_vbias, trim_vbias, BGPOS, ten, ten_enable_vbias, START, RESRTNIN2, ok_in2,
IN2DIV, IN1DIV, HVP100N, P100N, V1V0F, discharge, RESRTNIN1, latch_enable, a0
);
...
//Celera Confidential Do Not Copy STONEvbiasldoin160in230pmosNOME
//Verilog HDL for "Generate", "STONEvbiasldoin160in230pmosNOME" "functional"


module STONEvbiasldoin160in230pmosNOME ( IN1, CELG, CELSUB, IN2, V2V5, V1V0F,
ok_in1, FORCE_VBIAS, FB_VBIAS, P1U, ok_in2, RESRTN, P500N, ok_vbias, IDN, IDP,
a1 );
...
//Celera Confidential Do Not Copy resistordivider_vbias_428cfc85_XRfeedback.v
//Celera:resistordivider_vbias_428cfc85_XRfeedback
//Celera Confidential Symbol Generator
//VMAX:6V R:4500.0KOhm 1Taps
module resistordivider_vbias_428cfc85_XRfeedback (TOP,
TAP0,
CELG, BOTTOM);
inout TOP;
output TAP0;
...
//Celera Confidential Do Not Copy resistordivider_vbias_428cfc85_XRuvlo.v
//Celera:resistordivider_vbias_428cfc85_XRuvlo
//Celera Confidential Symbol Generator
...
//Celera Confidential Do Not Copy resistordivider_vbias_428cfc85_XRswitchover.v
//Celera:resistordivider_vbias_428cfc85_XRswitchover
//Celera Confidential Symbol Generator
//VMAX:6V R:4000.0KOhm 1Taps
module resistordivider_vbias_428cfc85_XRswitchover (TOP,
TAP0,
CELG, BOTTOM);
inout TOP;
output TAP0;
...
//Celera Confidential Do Not Copy vbias_428cfc85
//Celera Confidential Symbol Generator
...
//,diesize,STONEnoconn
//Celera Confidential Do Not Copy STONEvbiasbgcomp60vin2ACCURATE
STONEvbiasbgcomp60vin2ACCURATE Xbgcomp(
...
//,diesize,STONEvbiasbgcomp60vin2ACCURATE
//Celera Confidential Do Not Copy STONEvbiasservice60vNOME
...
//,diesize,STONEnoconn
//Celera Confidential Do Not Copy STONEvbiasldoin160in230pmosNOME
STONEvbiasldoin160in230pmosNOME Xldo(
.P500N (P500N),
.P1U (P1U),
.FB_VBIAS (FB_VBIAS),
.IDN (IDN),
...
//,diesize,STONEvbiasldoin160in230pmosNOME
//Celera Confidential Do Not Copy STONEvbiasENABLE60NOME
...
//Celera Confidential Do Not Copy resistordivider_vbias_428cfc85_XRfeedback
resistordivider_vbias_428cfc85_XRfeedback XRfeedback(
.TOP (celkelvin_VBIAS),
.TAP0 (FB_VBIAS),
.BOTTOM (RESRTN),
.CELG (CELG)
);
//,diesize,resistordivider_vbias_428cfc85_XRfeedback
//Celera Confidential Do Not Copy resistordivider_vbias_428cfc85_XRuvlo
resistordivider_vbias_428cfc85_XRuvlo XRuvlo(
.TOP (celkelvin_IN1),
.TAP0 (I_TO_IN1RES),
.BOTTOM (RESRTNIN1),
.CELG (CELG)
);
//,diesize,resistordivider_vbias_428cfc85_XRuvlo
//Celera Confidential Do Not Copy STONEvbiasENABLE60NOME
...
//,diesize,STONEvbiasENABLE60NOME
//Celera Confidential Do Not Copy resistordivider_vbias_428cfc85_XRswitchover
resistordivider_vbias_428cfc85_XRswitchover XRswitchover(
.TOP (celkelvin_IN2),
.TAP0 (I_TO_IN2RES),
.BOTTOM (RESRTNIN2),
.CELG (CELG)
);
//,diesize,resistordivider_vbias_428cfc85_XRswitchover
//Celera Confidential Do Not Copy STONEvbiasENABLE30NOME
STONEvbiasENABLE30NOME Xswitchover(
.I (I_TO_IN2RES),
.O (IN2DIV),
.CELG (CELG),
.CELSUB (CELSUB)
