...
//Celera Confidential Do Not Copy logicshifter0H2L_fetdriver_5ddd0fd3_Xstatusout.v
//Celera:logicshifter0H2L_fetdriver_5ddd0fd3_Xstatusout
//Logic Level shifter with Enable
module logicshifter0H2L_fetdriver_5ddd0fd3_Xstatusout (enable_logicshifter,
VIN1,VIN2,
in,
out,
CELG,CELSUB);
...
//Celera Confidential Do Not Copy fet_fetdriver_5ddd0fd3_Xnmos0.v
//Celera:fet_fetdriver_5ddd0fd3_Xnmos0
//Celera Confidential Symbol Generator
//power NMOS:Ron:4.000 Ohm
//Vgs 6V Vds 6V
//Kelvin:no

module fet_fetdriver_5ddd0fd3_Xnmos0 (GATE,SOURCE,DRAIN,NMOSiso6,SUB);
input GATE;
inout SOURCE;
inout DRAIN;
input SUB;
...
//Celera Confidential Do Not Copy fet_fetdriver_5ddd0fd3_Xpmos0.v
//Celera:fet_fetdriver_5ddd0fd3_Xpmos0
//Celera Confidential Symbol Generator
//power PMOS:Ron:8.000 Ohm
//Vgs 6V Vds 6V
//Kelvin:no

module fet_fetdriver_5ddd0fd3_Xpmos0 (GATE,DRAIN,
SOURCE,
PMOSiso6,SUB);
input GATE;
inout SOURCE;
...
//Celera Confidential Do Not Copy resistor_resistor_fetdriver_5ddd0fd3_Xpassive.v
//Celera:resistor_resistor_fetdriver_5ddd0fd3_Xpassive
//Celera Confidential Symbol Generator
//RESISTOR:1000.00KOhm TYPE:poly DFT:no
module resistor_resistor_fetdriver_5ddd0fd3_Xpassive (RP,
CELG,
RN);
inout RP;
inout RN;
...
//Celera Confidential Do Not Copy fetdriver_5ddd0fd3
//Celera Confidential Symbol Generator
//FET DRIVER 'n' Type 8 Ron 4 Roff 
//Input 6V Levelshifter
//Gate Sense 6V Sense Levelshifterwith 0nsdelay
//DFT no
module fetdriver_5ddd0fd3 (HVPOS,global_fetdriver,fetin,GATE,gate_status,
gate_status_vin,
CELV,
CELG,
enable_fetdriver,
...
//Celera Confidential Do Not Copy logicshifter0H2L_fetdriver_5ddd0fd3_Xstatusout
logicshifter0H2L_fetdriver_5ddd0fd3_Xstatusout Xstatusout(
.VIN1 (HVPOS),
.VIN2 (CELV),
.in (gate_status),
...
//,diesize,logicshifter0H2L_fetdriver_5ddd0fd3_Xstatusout

//Celera Confidential Do Not Copy fet_fetdriver_5ddd0fd3_Xnmos0
fet_fetdriver_5ddd0fd3_Xnmos0 Xpowernmos0(
.GATE (ndrive0),
.SOURCE (HVNEG),
.DRAIN (GATE),
.NMOSiso6 (HVPOS),
...
//,diesize,fet_fetdriver_5ddd0fd3_Xnmos0
...
//Celera Confidential Do Not Copy fet_fetdriver_5ddd0fd3_Xpmos0
fet_fetdriver_5ddd0fd3_Xpmos0 Xpowerpmos0(
.GATE (pdrive0),
.SOURCE (HVPOS),
.DRAIN (GATE),
.SUB (CELSUB),
...
//,diesize,fet_fetdriver_5ddd0fd3_Xpmos0
...
//Celera Confidential Do Not Copy resistor_resistor_fetdriver_5ddd0fd3_Xpassive
resistor_resistor_fetdriver_5ddd0fd3_Xpassive Xpassive(
.RP (GATE),
.RN (HVNEG),
.CELG (HVNEG)
);
//,diesize,resistor_resistor_fetdriver_5ddd0fd3_Xpassive
