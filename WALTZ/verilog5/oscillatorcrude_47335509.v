...
module mim34_2f26p2x21p0 (CP,CN);
inout CP;
inout CN;
endmodule
...
//Celera Confidential Do Not Copy oscillatorcrude_47335509
...
mim34_2f26p2x21p0 XCAPon__0(
.CP (CR),
.CN (SENSE_G)
);
mim34_2f26p2x21p0 XCAPon__1(
.CP (CR),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CAPoff__
mim34_2f26p2x21p0 XCAPoff__0(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f26p2x21p0 XCAPoff__1(
.CP (CL),
.CN (SENSE_G)
);
