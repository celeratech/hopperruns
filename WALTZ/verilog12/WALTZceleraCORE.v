...
module DRIVERwaltz (SW,BSTV,MUDV,MUDHV,PMUDG,PMUDV,PMUDHV,botstate,topstate,CELG59462,CELV96848,bbm_topon,botswineg,ok_driver,botswipeak,topswipeak,CELSUB40948,IP_14d08c8e,IP_2d447a5c,IP_a0afb596,IP_f4252e65,IREF_DRIVER,botswzcross,bbm_bottomon,ISLOPE_DRIVER,enable_driver);
  inout  SW;
  input  BSTV;
  input  MUDV;
  input  MUDHV;
...
module FAULTMANAGERwaltz (MUDV,clock,CELG59462,CELV96848,PORB97836,fault_run,CELBG83021,CELSUB40948,IP_201f84ba,blank_fault,fault_short,fault_freeze,enable_faultmanager);
  input  MUDV;
  input  clock;
  input  CELG59462;
  input  CELV96848;
...
module SERVICEwaltz (EN,IN,VCC,BIAS,porb,REF0V9,CELG59462,CELV96848,CELBG83021,OKREF03249,kelvin_VCC,ok_service,CELREF84329,CELSUB40948,IP_75c89176,kelvin_GNDservice,celkelvin_IN_bc3b7675,celkelvin_GND_d75c3f7f,celkelvin_VCC_bc3b7675,celkelvin_BIAS_bc3b7675);
  input  EN;
  input  IN;
  output  VCC;
  input  BIAS;
