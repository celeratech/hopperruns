...
module oscillator_XWALTZ_XceleraSERDES_Xoscillator (ten,CELG,SIMPV,tdext,CELSUB,oscillator,ok_oscillator,tdi_oscillator,enable_oscillator,ten_oscillator_on,ten_oscillator_off,ten_oscillator_div8,ten_oscillator_external);
  input  ten;
  input  CELG;
  input  SIMPV;
  input  tdext;
