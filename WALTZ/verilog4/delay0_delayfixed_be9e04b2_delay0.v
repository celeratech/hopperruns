...
//CELL SOURCE:delay0
//NAME:delay0_delayfixed_be9e04b2_delay0
...
module mim34_2f20p5x13p0 (CP,CN);
inout CP;
inout CN;
endmodule
...
//Celera Confidential Do Not Copy delay0_delayfixed_be9e04b2_delay0
//TYPE:fixed 30us EDGE:rise DFT:no ACC:no
module delay0_delayfixed_be9e04b2_delay0 (i,CELV,o,
CELG,CELSUB);
input CELV;
input i;
output o;
...
mim34_2f20p5x13p0 XC0_0(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x13p0 XC0_1(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x13p0 XC0_2(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x13p0 XC0_3(
.CP (C0),
.CN (CELG)
);
mim34_2f20p5x13p0 XC0_4(
.CP (C0),
.CN (CELG)
);

//Celera Confidential Do Not Copy //DieSize,mim34_2f20p5x13p0

//Die Size Calculator mim34_2f20p5x13p0
//,diesize,mim34_2f20p5x13p0,5
