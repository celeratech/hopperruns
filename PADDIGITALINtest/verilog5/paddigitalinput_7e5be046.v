...
//Celera Confidential Do Not Copy delay0_paddigitalinput_7e5be046_Xglitch.v
//Celera:delay0_paddigitalinput_7e5be046_Xglitch
//TYPE: fixed 1ns
module delay0_paddigitalinput_7e5be046_Xglitch (i, CELV, o,
CELG,CELSUB);
input CELV;
input i;
output o;
...
//Celera Confidential Do Not Copy paddigitalinput_7e5be046
//Celera Confidential Symbol Generator
//PAD Digital Input with 1.0Kohm pulldown
//Filter Time:1ns
module paddigitalinput_7e5be046 (SIMPV,CELV,IN,out,
CELG,CELSUB); 
input SIMPV;
input CELV;
input IN;
...
//Celera Confidential Do Not Copy delay0_paddigitalinput_7e5be046_Xglitch
delay0_paddigitalinput_7e5be046_Xglitch Xglitch(
.CELV (CELV),
.i (glitchi),
.o (out),
.CELSUB (CELSUB),
...
//,diesize,delay0_paddigitalinput_7e5be046_Xglitch
