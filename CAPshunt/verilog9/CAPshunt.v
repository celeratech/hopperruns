...
// ------------------------ Module Verilog ---------------
module CAPshunt (IN, IP, CAP1, CAP2, CAP3, CAP4, SIMPV, CAPRTN, CELG59462, CELV96848, PORB97836, CELSUB40948, clock_shunt, IP_CAPshunt1, active_shunt, enable_shunt, maximum_channel_0, maximum_channel_1);
input  IN;
inout  IP;
inout  CAP1;
inout  CAP2;
...
.CELG(CELG59462),
.ISET(IP_CAPshunt1),
.SIMPV(TBD_XSHUNT_XCurrentMirror1_SIMPV),
.CELSUB(CELSUB40948),
