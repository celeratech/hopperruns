...
module mim34_2f30p0x28p5 (CP,CN);
inout CP;
inout CN;
endmodule
...
//Celera Confidential Do Not Copy oscillatorcrude_6f9c64ad
...
mim34_2f30p0x28p5 XCAPon__0(
.CP (CR),
.CN (SENSE_G)
);
mim34_2f30p0x28p5 XCAPon__1(
.CP (CR),
.CN (SENSE_G)
);
mim34_2f30p0x28p5 XCAPon__2(
.CP (CR),
.CN (SENSE_G)
);
mim34_2f30p0x28p5 XCAPon__3(
.CP (CR),
.CN (SENSE_G)
);
mim34_2f30p0x28p5 XCAPon__4(
.CP (CR),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CAPoff__
mim34_2f30p0x28p5 XCAPoff__0(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x28p5 XCAPoff__1(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x28p5 XCAPoff__2(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x28p5 XCAPoff__3(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x28p5 XCAPoff__4(
.CP (CL),
.CN (SENSE_G)
);
