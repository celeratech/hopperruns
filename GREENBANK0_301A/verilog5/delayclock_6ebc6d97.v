...
//Celera Confidential Do Not Copy delayclock_6ebc6d97
...
.CELV (CELV),
.i0 ({do,d1,do,do,d1,d1,do,d1,do}),
.i1 ({do,d1,do,d1,d1,do,d1,do,do}),
.i2 ({do,d1,d1,do,do,d1,d1,do,d1}),
.i3 ({do,d1,d1,d1,do,do,d1,d1,d1}),
.sel (delay [1:0]),
