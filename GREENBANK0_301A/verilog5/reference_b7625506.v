...
//NAME:reference_b7625506
//REFERENCE:0.800V
//FEEDBACK CURRENT:10.000uA
//VMAX:6V
//TRIM:yes
//CC TRIM:yes
//CCN POR:15
...
module rlpp3000rpo95p6u0p8u (ISO,RP,RN);
input ISO;
inout RP;
inout RN;
endmodule
...
module reference_b7625506 (SIMPV,enable_reference,ok_reference,REF,global_reference,
CELBG,
ten_ref,TAI_REF,
ten_refbg,TAI_REFBG,
trim_ref,trim_refbg,
...
//,diesize,STONEnoconn
//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo95p6u0p8u

//Die Size Calculator rlpp3000rpo95p6u0p8u
//,diesize,rlpp3000rpo95p6u0p8u,14

//Celera Confidential Do Not Copy RFB0
rlpp3000rpo95p6u0p8u XRFB0_0(
.RP (REFDIV2),
.RN (REFDIV2celkelvin_GNDref_1),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB0_1(
.RP (REFDIV2celkelvin_GNDref_1),
.RN (REFDIV2celkelvin_GNDref_2),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB0_2(
.RP (REFDIV2celkelvin_GNDref_2),
.RN (REFDIV2celkelvin_GNDref_3),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB0_3(
.RP (REFDIV2celkelvin_GNDref_3),
.RN (REFDIV2celkelvin_GNDref_4),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB0_4(
.RP (REFDIV2celkelvin_GNDref_4),
.RN (REFDIV2celkelvin_GNDref_5),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB0_5(
.RP (REFDIV2celkelvin_GNDref_5),
.RN (REFDIV2celkelvin_GNDref_6),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB0_6(
.RP (REFDIV2celkelvin_GNDref_6),
.RN (REFDIV2celkelvin_GNDref_7),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB0_7(
.RP (REFDIV2celkelvin_GNDref_7),
.RN (REFDIV2celkelvin_GNDref_A),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB0_8(
.RP (REFDIV2celkelvin_GNDref_A),
.RN (REFDIV2celkelvin_GNDref_B),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB0_9(
.RP (REFDIV2celkelvin_GNDref_A),
.RN (REFDIV2celkelvin_GNDref_B),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB0_10(
.RP (REFDIV2celkelvin_GNDref_B),
.RN (celkelvin_GNDref),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB0_11(
.RP (REFDIV2celkelvin_GNDref_B),
.RN (celkelvin_GNDref),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB0_12(
.RP (REFDIV2celkelvin_GNDref_B),
.RN (celkelvin_GNDref),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB0_13(
.RP (REFDIV2celkelvin_GNDref_B),
.RN (celkelvin_GNDref),
.ISO (CELG)
);
...
rlpp3000rpo95p6u0p8u XRFB1_0(
.RP (REFI),
.RN (REFIREFDIV2_1),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB1_1(
.RP (REFIREFDIV2_1),
.RN (REFIREFDIV2_2),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB1_2(
.RP (REFIREFDIV2_2),
.RN (REFIREFDIV2_3),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB1_3(
.RP (REFIREFDIV2_3),
.RN (REFIREFDIV2_4),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB1_4(
.RP (REFIREFDIV2_4),
.RN (REFIREFDIV2_5),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB1_5(
.RP (REFIREFDIV2_5),
.RN (REFIREFDIV2_6),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB1_6(
.RP (REFIREFDIV2_6),
.RN (REFIREFDIV2_7),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB1_7(
.RP (REFIREFDIV2_7),
.RN (REFIREFDIV2_A),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB1_8(
.RP (REFIREFDIV2_A),
.RN (REFIREFDIV2_B),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB1_9(
.RP (REFIREFDIV2_A),
.RN (REFIREFDIV2_B),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB1_10(
.RP (REFIREFDIV2_B),
.RN (REFDIV2),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB1_11(
.RP (REFIREFDIV2_B),
.RN (REFDIV2),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB1_12(
.RP (REFIREFDIV2_B),
.RN (REFDIV2),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XRFB1_13(
.RP (REFIREFDIV2_B),
.RN (REFDIV2),
.ISO (CELG)
);
...
//Die Size Calculator rlpp3000rpo95p6u0p8u
//,diesize,rlpp3000rpo95p6u0p8u,11

//Celera Confidential Do Not Copy ROUT
rlpp3000rpo95p6u0p8u XROUT_0(
.RP (RREF0),
.RN (RREF0REFI_1),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XROUT_1(
.RP (RREF0REFI_1),
.RN (RREF0REFI_2),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XROUT_2(
.RP (RREF0REFI_2),
.RN (RREF0REFI_3),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XROUT_3(
.RP (RREF0REFI_3),
.RN (RREF0REFI_4),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XROUT_4(
.RP (RREF0REFI_4),
.RN (RREF0REFI_5),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XROUT_5(
.RP (RREF0REFI_5),
.RN (RREF0REFI_6),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XROUT_6(
.RP (RREF0REFI_6),
.RN (RREF0REFI_7),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XROUT_7(
.RP (RREF0REFI_7),
.RN (RREF0REFI_8),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XROUT_8(
.RP (RREF0REFI_8),
.RN (RREF0REFI_A),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XROUT_9(
.RP (RREF0REFI_A),
.RN (REFI),
.ISO (CELG)
);
rlpp3000rpo95p6u0p8u XROUT_10(
.RP (RREF0REFI_A),
.RN (REFI),
.ISO (CELG)
);
...
//,diesize,rlpp3000rpo1p3u0p4u,64
...
rlpp3000rpo1p3u0p4u XRT0_14(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_15(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_16(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_17(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_18(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_19(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_20(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_21(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_22(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_23(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_24(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_25(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_26(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_27(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_28(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_29(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_30(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_31(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_32(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_33(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_34(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_35(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_36(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_37(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_38(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_39(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_40(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_41(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_42(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_43(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_44(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_45(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_46(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_47(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_48(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_49(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_50(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_51(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_52(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_53(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_54(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_55(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_56(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_57(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_58(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_59(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_60(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_61(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_62(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT0_63(
.RP (RREF0),
.RN (RREF1),
.ISO (CELG)
);
...
//Die Size Calculator rlpp3000rpo1p3u0p4u
//,diesize,rlpp3000rpo1p3u0p4u,32
...
rlpp3000rpo1p3u0p4u XRT1_14(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_15(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_16(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_17(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_18(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_19(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_20(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_21(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_22(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_23(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_24(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_25(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_26(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_27(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_28(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_29(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_30(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT1_31(
.RP (RREF1),
.RN (RREF2),
.ISO (CELG)
);
...
//Die Size Calculator rlpp3000rpo1p3u0p4u
//,diesize,rlpp3000rpo1p3u0p4u,16
...
rlpp3000rpo1p3u0p4u XRT2_14(
.RP (RREF2),
.RN (RREF3),
.ISO (CELG)
);
rlpp3000rpo1p3u0p4u XRT2_15(
.RP (RREF2),
.RN (RREF3),
.ISO (CELG)
);
