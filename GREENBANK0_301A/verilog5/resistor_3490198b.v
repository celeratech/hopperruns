...
//Celera Confidential Do Not Copy rlpp3000rpo9p0u0p4u
//Celera Confidential Symbol Generator
//poly 94.860046Kohm Resistor
module rlpp3000rpo9p0u0p4u (RP, RN, ISO);
inout RP;
inout RN;
input ISO;
endmodule
...
//Celera Confidential Do Not Copy rlpp3000rpo13p7u0p4u
//Celera Confidential Symbol Generator
//poly 144.295685Kohm Resistor
module rlpp3000rpo13p7u0p4u (RP, RN, ISO);
inout RP;
inout RN;
input ISO;
endmodule

//Celera Confidential Do Not Copy rlpp3000rpo16p1u0p4u
//Celera Confidential Symbol Generator
//poly 169.539444Kohm Resistor
module rlpp3000rpo16p1u0p4u (RP, RN, ISO);
inout RP;
inout RN;
input ISO;
endmodule

//Celera Confidential Do Not Copy resistor_3490198b
//Celera Confidential Symbol Generator
...
rlpp3000rpo2p8u0p4u XRA1_0(
.RP (RA0),
.RN (RA1),
.ISO (CELG)
);
rlpp3000rpo2p8u0p4u XRA1_1(
.RP (RA0),
.RN (RA1),
.ISO (CELG)
);
rlpp3000rpo2p8u0p4u XRA1_2(
.RP (RA0),
.RN (RA1),
.ISO (CELG)
);
...
rlpp3000rpo9p0u0p4u XRA4_0(
.RP (RA3),
.RN (RA4),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo9p0u0p4u

//Die Size Calculator rlpp3000rpo9p0u0p4u
//,diesize,rlpp3000rpo9p0u0p4u,1
...
rlpp3000rpo13p7u0p4u XRA6_0(
.RP (RA5),
.RN (RA6),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo13p7u0p4u

//Die Size Calculator rlpp3000rpo13p7u0p4u
//,diesize,rlpp3000rpo13p7u0p4u,1
...
rlpp3000rpo16p1u0p4u XRA7_0(
.RP (RA6),
.RN (RN),
.ISO (CELG)
);

//Celera Confidential Do Not Copy //DieSize,rlpp3000rpo16p1u0p4u

//Die Size Calculator rlpp3000rpo16p1u0p4u
//,diesize,rlpp3000rpo16p1u0p4u,1
