...
// ------------------------ Module Verilog ---------------
module GREENBANK0_301AceleraREGISTER (MUDV, scli, sdai, ADDRESS, CELG59462, CELV96848, PORB97836, CELSUB40948, sdapd_registermap, KELVINsenseADDRESS, register_REF2output_xdatamap2_8e30a47d, register_REF3output_xdatamap1_e1ae9635, status_AMPLIFIERstatus1_xdatamap2_7b045570, status_AMPLIFIERstatus2_xdatamap3_ac0deefd, status_AMPLIFIERstatus3_xdatamap4_8e22524f, status_AMPLIFIERstatus4_xdatamap5_b160a2b2, status_AMPLIFIERstatus5_xdatamap6_8433c5bc, register_REFERENCEselect_xdatamap4_d156f668, register_LDOconfigurationA_xdatamap1_d6b88199, register_LDOconfigurationA_xdatamap2_6d40af93, register_AMPCONTROLHIGHgain_xdatamap1_c5092cf0, register_AMPCONTROLSLOWgain_xdatamap1_ddf37bab, register_AMPCONTROLMEDIUMgain_xdatamap1_2bedf005, register_SERVICEconfiguration_xdatamap3_d08024d7, register_AMPLIFIERconfiguration_xdatamap1_6b265aab);
inout  MUDV;
input  scli;
input  sdai;
output  ADDRESS;
...
input [1:0] status_AMPLIFIERstatus1_xdatamap2_7b045570;
input [2:0] status_AMPLIFIERstatus2_xdatamap3_ac0deefd;
input [5:0] status_AMPLIFIERstatus3_xdatamap4_8e22524f;
input [6:0] status_AMPLIFIERstatus4_xdatamap5_b160a2b2;
input [7:0] status_AMPLIFIERstatus5_xdatamap6_8433c5bc;
...
output [2:0] register_AMPCONTROLHIGHgain_xdatamap1_c5092cf0;
output [2:0] register_AMPCONTROLSLOWgain_xdatamap1_ddf37bab;
output [2:0] register_AMPCONTROLMEDIUMgain_xdatamap1_2bedf005;
output [5:0] register_SERVICEconfiguration_xdatamap3_d08024d7;
output [7:0] register_AMPLIFIERconfiguration_xdatamap1_6b265aab;
...
.i2cmiso(i2cmiso),
.register({REG0x01_7,REG0x01_6,REG0x01_5,REG0x01_4,REG0x01_3,register_AMPCONTROLHIGHgain_xdatamap1_c5092cf0[2],register_AMPCONTROLHIGHgain_xdatamap1_c5092cf0[1],register_AMPCONTROLHIGHgain_xdatamap1_c5092cf0[0]})
);
...
.i2cmiso(i2cmiso),
.register({REG0x02_7,REG0x02_6,REG0x02_5,REG0x02_4,REG0x02_3,register_AMPCONTROLMEDIUMgain_xdatamap1_2bedf005[2],register_AMPCONTROLMEDIUMgain_xdatamap1_2bedf005[1],register_AMPCONTROLMEDIUMgain_xdatamap1_2bedf005[0]})
);
...
.i2cmiso(i2cmiso),
.register({REG0x03_7,REG0x03_6,REG0x03_5,REG0x03_4,REG0x03_3,register_REF2output_xdatamap2_8e30a47d[2],register_REF2output_xdatamap2_8e30a47d[1],register_REF2output_xdatamap2_8e30a47d[0]})
);
...
.i2cmiso(i2cmiso),
.register({REG0x04_7,REG0x04_6,REG0x04_5,REG0x04_4,REG0x04_3,register_REF3output_xdatamap1_e1ae9635[2],register_REF3output_xdatamap1_e1ae9635[1],register_REF3output_xdatamap1_e1ae9635[0]})
);
...
.i2cmiso(i2cmiso),
.register({REG0x05_7,REG0x05_6,REG0x05_5,register_REFERENCEselect_xdatamap4_d156f668[2],register_REFERENCEselect_xdatamap4_d156f668[1],register_REFERENCEselect_xdatamap4_d156f668[0],REG0x05_1,REG0x05_0})
);
...
.i2cmiso(i2cmiso),
.register({register_SERVICEconfiguration_xdatamap3_d08024d7[0],REG0x06_6,REG0x06_5,register_SERVICEconfiguration_xdatamap3_d08024d7[5],register_SERVICEconfiguration_xdatamap3_d08024d7[4],register_SERVICEconfiguration_xdatamap3_d08024d7[3],register_SERVICEconfiguration_xdatamap3_d08024d7[2],register_SERVICEconfiguration_xdatamap3_d08024d7[1]})
);
...
.lock(h0),
.i2cbus(i2cbus[12:0]),
.address({h0,h0,h1,h0,h0,h0,h1,h0}),
.i2cmiso(i2cmiso),
...
.i2cmiso(i2cmiso),
.register({REG0x45_7,REG0x45_6,register_AMPCONTROLSLOWgain_xdatamap1_ddf37bab[2],register_AMPCONTROLSLOWgain_xdatamap1_ddf37bab[1],register_AMPCONTROLSLOWgain_xdatamap1_ddf37bab[0],REG0x45_2,REG0x45_1,REG0x45_0})
);
...
.i2cmiso(i2cmiso),
.register({register_AMPLIFIERconfiguration_xdatamap1_6b265aab[0],register_AMPLIFIERconfiguration_xdatamap1_6b265aab[7],register_AMPLIFIERconfiguration_xdatamap1_6b265aab[6],register_AMPLIFIERconfiguration_xdatamap1_6b265aab[5],register_AMPLIFIERconfiguration_xdatamap1_6b265aab[4],register_AMPLIFIERconfiguration_xdatamap1_6b265aab[3],register_AMPLIFIERconfiguration_xdatamap1_6b265aab[2],register_AMPLIFIERconfiguration_xdatamap1_6b265aab[1]})
);
...
.i2cmiso(i2cmiso),
.status0(status_AMPLIFIERstatus3_xdatamap4_8e22524f[0]),
.status1(status_AMPLIFIERstatus3_xdatamap4_8e22524f[1]),
.status2(status_AMPLIFIERstatus3_xdatamap4_8e22524f[2]),
.status3(status_AMPLIFIERstatus3_xdatamap4_8e22524f[3]),
.status4(status_AMPLIFIERstatus3_xdatamap4_8e22524f[4]),
.status5(status_AMPLIFIERstatus3_xdatamap4_8e22524f[5]),
.status6(p0),
.status7(p0)
);
...
.i2cmiso(i2cmiso),
.status0(status_AMPLIFIERstatus4_xdatamap5_b160a2b2[0]),
.status1(status_AMPLIFIERstatus4_xdatamap5_b160a2b2[1]),
.status2(status_AMPLIFIERstatus4_xdatamap5_b160a2b2[2]),
.status3(status_AMPLIFIERstatus4_xdatamap5_b160a2b2[3]),
.status4(status_AMPLIFIERstatus4_xdatamap5_b160a2b2[4]),
.status5(status_AMPLIFIERstatus4_xdatamap5_b160a2b2[5]),
.status6(status_AMPLIFIERstatus4_xdatamap5_b160a2b2[6]),
.status7(q0)
);
...
.status2(n0),
.status3(n0),
.status4(status_AMPLIFIERstatus2_xdatamap3_ac0deefd[0]),
.status5(status_AMPLIFIERstatus2_xdatamap3_ac0deefd[1]),
.status6(status_AMPLIFIERstatus2_xdatamap3_ac0deefd[2]),
.status7(n0)
);
...
.i2cmiso(i2cmiso),
.status0(status_AMPLIFIERstatus5_xdatamap6_8433c5bc[0]),
.status1(status_AMPLIFIERstatus5_xdatamap6_8433c5bc[1]),
.status2(status_AMPLIFIERstatus5_xdatamap6_8433c5bc[2]),
.status3(status_AMPLIFIERstatus5_xdatamap6_8433c5bc[3]),
.status4(status_AMPLIFIERstatus5_xdatamap6_8433c5bc[4]),
.status5(status_AMPLIFIERstatus5_xdatamap6_8433c5bc[5]),
.status6(status_AMPLIFIERstatus5_xdatamap6_8433c5bc[6]),
.status7(status_AMPLIFIERstatus5_xdatamap6_8433c5bc[7])
);
...
.status0(m0),
.status1(m0),
.status2(status_AMPLIFIERstatus1_xdatamap2_7b045570[0]),
.status3(status_AMPLIFIERstatus1_xdatamap2_7b045570[1]),
.status4(m0),
.status5(m0),
.status6(m0),
.status7(m0)
