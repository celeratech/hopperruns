...
module amplifier_0e1b07e7 (IP,INN,INP,OUT,CELG,SIMPV,CELSUB,ok_amplifier,enable_amplifier,global_amplifier);
  input  IP;
  input  INN;
  input  INP;
  output  OUT;
...
.O(net_32),
.CELG(CELG59462),
.SIMPV(TBD_XU1_XceleraCORE_XU20_XAMPOPENlow_XU9_SIMPV),
.CELSUB(CELSUB40948),
.enable_switch(enable_ldo)
);

amplifier_0e1b07e7 Xamplifier1 (
.IP(IP_d8ecf8f1_Xamplifier1),
...
.global_amplifier(global_amplifier_d8ecf8f1_Xamplifier1)
);
...
.a({a1,a0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x16_ten_7,noconn_dft_hex0x16_ten_6,noconn_dft_hex0x16_ten_5,noconn_dft_hex0x16_ten_4,noconn_dft_hex0x16_ten_3,noconn_dft_hex0x16_ten_2,noconn_dft_hex0x16_ten_1,global_amplifier_d8ecf8f1_Xamplifier1}),
...
STONEnoconn XNCnoconn_dft_hex0x16_ten_1 (
.noconn(noconn_dft_hex0x16_ten_1)
);
