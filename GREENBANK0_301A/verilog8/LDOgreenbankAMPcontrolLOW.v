...
.O(net_45),
.CELG(CELG59462),
.SIMPV(TBD_XU3_XceleraCORE_XU21_XAMPCONTROLlow_XU9_SIMPV),
.CELSUB(CELSUB40948),
.enable_switch(enable_ldo)
);

amplifier_accaea92 Xamplifier1 (
.IP(IP_7a870fa6_Xamplifier1),
.INN(kelvin_GNDldo),
.INP(net_45),
.OUT(LDO),
.CELG(CELG59462),
...
.a({a1,a0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x11_ten_7,noconn_dft_hex0x11_ten_6,noconn_dft_hex0x11_ten_5,noconn_dft_hex0x11_ten_4,noconn_dft_hex0x11_ten_3,noconn_dft_hex0x11_ten_2,noconn_dft_hex0x11_ten_1,global_amplifier_7a870fa6_Xamplifier1}),
