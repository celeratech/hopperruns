...
.O(net_45),
.CELG(CELG59462),
.SIMPV(TBD_XU3_XceleraCORE_XU21_XAMPCONTROLhigh_XU9_SIMPV),
.CELSUB(CELSUB40948),
.enable_switch(enable_ldo)
);

amplifier_a91f9ff9 Xamplifier1 (
.IP(IP_b802e904_Xamplifier1),
.INN(kelvin_GNDldo),
.INP(net_45),
.OUT(LDO),
.CELG(CELG59462),
...
.global_amplifier(global_amplifier_b802e904_Xamplifier1)
);
...
.a({a1,a0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x10_ten_7,noconn_dft_hex0x10_ten_6,noconn_dft_hex0x10_ten_5,noconn_dft_hex0x10_ten_4,noconn_dft_hex0x10_ten_3,noconn_dft_hex0x10_ten_2,noconn_dft_hex0x10_ten_1,global_amplifier_b802e904_Xamplifier1}),
...
WRAPPER1 XWRAPregister_AMPCONTROLHIGHgain_9c59cd45_Xdatamap1_0 (
.i(register_AMPCONTROLHIGHgain_9c59cd45_Xdatamap1[0]),
.o(net_26)
);

WRAPPER1 XWRAPregister_AMPCONTROLHIGHgain_9c59cd45_Xdatamap1_1 (
.i(register_AMPCONTROLHIGHgain_9c59cd45_Xdatamap1[1]),
.o(net_27)
);

WRAPPER1 XWRAPregister_AMPCONTROLHIGHgain_9c59cd45_Xdatamap1_2 (
.i(register_AMPCONTROLHIGHgain_9c59cd45_Xdatamap1[2]),
.o(net_28)
);
