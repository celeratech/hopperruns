...
.O(net_32),
.CELG(CELG59462),
.SIMPV(TBD_XU3_XceleraCORE_XU21_XAMPOPENhigh_XU9_SIMPV),
.CELSUB(CELSUB40948),
.enable_switch(enable_ldo)
);

amplifier_fb73e43e Xamplifier1 (
.IP(IP_994c1064_Xamplifier1),
...
.global_amplifier(global_amplifier_994c1064_Xamplifier1)
);
...
.a({a1,a0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x15_ten_7,noconn_dft_hex0x15_ten_6,noconn_dft_hex0x15_ten_5,noconn_dft_hex0x15_ten_4,noconn_dft_hex0x15_ten_3,noconn_dft_hex0x15_ten_2,noconn_dft_hex0x15_ten_1,global_amplifier_994c1064_Xamplifier1}),
