...
module currentgenerator_96ad9135 (I0,IP,CELG,SIMPV,TAEXT,CELSUB,TAI_N5UREF,TAI_P5UREF,TAI_N50UREF,TAI_P50NREF,TAI_P50UREF,TAI_N500NREF,TAI_P500NREF,ten_tai_n5uref,ten_tai_p5uref,ten_tai_n50uref,ten_tai_p50nref,ten_tai_p50uref,ten_tai_n500nref,ten_tai_p500nref,ok_currentgenerator,ten_currentgenerator,trim_currentgenerator,enable_currentgenerator,global_currentgenerator,tdi_ok_currentgenerator,ten_taext_currentgenerator);
  inout  I0;
  input  IP;
  input  CELG;
  input  SIMPV;
...
module amux8_042590b8 (O,I0,I1,I2,I3,I4,I5,CELG,amux,SIMPV,CELSUB);
  output  O;
  input  I0;
  input  I1;
  input  I2;
...
module capacitorfixed_963ebb59 (CN,CP,KELVIN_CN,KELVIN_CP);
  inout  CN;
  inout  CP;
  inout  KELVIN_CN;
  inout  KELVIN_CP;
...
module amux2_08fcb8b8 (O,I0,I1,CELG,amux,SIMPV,CELSUB);
  output  O;
  input  I0;
  input  I1;
  input  CELG;
...
module currentgenerator_f578862a (I0,IP,CELG,SIMPV,TAEXT,CELSUB,TAI_N5UREF,TAI_P5UREF,TAI_P50NREF,TAI_N500NREF,TAI_P500NREF,ten_tai_n5uref,ten_tai_p5uref,ten_tai_p50nref,ten_tai_n500nref,ten_tai_p500nref,ok_currentgenerator,ten_currentgenerator,trim_currentgenerator,enable_currentgenerator,global_currentgenerator,tdi_ok_currentgenerator,ten_taext_currentgenerator);
  inout  I0;
  input  IP;
  input  CELG;
  input  SIMPV;
...
currentgenerator_f578862a XU27 (
.I0(net_274),
.IP(IP_c99e7035_XU27),
.CELG(CELG59462),
.SIMPV(MUDV),
