...
WRAPPER1 XWRAPregister_REF2output_46e2454e_Xdatamap2_0 (
.i(register_REF2output_46e2454e_Xdatamap2[0]),
.o(net_209)
);

WRAPPER1 XWRAPregister_REF2output_46e2454e_Xdatamap2_1 (
.i(register_REF2output_46e2454e_Xdatamap2[1]),
.o(net_210)
);

WRAPPER1 XWRAPregister_REF2output_46e2454e_Xdatamap2_2 (
.i(register_REF2output_46e2454e_Xdatamap2[2]),
.o(net_211)
);

WRAPPER1 XWRAPregister_REF3output_00f9a76d_Xdatamap1_0 (
.i(register_REF3output_00f9a76d_Xdatamap1[0]),
.o(net_228)
);

WRAPPER1 XWRAPregister_REF3output_00f9a76d_Xdatamap1_1 (
.i(register_REF3output_00f9a76d_Xdatamap1[1]),
.o(net_229)
);

WRAPPER1 XWRAPregister_REF3output_00f9a76d_Xdatamap1_2 (
.i(register_REF3output_00f9a76d_Xdatamap1[2]),
.o(net_230)
);

WRAPPER1 XWRAPregister_REFERENCEselect_b05f295d_Xdatamap4_0 (
.i(register_REFERENCEselect_b05f295d_Xdatamap4[0]),
.o(net_182)
);

WRAPPER1 XWRAPregister_REFERENCEselect_b05f295d_Xdatamap4_1 (
.i(register_REFERENCEselect_b05f295d_Xdatamap4[1]),
.o(net_183)
);

WRAPPER1 XWRAPregister_REFERENCEselect_b05f295d_Xdatamap4_2 (
.i(register_REFERENCEselect_b05f295d_Xdatamap4[2]),
.o(net_184)
);

WRAPPER1 XWRAPregister_SERVICEconfiguration_d530de71_Xdatamap3_0 (
.i(register_SERVICEconfiguration_d530de71_Xdatamap3[0]),
.o(net_166)
);

WRAPPER1 XWRAPregister_SERVICEconfiguration_d530de71_Xdatamap3_1 (
.i(register_SERVICEconfiguration_d530de71_Xdatamap3[1]),
.o(net_167)
);

WRAPPER1 XWRAPregister_SERVICEconfiguration_d530de71_Xdatamap3_2 (
.i(register_SERVICEconfiguration_d530de71_Xdatamap3[2]),
.o(net_168)
);

WRAPPER1 XWRAPregister_SERVICEconfiguration_d530de71_Xdatamap3_3 (
.i(register_SERVICEconfiguration_d530de71_Xdatamap3[3]),
.o(net_169)
);

WRAPPER1 XWRAPregister_SERVICEconfiguration_d530de71_Xdatamap3_4 (
.i(register_SERVICEconfiguration_d530de71_Xdatamap3[4]),
.o(net_170)
);

WRAPPER1 XWRAPregister_SERVICEconfiguration_d530de71_Xdatamap3_5 (
.i(register_SERVICEconfiguration_d530de71_Xdatamap3[5]),
.o(net_171)
);
