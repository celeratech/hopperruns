// ------------------------ Module Definitions -----------
module SERVICEgreenbankBYPASS (tmi,MUDV,CELG59462,CELV96848,PORB97836,dft_clock,dft_bypass,ok_service,CELSUB40948,IP_924d4d4f,bypass_filter,ok_reference0,ok_reference1,ok_reference2,ok_reference3,ok_reference4,ok_reference5,disable_bypass,SENSE_G_924d4d4f,enable_reference0,enable_reference1,enable_reference2,enable_reference3,enable_reference4,filter_resistor_0,filter_resistor_1,filter_resistor_2,enable_reference567);
  input [4:0] tmi;
  input  MUDV;
  input  CELG59462;
  input  CELV96848;
...
//Celera Confidential Symbol Generator
//Reference:0.800V with Curveture Correction
module reference_2e07093a (SIMPV,enable_reference,ok_reference,REF,global_reference,
CELBG,
ten_ref,TAI_REF,
ten_refbg,TAI_REFBG,
trim_ref,trim_refbg,
...
//Celera:decoder3_82ad6e6e
//Celera Confidential Symbol Generator
//DECODER
module decoder3_82ad6e6e (CELV,i,o,
enable_decoder,
CELG,SUB);
input CELV;
input [2:0] i;
...
WRAPPER1 XWRAPregister_REF2output_0_0 (
.i(register_REF2output_0[0]),
.o(net_209)
);

WRAPPER1 XWRAPregister_REF2output_0_1 (
.i(register_REF2output_0[1]),
.o(net_210)
);

WRAPPER1 XWRAPregister_REF2output_0_2 (
.i(register_REF2output_0[2]),
.o(net_211)
);

WRAPPER1 XWRAPregister_REF3output_0_0 (
.i(register_REF3output_0[0]),
.o(net_228)
);

WRAPPER1 XWRAPregister_REF3output_0_1 (
.i(register_REF3output_0[1]),
.o(net_229)
);

WRAPPER1 XWRAPregister_REF3output_0_2 (
.i(register_REF3output_0[2]),
.o(net_230)
);

WRAPPER1 XWRAPregister_REFERENCEselect_5_0 (
.i(register_REFERENCEselect_5[0]),
.o(net_182)
);

WRAPPER1 XWRAPregister_REFERENCEselect_5_1 (
.i(register_REFERENCEselect_5[1]),
.o(net_183)
);

WRAPPER1 XWRAPregister_REFERENCEselect_5_2 (
.i(register_REFERENCEselect_5[2]),
.o(net_184)
);

WRAPPER1 XWRAPregister_SERVICEconfiguration_5_0 (
.i(register_SERVICEconfiguration_5[0]),
.o(net_166)
);

WRAPPER1 XWRAPregister_SERVICEconfiguration_5_1 (
.i(register_SERVICEconfiguration_5[1]),
.o(net_167)
);

WRAPPER1 XWRAPregister_SERVICEconfiguration_5_2 (
.i(register_SERVICEconfiguration_5[2]),
.o(net_168)
);

WRAPPER1 XWRAPregister_SERVICEconfiguration_5_3 (
.i(register_SERVICEconfiguration_5[3]),
.o(net_169)
);

WRAPPER1 XWRAPregister_SERVICEconfiguration_5_4 (
.i(register_SERVICEconfiguration_5[4]),
.o(net_170)
);

WRAPPER1 XWRAPregister_SERVICEconfiguration_5_5 (
.i(register_SERVICEconfiguration_5[5]),
.o(net_171)
);
