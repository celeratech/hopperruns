...
module oscillatorcrude_8b55da5f (SIMPV,ok_oscillator,osc,global_oscillator,enable_oscillator,IP,CELG,SENSE_G,CELSUB);
  input  IP;
  output  osc;
  input  CELG;
  input  SIMPV;
...
oscillatorcrude_8b55da5f XIXosccrude (
