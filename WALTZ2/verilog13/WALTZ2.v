// ------------------------ Module Definitions -----------
module WALTZ2celeraCORE (EN,FB,IN,SW,BST,GND,PIN,POK,TAO,VCC,tdo,tmi,BIAS,FSET,PGND,PVCC,SYNC,sense_FB,CELG59462,CELV96848,PORB97836,kelvin_VCC,CELSENSE_RF,CELSUB40948,SENSE_G_2f5a8499,kelvin_GNDservice,kelvin_GNDpowergood,kelvin_GNDsoftstart,kelvin_GNDregulation,celkelvin_IN_bc3b7675,celkelvin_GND_73ebd82d,celkelvin_GND_bb7e77f4,celkelvin_GND_d75c3f7f,celkelvin_VCC_bc3b7675,celkelvin_BIAS_bc3b7675);
  input  EN;
  inout  FB;
  input  IN;
  inout  SW;
...
module WALTZ2celeraSERDES (tdo,tmi,GOTP,VOTP,DFTSCL,DFTSDA,unlock,otp_done,CELG59462,CELV96848,PORB97836,CELSUB40948,celkelvin_VCC_9893c918);
  inout  tdo;
  inout [5:0] tmi;
  input  GOTP;
  input  VOTP;
...
// ------------------------ Module Verilog ---------------
module WALTZ2 (EN, FB, IN, SW, BST, GND, POK, VCC, BIAS, FSET, PGND, PVCC, SYNC);
inout  EN;
inout  FB;
inout  IN;
inout  SW;
...
WALTZ2celeraSERDES XceleraSERDES (
.tdo(tdo),
.tmi(tmi[5:0]),
.GOTP(GOTP),
.VOTP(VOTP),
