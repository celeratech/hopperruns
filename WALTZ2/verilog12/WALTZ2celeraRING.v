// ------------------------ Module Definitions -----------
module pad_WALTZ2_BIAS (BIAS,GESD,CELSUB40948,celkelvin_BIAS_bc3b7675);
  inout  BIAS;
  input  GESD;
  input  CELSUB40948;
...
module pad_WALTZ2_FB (FB,GESD,sense_FB);
  inout  FB;
  input  GESD;
  inout  sense_FB;
endmodule

module pad_WALTZ2_FSET (FSET,GESD);
  inout  FSET;
  input  GESD;
endmodule

module pad_WALTZ2_GND (GND,GESD,GOTP,CELG59462,CELSUB40948,SENSE_G_2f5a8499,kelvin_GNDservice,kelvin_GNDpowergood,kelvin_GNDsoftstart,kelvin_GNDregulation,celkelvin_GND_73ebd82d,celkelvin_GND_bb7e77f4,celkelvin_GND_d75c3f7f,celkelvin_GND_db749c23);
  inout  GND;
  output  GESD;
  output  GOTP;
  inout  CELG59462;
...
module pad_WALTZ2_IN (IN,PIN,GESD,CELSUB40948,celkelvin_IN_bc3b7675);
  inout  IN;
  inout  PIN;
  input  GESD;
  input  CELSUB40948;
...
module pad_WALTZ2_PGND (GESD,PGND);
  input  GESD;
  inout  PGND;
endmodule

module pad_WALTZ2_POK (POK,GESD);
  inout  POK;
  input  GESD;
endmodule

module pad_WALTZ2_SW (SW);
  inout  SW;
endmodule

module pad_WALTZ2_SYNC (GESD,SYNC);
  input  GESD;
  inout  SYNC;
endmodule

module pad_WALTZ2_VCC (VCC,GESD,PVCC,VOTP,CELV96848,kelvin_VCC,celkelvin_VCC_9893c918,celkelvin_VCC_bc3b7675);
  inout  VCC;
  input  GESD;
  inout  PVCC;
  output  VOTP;
...
// ------------------------ Module Verilog ---------------
module WALTZ2celeraRING (EN, FB, IN, SW, BST, GND, PIN, POK, TAO, VCC, tdo, tmi, BIAS, FSET, GOTP, PGND, PVCC, SYNC, VOTP, DFTSCL, DFTSDA, unlock, sense_FB, CELG59462, CELV96848, POK_inout, FSET_inout, SYNC_inout, kelvin_VCC, CELSENSE_RF, CELSUB40948, SENSE_G_2f5a8499, kelvin_GNDservice, kelvin_GNDpowergood, kelvin_GNDsoftstart, kelvin_GNDregulation, celkelvin_IN_bc3b7675, celkelvin_GND_73ebd82d, celkelvin_GND_bb7e77f4, celkelvin_GND_d75c3f7f, celkelvin_VCC_9893c918, celkelvin_VCC_bc3b7675, celkelvin_BIAS_bc3b7675);
inout  EN;
inout  FB;
inout  IN;
inout  SW;
