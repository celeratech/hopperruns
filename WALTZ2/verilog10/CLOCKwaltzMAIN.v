...
module timingskew_0a0bd2b6 (CELV,in,out,s,CELG,CELSUB);
  input [3:0] s;
  input  in;
  output  out;
  input  CELG;
...
module clocksync_e1cab6d9 (CELV,clocksync_in,clk,enable_clocksync,global_clocksync,clocksync_out,clocksync_high,clocksync_low,CELG,CELSUB);
  input  clk;
  input  CELG;
  input  CELV;
  input  CELSUB;
