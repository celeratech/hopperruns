...
module delayclock_24a0019c (in,CELV,out,clock,celeraporb,delay,CELG,CELSUB);
  input  in;
  output  out;
  input  CELG;
  input  CELV;
...
module delayfixed_8d787d93 (CELV,i,o,CELG,CELSUB);
  input  i;
  output  o;
  input  CELG;
  input  CELV;
...
module thermal_37802b8a (SIMPV,CELBG,IP,enable_thermal,fault_thermal,ten,CELG,CELSUB);
  input  IP;
  input  ten;
  input  CELG;
  input  CELBG;
