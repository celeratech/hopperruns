...
module celeradacr2r_1a2f4f0b (CELV,global_dac,DAC,ok_dac,i,enable_dac,strobe_dac,DACREF,GNDSENSE,CELG,CELSUB);
  input [7:0] i;
  output  DAC;
  input  CELG;
  input  CELV;
...
module oscillatorcrude_fa6711d9 (SIMPV,ok_oscillator,osc,global_oscillator,enable_oscillator,IP,CELG,SENSE_G,CELSUB);
  input  IP;
  output  osc;
  input  CELG;
  input  SIMPV;
