// ------------------------ Module Definitions -----------
module currentlimitfet_bdeab8a2 (CELPOS,CELSUB,measure_currentlimit,VSENSE,IREPLICA,enable_currentlimit,trim_currentlimit,IP,global_currentlimit,currentlimit_lv,ten_measure_currentlimit,tdi_currentlimitlive,CELG);
  input  IP;
  input  CELG;
  input  CELPOS;
  input  CELSUB;
