...
//Celera Confidential Do Not Copy currentgenerator_currentlimitfet_c69465c0_Xcg.v
//Celera:currentgenerator_currentlimitfet_c69465c0_Xcg
//Celera Confidential Symbol Generator
//Number of outputs: 1, Max Vout: 6V, Accuracy: no%, Temperature Coefficient: zero, Temperature Gain: 3, DFT: no
//POLARITY0:source, OUTPUT0:1.0
module currentgenerator_currentlimitfet_c69465c0_Xcg (SIMPV,CELSUB,enable_currentgenerator,global_currentgenerator,IP,ok_currentgenerator,
I0,
CELG);
input SIMPV;
input CELG;
...
//Celera Confidential Do Not Copy logicshifter0L2H_currentlimitfet_c69465c0_Xlogice.v
//Celera:logicshifter0L2H_currentlimitfet_c69465c0_Xlogice
//Logic Level shifter with Enable
module logicshifter0L2H_currentlimitfet_c69465c0_Xlogice (enable_logicshifter,
VIN1,VIN2,
in,
out,
CELG,CELSUB);
...
//Celera Confidential Do Not Copy levelshifter0L2H_currentlimitfet_c69465c0_Xmeasure.v
//Celera:levelshifter0L2H_currentlimitfet_c69465c0_Xmeasure
//Celera Confidential Symbol Generator
//Direction: low2high, Maximum high voltage:12V 
//Enable pin:yes
module levelshifter0L2H_currentlimitfet_c69465c0_Xmeasure (SIMPV,CELSUB,HVPOS,HVNEG,in,out,
enable_levelshifter,
CELG);
input SIMPV;
input CELG;
...
//Celera Confidential Do Not Copy levelshifter0H2L_currentlimitfet_c69465c0_Xoutput.v
//Celera:levelshifter0H2L_currentlimitfet_c69465c0_Xoutput
//Celera Confidential Symbol Generator
//Direction: high2low, Maximum high voltage:12V 
//Enable pin:yes
module levelshifter0H2L_currentlimitfet_c69465c0_Xoutput (SIMPV,CELSUB,HVPOS,HVNEG,in,out,
enable_levelshifter,
CELG);
input SIMPV;
input CELG;
...
//Celera Confidential Do Not Copy currentlimitfet_c69465c0
//Celera Confidential Symbol Generator
...
module currentlimitfet_c69465c0 (CELPOS,CELSUB,measure_currentlimit,VSENSE,IREPLICA,enable_currentlimit,
CELV,
trim_currentlimit,
IP,
global_currentlimit,
...
.CELV (CELV),
.enable_currentlimit (enable_currentlimitHV),
.IREFTRIM (IREFTRIM),
.IREPLICA (IREPLICA),
...
//,diesize,STONEnoconn
//Celera Confidential Do Not Copy currentgenerator_currentlimitfet_c69465c0_Xcg
currentgenerator_currentlimitfet_c69465c0_Xcg Xcg(
.SIMPV (CELV),
.global_currentgenerator (global_currentlimit),
.I0 (IREF),
.enable_currentgenerator (enable_currentlimitHV),
.IP (IP),
.ok_currentgenerator (noconnect_ok),
.CELSUB (CELSUB),
.CELG (CELG)
);
//,diesize,currentgenerator_currentlimitfet_c69465c0_Xcg
//Celera Confidential Do Not Copy logicshifter0L2H_currentlimitfet_c69465c0_Xlogice
logicshifter0L2H_currentlimitfet_c69465c0_Xlogice Xlogice(
...
//,diesize,logicshifter0L2H_currentlimitfet_c69465c0_Xlogice
//Celera Confidential Do Not Copy PEBBLEtiehi
...
//Celera Confidential Do Not Copy levelshifter0L2H_currentlimitfet_c69465c0_Xmeasure
levelshifter0L2H_currentlimitfet_c69465c0_Xmeasure Xmeasure(
.SIMPV (CELV),
...
//,diesize,levelshifter0L2H_currentlimitfet_c69465c0_Xmeasure
//Celera Confidential Do Not Copy levelshifter0H2L_currentlimitfet_c69465c0_Xoutput
levelshifter0H2L_currentlimitfet_c69465c0_Xoutput Xoutput(
.SIMPV (CELV),
...
//,diesize,levelshifter0H2L_currentlimitfet_c69465c0_Xoutput
//Celera Confidential Do Not Copy STONEcurrentlimitreftrim10u
