...
//Celera Confidential Do Not Copy currentgenerator_currentlimitfet_ec9b675f_Xcg.v
//Celera:currentgenerator_currentlimitfet_ec9b675f_Xcg
//Celera Confidential Symbol Generator
//Number of outputs: 1, Max Vout: 6V, Accuracy: no%, Temperature Coefficient: zero, Temperature Gain: 3, DFT: no
//POLARITY0:source, OUTPUT0:15.0
module currentgenerator_currentlimitfet_ec9b675f_Xcg (SIMPV,CELSUB,enable_currentgenerator,global_currentgenerator,IP,ok_currentgenerator,
I0,
CELG);
input SIMPV;
input CELG;
...
//Celera Confidential Do Not Copy logicshifter0L2H_currentlimitfet_ec9b675f_Xlogice.v
//Celera:logicshifter0L2H_currentlimitfet_ec9b675f_Xlogice
//Logic Level shifter with Enable
module logicshifter0L2H_currentlimitfet_ec9b675f_Xlogice (enable_logicshifter,
VIN1,VIN2,
in,
out,
CELG,CELSUB);
...
//Celera Confidential Do Not Copy levelshifter0L2H_currentlimitfet_ec9b675f_Xmeasure.v
//Celera:levelshifter0L2H_currentlimitfet_ec9b675f_Xmeasure
//Celera Confidential Symbol Generator
//Direction: low2high, Maximum high voltage:12V 
//Enable pin:yes
module levelshifter0L2H_currentlimitfet_ec9b675f_Xmeasure (SIMPV,CELSUB,HVPOS,HVNEG,in,out,
enable_levelshifter,
CELG);
input SIMPV;
input CELG;
...
//Celera Confidential Do Not Copy levelshifter0H2L_currentlimitfet_ec9b675f_Xoutput.v
//Celera:levelshifter0H2L_currentlimitfet_ec9b675f_Xoutput
//Celera Confidential Symbol Generator
//Direction: high2low, Maximum high voltage:12V 
//Enable pin:yes
module levelshifter0H2L_currentlimitfet_ec9b675f_Xoutput (SIMPV,CELSUB,HVPOS,HVNEG,in,out,
enable_levelshifter,
CELG);
input SIMPV;
input CELG;
...
//Celera Confidential Do Not Copy STONEcurrentlimitlowsidedrain60v_en
//Verilog HDL for "Generate", "STONEcurrentlimitlowsidedrain60v_en" "functional"


module STONEcurrentlimitlowsidedrain60v_en ( en, VREFS, VREPS, CELG, CELV, HVREF,
IREFTRIM, IREPLICA, SUB, VSENSE, currentlimit, enable_currentlimit, measure_currentlimit
);
...
//Celera Confidential Do Not Copy currentlimitfet_ec9b675f
//Celera Confidential Symbol Generator
...
//Celera Confidential Do Not Copy STONEcurrentlimitlowsidedrain60v_en
STONEcurrentlimitlowsidedrain60v_en Xlow_nmos_drain_en(
.CELV (CELV),
.VSENSE (VSENSE),
...
//,diesize,STONEcurrentlimitlowsidedrain60v_en
//Celera Confidential Do Not Copy STONEnoconn
...
//,diesize,STONEnoconn
//Celera Confidential Do Not Copy currentgenerator_currentlimitfet_ec9b675f_Xcg
currentgenerator_currentlimitfet_ec9b675f_Xcg Xcg(
.SIMPV (CELV),
...
//,diesize,currentgenerator_currentlimitfet_ec9b675f_Xcg
//Celera Confidential Do Not Copy logicshifter0L2H_currentlimitfet_ec9b675f_Xlogice
logicshifter0L2H_currentlimitfet_ec9b675f_Xlogice Xlogice(
...
//,diesize,logicshifter0L2H_currentlimitfet_ec9b675f_Xlogice
//Celera Confidential Do Not Copy PEBBLEtiehi
...
//Celera Confidential Do Not Copy levelshifter0L2H_currentlimitfet_ec9b675f_Xmeasure
levelshifter0L2H_currentlimitfet_ec9b675f_Xmeasure Xmeasure(
.SIMPV (CELV),
...
//,diesize,levelshifter0L2H_currentlimitfet_ec9b675f_Xmeasure
//Celera Confidential Do Not Copy levelshifter0H2L_currentlimitfet_ec9b675f_Xoutput
levelshifter0H2L_currentlimitfet_ec9b675f_Xoutput Xoutput(
.SIMPV (CELV),
...
//,diesize,levelshifter0H2L_currentlimitfet_ec9b675f_Xoutput
//Celera Confidential Do Not Copy STONEcurrentlimitreftrim50u
