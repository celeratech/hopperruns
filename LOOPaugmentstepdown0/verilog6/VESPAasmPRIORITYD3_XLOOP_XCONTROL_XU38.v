...
module timingskew_XLOOP_XCONTROL_XU38_XU10 (CELV,in,out,s,CELG,SUB);
  input [1:0] s;
  input  in;
  input  SUB;
  output  out;
...
module timingskew_XLOOP_XCONTROL_XU38_XU19 (CELV,in,out,s,CELG,SUB);
  input [1:0] s;
  input  in;
  input  SUB;
  output  out;
...
module timingskew_XLOOP_XCONTROL_XU38_XU35 (CELV,in,out,s,CELG,SUB);
  input [1:0] s;
  input  in;
  input  SUB;
  output  out;
