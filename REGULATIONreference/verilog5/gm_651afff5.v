...
//Celera Confidential Do Not Copy STONEgminptrim4x
//Verilog HDL for "Generate", "STONEgminptrim4x" "functional"


module STONEgminptrim4x ( ISP, SUB, INP, IDPP, IDNP, INN, CELG, CELV, trim_gmneg,
trim_gmpos );
...
//Celera Confidential Do Not Copy gm_651afff5
//Celera Confidential Symbol Generator
//Gain: 1, Type: p, Clamp High: no, Clamp Low: no
//Lowiq:no, Override: no, DFT: no, Accuracy: system
module gm_651afff5 (SIMPV,CELSUB,enable_gm,IP,GMO,INP,INN,global_gm,
...
//Celera Confidential Do Not Copy STONEgminptrim4x
STONEgminptrim4x XgmINP_TRIM4X(
.CELV (SIMPV),
.IDNP (IDNP),
.INP (INP),
.IDPP (IDPP),
