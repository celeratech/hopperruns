...
module REGULATIONreferenceGMVcap (CAPFB,SIMPV,input,REF_CAP,VCforce,ok_capfb,CELG59462,CELV96848,VCsinkCAP,CELSUB40948,IP_52cba950,enable_stepdown);
  inout  CAPFB;
  input  SIMPV;
  input  input;
  input  REF_CAP;
...
module REGULATIONreferenceGMVout (OUTFB,SIMPV,input,ok_out,REF_OUT,VCforce,CELG59462,CELV96848,VCsinkOUT,CELSUB40948,IP_9b35f469,enable_stepup);
  inout  OUTFB;
  input  SIMPV;
  input  input;
  output  ok_out;
