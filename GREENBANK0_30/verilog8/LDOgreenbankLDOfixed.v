...
.O(net_36),
.CELG(CELG59462),
.SIMPV(TBD_XGREENBANK_XceleraCORE_XLDO_XLDOFIXED_XU9_SIMPV),
.CELSUB(CELSUB40948),
.enable_switch(enable_ldo)
);

IPOTTldo_d6d23838 XLDO1 (
.LDO(LDO),
.REF(net_36),
.CELG(CELG59462),
.SIMPV(MUDV),
...
.celkelvin_GNDldo(celkelvin_MUDG_377130793)
);
...
.a({a1,a0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x04_ten_7,noconn_dft_hex0x04_ten_6,noconn_dft_hex0x04_ten_5,noconn_dft_hex0x04_ten_4,noconn_dft_hex0x04_ten_3,noconn_dft_hex0x04_ten_2,noconn_dft_hex0x04_ten_1,global_ldo_fd4a89e4_XLDO1}),
