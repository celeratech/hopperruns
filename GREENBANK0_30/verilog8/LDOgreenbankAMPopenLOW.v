...
.O(net_32),
.CELG(CELG59462),
.SIMPV(TBD_XGREENBANK_XceleraCORE_XU19_XAMPOPENlow_XU9_SIMPV),
.CELSUB(CELSUB40948),
.enable_switch(enable_ldo)
);

amplifier_0e1b07e7 Xamplifier1 (
.IP(IP_00732f90_Xamplifier1),
...
.global_amplifier(global_amplifier_00732f90_Xamplifier1)
);
...
.a({a1,a0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x16_ten_7,noconn_dft_hex0x16_ten_6,noconn_dft_hex0x16_ten_5,noconn_dft_hex0x16_ten_4,noconn_dft_hex0x16_ten_3,noconn_dft_hex0x16_ten_2,noconn_dft_hex0x16_ten_1,global_amplifier_00732f90_Xamplifier1}),
