...
.O(net_32),
.CELG(CELG59462),
.SIMPV(TBD_XGREENBANK_XceleraCORE_XU19_XAMPFIXEDmedium_XU9_SIMPV),
.CELSUB(CELSUB40948),
.enable_switch(enable_ldo)
);

amplifier_d3d8dcb1 Xamplifier1 (
.IP(IP_faec70c3_Xamplifier1),
.INN(kelvin_GNDldo),
.INP(net_32),
.OUT(LDO),
.CELG(CELG59462),
...
.global_amplifier(global_amplifier_faec70c3_Xamplifier1)
);
...
.a({a1,a0}),
.SUB(CELSUB40948),
.ten({noconn_dft_hex0x14_ten_7,noconn_dft_hex0x14_ten_6,noconn_dft_hex0x14_ten_5,noconn_dft_hex0x14_ten_4,noconn_dft_hex0x14_ten_3,noconn_dft_hex0x14_ten_2,noconn_dft_hex0x14_ten_1,global_amplifier_faec70c3_Xamplifier1}),
