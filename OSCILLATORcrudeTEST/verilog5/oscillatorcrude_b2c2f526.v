...
//Celera Confidential Do Not Copy oscillatorcrude_b2c2f526
//Celera Confidential Symbol Generator
//VMAX:globalV,Crude:1.000KHz
module oscillatorcrude_b2c2f526 (SIMPV,ok_oscillator,osc,global_oscillator,
enable_oscillator,
IP,
CELG,SENSE_G,CELSUB);
input SIMPV;
...
mim34_2f26p5x21p1 XCAPon_0(
.CP (CR),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CAPoff__
mim34_2f30p0x29p2 XCAPoff__0(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x29p2 XCAPoff__1(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x29p2 XCAPoff__2(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x29p2 XCAPoff__3(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x29p2 XCAPoff__4(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x29p2 XCAPoff__5(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x29p2 XCAPoff__6(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x29p2 XCAPoff__7(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x29p2 XCAPoff__8(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x29p2 XCAPoff__9(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x29p2 XCAPoff__10(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x29p2 XCAPoff__11(
.CP (CL),
.CN (SENSE_G)
);
