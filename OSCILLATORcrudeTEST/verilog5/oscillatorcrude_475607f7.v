...
//Celera Confidential Do Not Copy mim34_2f8p4x6p7
module mim34_2f8p4x6p7 (CP,CN);
inout CP;
inout CN;
endmodule
...
//Celera Confidential Do Not Copy oscillatorcrude_475607f7
...
mim34_2f5p4x5p0 XCT1_0(
.CP (CRT0),
.CN (CRT0_A)
);
mim34_2f5p4x5p0 XCT1_1(
.CP (CRT0_A),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CT3_
mim34_2f5p4x5p0 XCT3_0(
.CP (CRT1),
.CN (CRT1_A)
);
mim34_2f5p4x5p0 XCT3_1(
.CP (CRT1_A),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CT5_
mim34_2f5p4x5p0 XCT5_0(
.CP (CRT2),
.CN (CRT2_A)
);
mim34_2f5p4x5p0 XCT5_1(
.CP (CRT2_A),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CT0_
mim34_2f5p4x5p0 XCT0_0(
.CP (CLT0),
.CN (CLT0_A)
);
mim34_2f5p4x5p0 XCT0_1(
.CP (CLT0_A),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CT2_
mim34_2f5p4x5p0 XCT2_0(
.CP (CLT1),
.CN (CLT1_A)
);
mim34_2f5p4x5p0 XCT2_1(
.CP (CLT1_A),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CT4_
mim34_2f5p4x5p0 XCT4_0(
.CP (CLT2),
.CN (CLT2_A)
);
mim34_2f5p4x5p0 XCT4_1(
.CP (CLT2_A),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CAPon_
mim34_2f8p4x6p7 XCAPon_0(
.CP (CR),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CAPoff_
mim34_2f8p4x6p7 XCAPoff_0(
.CP (CL),
.CN (SENSE_G)
);
