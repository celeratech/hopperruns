...
//Celera Confidential Do Not Copy oscillatorcrude_a1b1bf39
//Celera Confidential Symbol Generator
//VMAX:localV,Crude:200.000KHz
module oscillatorcrude_a1b1bf39 (SIMPV,ok_oscillator,osc,global_oscillator,
enable_oscillator,
CELG,SENSE_G,CELSUB);
input SIMPV;
output ok_oscillator;
...
mim34_2f8p7x7p0 XCAPon_0(
.CP (CR),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CAPoff_
mim34_2f26p2x21p0 XCAPoff_0(
.CP (CL),
.CN (SENSE_G)
);
