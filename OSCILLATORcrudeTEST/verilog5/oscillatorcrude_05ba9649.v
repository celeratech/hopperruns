...
//Celera Confidential Do Not Copy oscillatorcrude_05ba9649
//Celera Confidential Symbol Generator
//VMAX:globalV,Crude:32.000KHz
module oscillatorcrude_05ba9649 (SIMPV,ok_oscillator,osc,global_oscillator,
...
mim34_2f10p6x8p5 XCT10(
.CP (CRT0),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CT3_
mim34_2f10p6x8p5 XCT3_0(
.CP (CRT1),
.CN (SENSE_G)
);
mim34_2f10p6x8p5 XCT3_1(
.CP (CRT1),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CT5_
mim34_2f10p6x8p5 XCT5_0(
.CP (CRT2),
.CN (SENSE_G)
);
mim34_2f10p6x8p5 XCT5_1(
.CP (CRT2),
.CN (SENSE_G)
);
mim34_2f10p6x8p5 XCT5_2(
.CP (CRT2),
.CN (SENSE_G)
);
mim34_2f10p6x8p5 XCT5_3(
.CP (CRT2),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CT0
mim34_2f18p5x14p8 XCT00(
.CP (CLT0),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CT2_
mim34_2f18p5x14p8 XCT2_0(
.CP (CLT1),
.CN (SENSE_G)
);
mim34_2f18p5x14p8 XCT2_1(
.CP (CLT1),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CT4_
mim34_2f18p5x14p8 XCT4_0(
.CP (CLT2),
.CN (SENSE_G)
);
mim34_2f18p5x14p8 XCT4_1(
.CP (CLT2),
.CN (SENSE_G)
);
mim34_2f18p5x14p8 XCT4_2(
.CP (CLT2),
.CN (SENSE_G)
);
mim34_2f18p5x14p8 XCT4_3(
.CP (CLT2),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CAPon__
mim34_2f30p0x25p0 XCAPon__0(
.CP (CR),
.CN (SENSE_G)
);
mim34_2f30p0x25p0 XCAPon__1(
.CP (CR),
.CN (SENSE_G)
);

//Celera Confidential Do Not Copy CAPoff__
mim34_2f30p0x25p5 XCAPoff__0(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x25p5 XCAPoff__1(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x25p5 XCAPoff__2(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x25p5 XCAPoff__3(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x25p5 XCAPoff__4(
.CP (CL),
.CN (SENSE_G)
);
mim34_2f30p0x25p5 XCAPoff__5(
.CP (CL),
.CN (SENSE_G)
);
